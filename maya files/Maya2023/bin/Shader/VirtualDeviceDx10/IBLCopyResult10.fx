...
// Pixel shader.
float4 PS_CopyResult(VS_TO_PS In) : SV_Target
{
    // A simple calculation.
    float4 result = gColorTex.Sample(gColorSamp, In.UV);
...
technique10 Main
{
    pass p0
    {
        SetVertexShader(CompileShader(vs_4_0, VS_CopyResult()));
        SetPixelShader(CompileShader(ps_4_0, PS_CopyResult()));
    }
}
