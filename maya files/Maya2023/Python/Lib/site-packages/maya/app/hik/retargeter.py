...
class RetargUtils(object):
    ...
    def getMatrix(node, matrixString):
        ...
        try:
            ...
            cmds.warning( maya.stringTable[ 'y_maya_app_hik_retargeter.kWorldMatrixError'  ] )
    ...
    def  getJointOrient(nodeName):
        ...
        try:
            ...
            cmds.warning( maya.stringTable[ 'y_maya_app_hik_retargeter.kOrientErr'  ] )
...
class DefaultRetargeter(object):
        ...
        def fromGraph(self,node):
            ...
            try:
                ...
                s = cmds.format( maya.stringTable[ 'y_maya_app_hik_retargeter.kFailedMatSource'  ], stringArg=( node ) )
                cmds.warning( s )
            ...
            try:
                ...
                s = cmds.format( maya.stringTable[ 'y_maya_app_hik_retargeter.kFailedRig'  ], stringArg=( node ) )
                cmds.warning( s )
            ...
            try:
                ...
                s = cmds.format( maya.stringTable[ 'y_maya_app_hik_retargeter.kFailedSkeleton'  ], stringArg=( node ) )
                cmds.warning( s )
        ...
        def setUpTrans (self, matrixSource, destination, destSkel  = None, offset = None, sourceRoot = None, destRoot = None):
            ...
            if(sourceRoot is None  or destRoot is None):
                ...
                cmds.error( maya.stringTable[ 'y_maya_app_hik_retargeter.kBothRequdError'  ] )
                return
        ...
        def calculateOffsets(self, destination, destinationSkel, type ):
            ...
            if   type == "T":
                ...
                try:
                    ...
                    fmt = maya.stringTable['y_maya_app_hik_retargeter.kInvalidOffsetNode' ]
                    if destMatrix == None:
                        cmds.warning(fmt % (maya.stringTable['y_maya_app_hik_retargeter.kDestinationNode'], maya.stringTable['y_maya_app_hik_retargeter.kWorldMatrix' ], destNode))

                    if destSkelMatrix == None:
                        cmds.warning(fmt % (maya.stringTable['y_maya_app_hik_retargeter.kDestinationSkeletonNode' ], maya.stringTable['y_maya_app_hik_retargeter.kWorldInverseMatrix' ], destSkelNode))
                    return (0., 0., 0.)
        ...
        def doRetarget(self,src):
            ...
            try:
                ...
                cmds.warning( maya.stringTable[ 'y_maya_app_hik_retargeter.kRetargeterFailed'  ] % ( self.__destRig ) )
            ...
            if nodes is not None:
                ...
                for node in nodes:
                    try:
                        ...
                        cmds.warning( maya.stringTable[ 'y_maya_app_hik_retargeter.kCleanupError'   ] % ( type( inst ), node ) )
...
class HIKRetargeter(object):
    ...
    def createDefaultMapping(source,dest,bodyPart,destRig,type,id,linkNum = 0 ):
        ...
        if ( destSkel is None ):
            cmds.warning( maya.stringTable[ 'y_maya_app_hik_retargeter.kBodyPartError'  ] %  ( name, dest ) )
            return None
    ...
    def __deleteConnections(self):
        for key in self.__Mappings:
            ...
            try:
                ...
                cmds.warning( maya.stringTable[ 'y_maya_app_hik_retargeter.kDeleteError'  ] % key )

    def __promptIgnoreMismatch(self, file, old_dest, new_dest):

        msg = maya.stringTable[ 'y_maya_app_hik_retargeter.kMappingMismatch'  ] % ( old_dest, new_dest )
        if ( file != None ):
            msg = maya.stringTable[ 'y_maya_app_hik_retargeter.kErrorPrefix'  ] % ( file, msg )
            
        buttons = [ maya.stringTable[ 'y_maya_app_hik_retargeter.kDialogContinue' ], maya.stringTable[ 'y_maya_app_hik_retargeter.kDialogCancel'  ]]
        title   = maya.stringTable[ 'y_maya_app_hik_retargeter.kDialogTitle'  ]
    ...
    def __init__(self,HIKDestination=None):
        ...
        if ( HIKDestination is not None ):
            if ( cmds.nodeType(HIKDestination) != "HIKCharacterNode") :
                cmds.error( maya.stringTable[ 'y_maya_app_hik_retargeter.kNotACharacterNode'  ] % ( HIKDestination ) )
            else:
    ...
    def connect(self):
        ...
        for v in list(self.__Mappings.values()):
    ...
    def getMappingKey(self,bodyPart,type,linkNum=0):
        ...
        for k, v in list(self.__Mappings.items()):
            r = v.getRetargeter()
    ...
    def toXML(self):
        ...
        for key in list(self.__Mappings.keys()):
    ...
    def fromXML(self, root, dest, file=None ):
        ...
        if n1 != n2 :
            cmds.warning( maya.stringTable[ 'y_maya_app_hik_retargeter.kMismatchNamespace'  ] )
            return False
    ...
    def read(self,file,dest):
        ...
        try:
            ...
            cmds.warning( maya.stringTable[ 'y_maya_app_hik_retargeter.kFileError'  ] % (file, inst) )
            return 0
