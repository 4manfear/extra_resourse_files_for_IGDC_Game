...
class EventDescriptionWindow(object):
    ...
    def __init__(self, window_name="profilerEventDescriptionWindowId"):
        ...
        '''
        self.window_title = maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kEventDescriptionWindowTitle' ]
    ...
    def populate_event_types(selected_event_types):
        ...
        '''
        with LayoutManager( cmds.frameLayout(label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kFrameEventTypes' ], **FRAME_LAYOUT)):
            # If no selection then reduce the contents of the window to a single message
            if len(selected_event_types) == 0:
                cmds.text( label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kNoSelection'] )
                return

            with LayoutManager( cmds.rowColumnLayout(numberOfColumns=5 , **RC_LAYOUT_5_COLUMN ) ):
                cmds.text( label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kEventTypeNameColumnLabel'], **TABLE_HEADER )
                cmds.text( label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kEventTypeCategoryColumnLabel'], **TABLE_HEADER )
                cmds.text( label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kEventTypeDescriptionColumnLabel'], wordWrap=True, **TABLE_HEADER )
                cmds.text( label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kEventTypeColorColumnLabel'], **TABLE_HEADER )
                cmds.text( label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kEventTypeCountColumnLabel'], **TABLE_HEADER )
                for event_type_info in selected_event_types:
                    try:
                        if KEY_TYPE in event_type_info:
                            ...
                            event_type_name        = maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kEventTypeAnonymous']
                        ...
                        print(maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kColourParsingError' ].format(ex, event_type_info))
    ...
    def populate_categories(category_info):
        ...
        '''
        with LayoutManager( cmds.frameLayout(label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kFrameCategories' ], collapse=True, **FRAME_LAYOUT)):
            with LayoutManager( cmds.rowColumnLayout(numberOfColumns=2 , **RC_LAYOUT_2_COLUMN ) ):
                cmds.text( label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kTypeCategoryNameColumnLabel'], **TABLE_HEADER )
                cmds.text( label=maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kTypeCategoryDescriptionColumnLabel'], **TABLE_HEADER )
    ...
    def populate(self):
        ...
        try:
            ...
            print(maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kProfilerToolMissingEvents' ].format(ex))
        ...
        try:
            ...
            print(maya.stringTable['y_maya_app_profilerEventDescriptionWindow_profilerEventDescriptionWindow.kProfilerToolMissingCategories' ].format(ex))
            category_info = []
