...
def preRender():
    ...
    if not matchingCriteria:
         cmds.warning( maya.stringTable['y_maya_app_sceneAssembly_adskPrepareRender.kPrepareRenderNoMatchingCriteria' ] )
...
def settingsUI():
    ...
    repName = cmds.textFieldGrp(ad2=2, label=maya.stringTable['y_maya_app_sceneAssembly_adskPrepareRender.kSceneAssemblyRenderSettingRepName'], text=renderRepName)    
    repLabel = cmds.textFieldGrp(ad2=2, label=maya.stringTable['y_maya_app_sceneAssembly_adskPrepareRender.kSceneAssemblyRenderSettingRepLabel'],text=renderRepLabel)
    repType = cmds.textFieldGrp(ad2=2, label=maya.stringTable['y_maya_app_sceneAssembly_adskPrepareRender.kSceneAssemblyRenderSettingRepType'],text=renderRepType)
    useRegExp = cmds.checkBoxGrp(numberOfCheckBoxes=1, label=maya.stringTable['y_maya_app_sceneAssembly_adskPrepareRender.kSceneAssemblyRenderSettingRgEx'], label1='', value1=useRegularExpression)
