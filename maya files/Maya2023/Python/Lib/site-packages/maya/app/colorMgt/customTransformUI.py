...
def dialogFactory(type):
    ...
    if type == 'rendering space':
        ...
        return _createOutputDialog(type, maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtCustomOutput' ])
    elif type == 'playblast':
        return _createOutputDialog(type, maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtCustomPlayblastOutput' ])
    else:
        errorStr = maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtBadCustomType' ] % type
    ...
    while not done:
        ...
        if len(dialogRetVal) > 0:
            ...
            if dialogRetVal == 'save':
                okStr = maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtOK' ]
                try:
                    dialog.add()
                except RuntimeError as ex:
                    # Return error: add didn't pan out, so don't try applying.  
                    titleStr = maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtAddTransformFailed' ]
                    buttonStr = okStr
                    cmds.confirmDialog(
                        title=titleStr, message=futureStr(ex), button=buttonStr, icon='warning')
                    return ''
                ...
                try:
                    ...
                    titleStr = maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtBadTransform' ]
                    buttonStr = okStr
                    cmds.confirmDialog(
                        title=titleStr, message=futureStr(ex), button=buttonStr, icon='warning')
                    dialog.remove()
...
class Dialog(object):
    ...
    _dirSrc = maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtDirSrc' ]
    _dirDst = maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtDirDst' ]
    ...
    def show(self):
        ...
        titleString = maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtCustomTransformUI' ] % self.title()
    ...
    def build(self):
        ...
        self._pathWidget = cmds.textFieldGrp(
            ad2=2,
            label=maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtCustomTransformFilePath'],
            text=self.path)
        ...
        self._nameWidget = cmds.textFieldGrp(
            ad2=2, label=maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtCustomTransformName'],
            text=self.name)

        transformConnectionLabel = maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtTransformConnection' ]\
                          % self.direction()
        ...
        saveBtn = cmds.button(label=maya.stringTable['y_maya_app_colorMgt_customTransformUI.kSave' ],
                              command=partial(self.onDismissButton, msg='save'))

        cancelBtn = cmds.button(label=maya.stringTable['y_maya_app_colorMgt_customTransformUI.kCancel' ],
    ...
    def onPathBrowse(self, data):
        ...
        multiFilter = maya.stringTable['y_maya_app_colorMgt_customTransformUI.kTransformFiles' ]
        multiFilter += ' ('
...
class RenderingSpaceDialog(Dialog):
    ...
    def title(self):
        return maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtCustomRenderingSpace' ]
...
class ViewTransformDialog(Dialog):
    ...
    def title(self):
        return maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtCustomView' ]
...
class InputTransformDialog(Dialog):
    ...
    def title(self):
        return maya.stringTable['y_maya_app_colorMgt_customTransformUI.kColorMgtCustomInput' ],
