...
def updateConstraintUI( nodeName ):
	...
	"""
	logger.debug( maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraintUI.kUpdatingConstrUI'  ] % nodeName )

	# Limit Properties section
	constraintType = cmds.getAttr('{0}.constraintType'.format(nodeName))
	for attrName in list(dictConstraintAttributes.keys()):
