...
solverDisplayOptionsMap = {
	maya.stringTable[ 'y_maya_app_mayabullet_SolverUI.kDrawCenterOfMass'  ]		: (1<<00),
	maya.stringTable[ 'y_maya_app_mayabullet_SolverUI.kDrawBB'  ]		: (1<<0o1),
	maya.stringTable[ 'y_maya_app_mayabullet_SolverUI.kDrawContactPoints'  ]		: (1<<0o3),
	maya.stringTable[ 'y_maya_app_mayabullet_SolverUI.kDrawConstraints'  ]			: (1<<11),
	maya.stringTable[ 'y_maya_app_mayabullet_SolverUI.kDrawCollisionShape'  ]		: (1<<4),
		}
...
def AEOptions( attr, optionsMap, deleteCB=None, replace=False ):
	...
	# sort by optionName
	for optionName in sorted(optionsMap.keys()):
