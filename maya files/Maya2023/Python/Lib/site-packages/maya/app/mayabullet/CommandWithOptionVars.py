...
class CommandWithOptionVars(object):
    ...
    def getOptionVars(self):
        ...
        for k, v in list(optionVarDict.items()):
            ...
            logger.info(maya.stringTable[ 'y_maya_app_mayabullet_CommandWithOptionVars.kGettingOptVar'  ]%(optVarKey,v))
    ...
    def setOptionVars(self, optionVarDict):
        ...
        for k, v in list(optionVarDict.items()):
            optVarKey = self.optionVarPrefix+k
            logger.info(maya.stringTable[ 'y_maya_app_mayabullet_CommandWithOptionVars.kSettingOptVar'  ] %(optVarKey,v))
    ...
    def executeCommandCB(self, miscBool=None):
        ...
        '''
        logger.info(maya.stringTable[ 'y_maya_app_mayabullet_CommandWithOptionVars.kGetOptVarValues'  ])
        optionVarDict = self.getOptionVars()

        # REVISIT: May want to pass in parameters to the command a different way
        logger.info(maya.stringTable[ 'y_maya_app_mayabullet_CommandWithOptionVars.kExecuteCmd'  ])
    ...
    def executeCommandAndHideOptionBoxCB(self, miscBool=None):
        ...
        Note: Requires OptionBox Dialog to be created.
        '''
        logger.info(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kExecCmdAndCloseOBox' ])
    ...
    def hideOptionBoxCB(self, miscBool=None):
        ...
        Note: Requires OptionBox Dialog to be created.
        '''
        logger.info(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kCloseOBox' ])
        if (self.optionBox != ''):
            maya.cmds.control(self.optionBox, edit=True, visibleChangeCommand='')
        self.saveOptionBoxPreferencesCB()
        self.optionBoxClosing()
    ...
    def saveOptionBoxPreferencesCB(self, miscBool=None):
        ...
        Note: Requires OptionBox Dialog to be created.
        '''        
        logger.info(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kRetrieveWidgetValue'])
        optionVarDict = self.getWidgetValues()

        logger.info(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kSavingOptVars' ])
    ...
    def resetOptionBoxToDefaultsCB(self, miscBool=None):
        ...
        Note: Requires OptionBox Dialog to be created.
        '''        
        logger.info(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kResetDefaults' ]%miscBool)
    ...
    def setWidgetValues(self, optionVarDict):
        ...
        for optionVarDictKey, (widgetClass, widget) in list(self.optionVarToWidgetDict.items()):
            ...
            try:
                ...
                logger.error(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kRetrieveValsErr']%(widgetClass,widget,optionVarDictKey,widgetValue))
                raise
    ...
    def createOptionDialog(self, optionVarOverrideDict=None, saveOptionVars=True):
        ...
        # == Dialog attrs ==
        # Add parameters
        logger.info(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kAddWidgets'])
        ...
        if self.optionVarToWidgetDict == None:
            logger.warning(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kReturnedNone'])
        ...
        if len(omittedWidgetKeys) > 0:
            logger.warning(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kMissingWidgets']%str(missingDefaults))

        # Set Widget Values
        logger.info(maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kSetWidgetValues'])
        ...
        # * Titling and Help
        dlgTitle = self.l10nCommandName + maya.stringTable['y_maya_app_mayabullet_CommandWithOptionVars.kOptionsTitle' ]
