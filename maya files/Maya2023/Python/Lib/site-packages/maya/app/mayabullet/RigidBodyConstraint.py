...
class CreateRigidBodyConstraint(CommandWithOptionVars.CommandWithOptionVars):
    ...
    def __init__(self):
        ...
        self.l10nCommandName = maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kCreateRigidBodyConstraint' ]
        self.optionVarCategory = 'Bullet.Rigid Body Constraint'
    ...
    def addOptionDialogWidgets(self):
        ...
        widget = maya.cmds.optionMenuGrp(label=maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kConstrType'])
        point=maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kPoint' ]
        hinge=maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kHinge' ]
        slider=maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kSlider']
        coneTwist=maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kConeTwist']
        sixDOF=maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kSixDOF']
        hinge2=maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kHinge2' ]
        sixDOF2=maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kSixDOF2']
        ...
        widget = maya.cmds.optionMenuGrp(label=maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kUseRefFrame'])
        rigidA = maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kRigidBodyA' ]
        rigidB = maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kRigidBodyB' ]
        ...
        # Brekaing
        widget = maya.cmds.checkBoxGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kBreakable'  ],
                                       ann=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kBreakableAnn'  ],
                                       numberOfCheckBoxes=1)
        widgetDict['breakable'] = (maya.cmds.checkBoxGrp, widget)

        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kBreakingThreshold'  ],
                                          ann=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kBreakingThresholdAnn'  ],
                                          minValue=0, maxValue=100)
        widgetDict['breakingThreshold'] = (maya.cmds.floatSliderGrp, widget)

        # Damping/Softness/etc
        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearDamping'  ],
                                          minValue=0, maxValue=1)
        widgetDict['linearDamping'] = (maya.cmds.floatSliderGrp, widget)
        
        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearSoftness'  ],
                                          minValue=0, maxValue=1)
        widgetDict['linearSoftness'] = (maya.cmds.floatSliderGrp, widget)
        
        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearRestitution'  ],
                                          minValue=0, maxValue=1)
        widgetDict['linearRestitution'] = (maya.cmds.floatSliderGrp, widget)
        
        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularDamping'  ],
                                          minValue=0, maxValue=1)
        widgetDict['angularDamping'] = (maya.cmds.floatSliderGrp, widget)
        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularSoftness'  ],
                                          minValue=0, maxValue=1)
        widgetDict['angularSoftness'] = (maya.cmds.floatSliderGrp, widget)

        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularRestitution'  ],
                                          minValue=0, maxValue=1)
        widgetDict['angularRestitution'] = (maya.cmds.floatSliderGrp, widget)
        
        # Limits - Linear ====
        widget = maya.cmds.optionMenuGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearConstraintX'  ])
        free = maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kFree'  ]
        locked = maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLocked'  ]
        limited = maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLimited'  ]
        ...
        widget = maya.cmds.optionMenuGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearConstraintY'  ])
        maya.cmds.menuItem(label=free)
        maya.cmds.menuItem(label=locked)
        maya.cmds.menuItem(label=limited)
        ...
        widget = maya.cmds.optionMenuGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearConstraintZ'  ])
        maya.cmds.menuItem(label=free)
        maya.cmds.menuItem(label=locked)
        maya.cmds.menuItem(label=limited)
        ...
        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearConstraintMin'  ],
                                         numberOfFields=3)
        widgetDict['linearConstraintMin'] = (maya.cmds.floatFieldGrp, widget)

        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearConstraintMax'  ],
                                         numberOfFields=3)
        widgetDict['linearConstraintMax'] = (maya.cmds.floatFieldGrp, widget)

        # Limits - Angular =====
        widget = maya.cmds.optionMenuGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularConstraintX'  ])
        maya.cmds.menuItem(label=free)
        maya.cmds.menuItem(label=locked)
        maya.cmds.menuItem(label=limited)
        ...
        widget = maya.cmds.optionMenuGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularConstraintY'  ])
        maya.cmds.menuItem(label=free)
        maya.cmds.menuItem(label=locked)
        maya.cmds.menuItem(label=limited)
        ...
        widget = maya.cmds.optionMenuGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularConstraintZ'  ])
        maya.cmds.menuItem(label=free)
        maya.cmds.menuItem(label=locked)
        maya.cmds.menuItem(label=limited)
        ...
        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularConstraintMin'  ],
                                         numberOfFields=3)
        widgetDict['angularConstraintMin'] = (maya.cmds.floatFieldGrp, widget)

        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularConstraintMax'  ],
                                         numberOfFields=3)
        widgetDict['angularConstraintMax'] = (maya.cmds.floatFieldGrp, widget)

        # Limit Properties ====
        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearLimitSoftness'  ],
                                          minValue=0, maxValue=1)
        widgetDict['linearLimitSoftness'] = (maya.cmds.floatSliderGrp, widget)

        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearLimitBias'  ],
                                          minValue=0, maxValue=1)
        widgetDict['linearLimitBias'] = (maya.cmds.floatSliderGrp, widget)
        
        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearLimitRelaxation'  ],
                                          minValue=0, maxValue=1)
        widgetDict['linearLimitRelaxation'] = (maya.cmds.floatSliderGrp, widget)

        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularLimitSoftness'  ],
                                          minValue=0, maxValue=1)
        widgetDict['angularLimitSoftness'] = (maya.cmds.floatSliderGrp, widget)

        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularLimitBias'  ],
                                          minValue=0, maxValue=1)
        widgetDict['angularLimitBias'] = (maya.cmds.floatSliderGrp, widget)
        
        widget = maya.cmds.floatSliderGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularLimitRelaxation'  ],
                                          minValue=0, maxValue=1)
        widgetDict['angularLimitRelaxation'] = (maya.cmds.floatSliderGrp, widget)

        # Motors ====
        widget = maya.cmds.checkBoxGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearMotorEnabled'  ], changeCommand=self.linearMotorEnabledCB, 
                                       numberOfCheckBoxes=1)
        widgetDict['linearMotorEnabled'] = (maya.cmds.checkBoxGrp, widget)
        
        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearMotorTargetSpeed'  ],
                                         numberOfFields=3)
        widgetDict['linearMotorTargetSpeed'] = (maya.cmds.floatFieldGrp, widget)

        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearMotorMaxForce'  ],
                                         numberOfFields=3)
        widgetDict['linearMotorMaxForce'] = (maya.cmds.floatFieldGrp, widget)
        
        widget = maya.cmds.checkBoxGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularMotorEnabled'  ], changeCommand=self.angularMotorEnabledCB, 
                                       numberOfCheckBoxes=1)
        widgetDict['angularMotorEnabled'] = (maya.cmds.checkBoxGrp, widget)

        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularMotorTargetSpeed'  ],
                                         numberOfFields=3)
        widgetDict['angularMotorTargetSpeed'] = (maya.cmds.floatFieldGrp, widget)

        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularMotorMaxForce'  ],
                                         numberOfFields=3)
        widgetDict['angularMotorMaxForce'] = (maya.cmds.floatFieldGrp, widget)

        # Springs ====
        widget = maya.cmds.checkBoxGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearSpringEnabledX'  ],
        							numberOfCheckBoxes=1)
        widgetDict['linearSpringEnabledX'] = (maya.cmds.checkBoxGrp, widget)

        widget = maya.cmds.checkBoxGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearSpringEnabledY'  ],
        							numberOfCheckBoxes=1)
        widgetDict['linearSpringEnabledY'] = (maya.cmds.checkBoxGrp, widget)

        widget = maya.cmds.checkBoxGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearSpringEnabledZ'  ],
        							numberOfCheckBoxes=1)
        widgetDict['linearSpringEnabledZ'] = (maya.cmds.checkBoxGrp, widget)

        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearSpringStiffness'  ],
        								numberOfFields=3)
        widgetDict['linearSpringStiffness'] = (maya.cmds.floatFieldGrp, widget)

        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kLinearSpringDamping'  ],
        								numberOfFields=3)
        widgetDict['linearSpringDamping'] = (maya.cmds.floatFieldGrp, widget)

        widget = maya.cmds.checkBoxGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularSpringEnabledX'  ],
        							numberOfCheckBoxes=1)
        widgetDict['angularSpringEnabledX'] = (maya.cmds.checkBoxGrp, widget)

        widget = maya.cmds.checkBoxGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularSpringEnabledY'  ],
        							numberOfCheckBoxes=1)
        widgetDict['angularSpringEnabledY'] = (maya.cmds.checkBoxGrp, widget)

        widget = maya.cmds.checkBoxGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularSpringEnabledZ'  ],
        							numberOfCheckBoxes=1)
        widgetDict['angularSpringEnabledZ'] = (maya.cmds.checkBoxGrp, widget)

        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularSpringStiffness'  ],
        								numberOfFields=3)
        widgetDict['angularSpringStiffness'] = (maya.cmds.floatFieldGrp, widget)

        widget = maya.cmds.floatFieldGrp(label=maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kAngularSpringDamping'  ],
        								numberOfFields=3)
    ...
    def command(
        ...
        logger.debug( maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kCreatingRBC'  ] \
        ...
        logger.info(maya.stringTable['y_maya_app_mayabullet_RigidBodyConstraint.kRigidBodiesToConnect' ] % (rigids, parent))
        if len(rigids) == 0 or len(rigids) > 2:
            # TODO: this produces a pretty difficult to read error for the user.
            maya.OpenMaya.MGlobal.displayError(maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kPleaseSelectRigidbodies'  ])
            return []
        if len(rigids) == 1 and locals()['constraintType'] in (eConstraintType.kRBConstraintHinge2, eConstraintType.kRBConstraintSixDOF2):
            maya.OpenMaya.MGlobal.displayError(maya.stringTable[ 'y_maya_app_mayabullet_RigidBodyConstraint.kPleaseSelectTwoRigidbodies'  ])
            return []
