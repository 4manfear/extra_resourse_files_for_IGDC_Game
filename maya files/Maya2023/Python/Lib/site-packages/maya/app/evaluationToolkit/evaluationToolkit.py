...
from maya.debug.em_debug_utilities import convert_exception_to_unicode, get_all_custom_evaluators_clusters, dotFormatting
...
from maya.app.evaluationToolkit.EvaluationToolkitSectionGPUOverride import EvaluationToolkitSectionGPUOverride
...
# Window ID for the main window
kWindowName = 'evaluationToolkitWindowId'

# Key values for each of the sections
kSectionHUD       = 'HUD'
kSectionDebugging = 'Debugging'
kSectionGPUOverride = 'GPU Override'
...
kEvaluationManagerModes = [
    ('off',            maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDGMode' ],                         1),
    ('serial',         maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEMSMode' ],                    2),
    ('parallel',       maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEMPMode' ],                  3),
    ]
kCorrectnessModeNames = {
    'ems': maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEMSerialWithEnabledEvaluators'   ]
,   'emp': maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEMParallelWithEnabledEvaluators' ]
}
...
kTestNotRun = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kTestNotRun' ]

# Processing types
kProcessTypes = [
      (True,  maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kProcessTypeAll'                ],           1,
              maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kAnnotationProcessTypeAll'      ])
    , (False, maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kProcessTypeSelected'           ],      2,
              maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kAnnotationProcessTypeSelected' ])
    ]
...
kDynamicsOptions = [
    ('disablingNodes', maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsDisablingNodes' ], kNodeOptions),
    ('handledNodes',   maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsHandledNodes' ], kNodeOptions),
    ('action',         maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsAction' ], kActionOptions),
    ]

kDynamicsModes = [
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsDisabled' ],                     ('dynamics',    'none',     'none')),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsLegacy2016' ],                ('legacy2016',  'none',     'none')),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsSupported' ],                   ('unsupported', 'dynamics', 'evaluate')),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsEverything' ], ('none',        'dynamics', 'evaluate')),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsCustom' ],         None)
    ]

# Freeze option modes.
kFreezeDownstreamModes = [
    ('none',  maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeDownstreamOffMode' ]),
    ('safe',  maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeDownstreamSafeMode' ]),
    ('force', maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeDownstreamForceMode' ])
    ]

kFreezeUpstreamModes = [
    ('none',  maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeUpstreamOffMode' ]),
    ('safe',  maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeUpstreamSafeMode' ]),
    ('force', maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeUpstreamForceMode' ])
    ]

# Scheduling types.
kSchedulingTypes = [
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSchedulingTypeNone' ],                             None,                       None),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSchedulingTypeParallel' ],                    'nodeTypeParallel',          'Parallel'),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSchedulingTypeSerialize' ],                  'nodeTypeSerialize',         'Serial'),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSchedulingTypeGloballySerialize' ], 'nodeTypeGloballySerialize', 'GloballySerial'),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSchedulingTypeUntrusted' ],                  'nodeTypeUntrusted',         'Untrusted'),
    ]

# Labels.
kPrintLabel = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelPrint' ]
kSelectLabel = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelSelect' ]
kRunLabel = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelRun' ]
kGenerateLabel = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelGenerate' ]
kOpenLabel = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelOpen' ]
kRemoveLabel = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelRemove' ]
kShowLabel = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelShow' ]
kSetLabel = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelSet' ]

# Formatting
kUIRateFmt = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFramePerSecondUIString' ]

# Miscellaneous Strings
kNodeNotInCluster = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kNodeNotInCluster' ]

# Idle actions
kIdleActions = [
    (emModeManager.idle_action_none, maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kIdleActionNone' ]),
    (emModeManager.idle_action_build, maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kIdleActionRebuild' ]),
    (emModeManager.idle_action_manipPrepare, maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kIdleActionPrepareManip' ]),
    (emModeManager.idle_action_buildAndManipPrepare, maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kIdleActionRebuildPrepareManip' ])
]

# Invisibility modes
kInvisibilityModes = [
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityPartitioning' ],
     'partitioning',
     maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityPartitioningAnnotation' ]
     ),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityScheduling' ],
     'scheduling',
     maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilitySchedulingAnnotation' ]
     ),
    ]

# Invisibility notification modes
kInvisibilityNotificationModes = [
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityNotificationNone' ],
     'none',
     maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityNotificationNoneAnnotation' ]
     ),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityNotificationVisibility' ],
     'visibility',
     maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityNotificationVisibilityAnnotation' ]
     ),
    (maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityNotificationTransformGeometry' ],
     'transform_geometry',
     maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityNotificationTransformGeometryAnnotation' ]
     ),
    ]
...
class EvaluationToolkit(object):
    ...
    def __init__(self, windowName=kWindowName):
        """
        Simple constructor.
        ...
        self.windowTitle = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEvaluationToolkitTitle' ]
    ...
    def create(self):
        ...
        with LayoutManager(cmds.scrollLayout(childResizable=True)):
            with LayoutManager(cmds.columnLayout(adjustableColumn=True)):
                ...
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameConfiguration' ], **section_layout(True))):
                    with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameGraphvizOptions' ], **section_layout(True))):
                        self.checkboxUseSystemGraphviz = cmds.checkBox(
                            label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kUseSystemGraphviz' ],
                            value=False
                            )

                        with LayoutManager(cmds.rowColumnLayout(numberOfColumns=2, columnSpacing=[(1,COLUMN_SPACING), (2,COLUMN_SPACING)])):
                            cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kShowGraphvizVersion' ])
                            cmds.button(
                                label=kShowLabel,
                                width=BUTTON_WIDTH,
                                command=callback_tool(self, callback_CFG_PrintGraphvizVersion),
                                annotation=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kShowGraphvizVersionAnnotation' ]
                                )

                #}{---------------------------------------------------------------------
                # Modes Section
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameModes' ], **section_layout(False))):
                    self.evaluationModeList = cmds.optionMenuGrp(
                        label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEvaluationMode' ],
                    ...
                    self.checkboxGPUOverride = cmds.checkBoxGrp(
                        label='',
                        label1=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kGPUOverride' ],
                        changeCommand=callback_tool(self, callback_01_UpdateGPUOverride)
                        )
                    self.checkboxControllerPrepopulate = cmds.checkBoxGrp(
                        label='',
                        label1=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kControllerPrepopulate' ],
                        changeCommand=callback_tool(self, callback_01_UpdateControllerPrepopulate)
                        )

                    self.layoutModesAdvanced = cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameModesAdvanced' ], **section_layout(True))
                    with LayoutManager(self.layoutModesAdvanced):
                        self.checkboxManipulation = cmds.checkBoxGrp(
                            label='',
                            label1=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kManipulation' ],
                            changeCommand=callback_tool(self, callback_01_UpdateManipulation)
                            )
                        self.checkboxManipulationPrevalidation = cmds.checkBoxGrp(
                            label='',
                            label1=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kManipulationPrevalidation' ],
                            changeCommand=callback_tool(self, callback_01_UpdateManipulationPrevalidation)
                            )
                        self.checkboxReduceGraphRebuild = cmds.checkBoxGrp(
                            label='',
                            label1=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kReduceGraphRebuild' ],
                            changeCommand=callback_tool(self, callback_01_UpdateReduceGraphRebuild)
                            )
                        self.idleActionList = cmds.optionMenuGrp(
                            label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kIdleAction' ],
                ...
                #}{---------------------------------------------------------------------
                # HUD Section
                self.sections[kSectionHUD] = EvaluationToolkitSectionHUD( maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameHeadsUpDisplay' ], True )

                #}{---------------------------------------------------------------------
                # Debugging Section
                self.sections[kSectionDebugging] = EvaluationToolkitSectionDebugging(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameDebugging' ], True, partial(get_graphviz_manager, tool=self))

                #}{---------------------------------------------------------------------
                # Custom Evaluators Section
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameCustomEvaluators' ], **section_layout(True))):
                ...
                #}{---------------------------------------------------------------------
                # Dynamics Section
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameDynamicsEvaluator' ], **section_layout(True))):
                    self.dynamicsModeList = cmds.optionMenuGrp(
                        label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsMode' ],
                    ...
                    self.layoutDynamicsAdvanced = cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameDynamicsAdvanced' ], **section_layout(False))
                ...
                self.sections[kSectionGPUOverride] = EvaluationToolkitSectionGPUOverride( maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameGPUOverride' ], True, partial(get_graphviz_manager, tool=self) )

                #}{---------------------------------------------------------------------
                # Selection Section
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameSelection' ], **section_layout(True))):
                    with LayoutManager(cmds.rowColumnLayout(numberOfColumns=2,  columnAlign=[(1, 'right'), (2, 'left')], columnSpacing=[(1,COLUMN_SPACING), (2,COLUMN_SPACING)])):
                        cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSelectNodesUnderEvaluationManagerControl' ])
                        ...
                        cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSelectUpStreamNodes' ])
                        cmds.button(label=kSelectLabel, width=BUTTON_WIDTH, command=callback_tool(self, callback_07_SelectUpStreamNodes))

                        cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSelectDownStreamNodes' ])
                        cmds.button(label=kSelectLabel, width=BUTTON_WIDTH, command=callback_tool(self, callback_07_SelectDownStreamNodes))

                #}{---------------------------------------------------------------------
                # Cycles Section
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameCycles' ], **section_layout(True))):
                    ...
                    if True:
                        ...
                        outputFolder = tempfile_gettempdir()
                    else:
                        from os import path as os_path
                        workspace = cmds.workspace(fullName=True)
                        outputFolder = os_path.join(workspace, 'data')
                    kLabelTransitiveReduction = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kPerformTransitiveReduction' ]

                    with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameCyclesFullGraph' ], **section_layout(False))):
                        ...
                        self.checkboxMarkClusters = cmds.checkBox(
                            label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kMarkClustersInFullGraph' ],
                            value=True
                            )

                    with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameCyclesCycleGraph' ], **section_layout(False))):
                        cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kCycleClusters' ], align='left')
                        ...
                        with LayoutManager(cmds.rowLayout(numberOfColumns=2, adjustableColumn=1)):
                            ...
                            with LayoutManager(cmds.columnLayout()):
                                cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kCycleSizeThreshold' ])
                                ...
                                with LayoutManager(cmds.rowLayout(numberOfColumns=3)):
                                    cmds.symbolButton(image='cycle.png',
                                                      annotation=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kRefreshList' ],
                                                      statusBarMessage=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kRefreshCyclesAnnotation' ],
                                                      command=callback_tool(self, callback_08_RefreshCycleClusters))
                                    cmds.symbolButton(image='selectCycle.png',
                                                      annotation=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSelectCycle' ],
                                                      statusBarMessage=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSelectCycleAnnotation' ],
                                                      command=callback_tool(self, callback_08_SelectCycleBasedOnSelection))
                                    cmds.symbolButton(image='cycleList.png',
                                                      annotation=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kListNodes' ],
                                                      statusBarMessage=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kListNodesAnnotation' ],
                                                      command=callback_tool(self, callback_08_ListNodesInCycleCluster))

                        with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameShortestPath' ], **section_layout(True))):
                            with LayoutManager(cmds.rowColumnLayout(numberOfColumns=3, columnAlign=[(1, 'right'), (2, 'left')], columnSpacing=[(1,COLUMN_SPACING), (2,COLUMN_SPACING)])):
                                kLabelPickSelected = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelPickSelected' ]

                                cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSourceNode' ])
                                ...
                                cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDestinationNode' ])
                                ...
                                self.checkboxOnlyShortestPath = cmds.checkBox(
                                    label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelOnlyShortestPath' ],
                                    value=False
                                    )
                    ...
                    with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameCyclesDependencies' ], **section_layout(True))):
                        with LayoutManager(cmds.formLayout()) as dependenciesForm:
                            kLabelChooseSelected = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelChooseSelected' ]

                            textUpstream = cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kUpstreamNodes' ])
                            ...
                            textDownstream = cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDownstreamNodes' ])
                ...
                #----------------------------------------
                validation_frame = cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameValidation' ], **section_layout(True))
                with LayoutManager( validation_frame ):
                    ...
                    with LayoutManager(cmds.rowColumnLayout( numberOfColumns=7
                        ...
                        #----------------------------------------
                        cmds.button( label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kRunPerformanceTest' ]
                                   , width=BUTTON_WIDTH
                        ...
                        #----------------------------------------
                        cmds.button( label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kRunCorrectnessTest' ]
                                   , width=BUTTON_WIDTH
                                   , command=callback_tool(self, callback_09_RunCorrectnessTest) )
                        self.correctness_result_fields = {}
                        cmds.text( label='' )
                        cmds.text( label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelErrors' ] )
                        cmds.text( label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelSerial' ] )
                        self.correctness_result_fields['ems'] = cmds.text( label=kTestNotRun )
                        cmds.text( label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kLabelParallel' ] )
                ...
                #}{---------------------------------------------------------------------
                # Reports Section
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameReports' ], **section_layout(True))):
                ...
                #}{---------------------------------------------------------------------
                # Freezing Section
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameFreezing' ], **section_layout(True))):
                    self.checkboxFreezePropagation = cmds.checkBoxGrp(
                        label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrozenProgataion' ],
                        numberOfCheckBoxes=2,
                        label1=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezePropagation' ],
                        changeCommand1=callback_tool(self, callback_11_UpdateFreezeRuntimePropagation),
                        label2=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeExplicitPropagation' ],
                    ...
                    self.freezeDownstreamModeList = cmds.optionMenuGrp(
                        label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeDownstreamMode' ],
                    ...
                    self.freezeUpstreamModeList = cmds.optionMenuGrp(
                        label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeUpstreamMode' ],
                    ...
                    self.checkboxFreezeInvisible = cmds.checkBoxGrp(
                        label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeInvisibleLabel' ],
                        numberOfCheckBoxes=2,
...
#                        changeCommand3=callback_tool(self, callback_11_UpdateFreezeReferencedNodes),
                        label1=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeInvisibleNodes' ],
                        changeCommand1=callback_tool(self, callback_11_UpdateFreezeInvisibleNodes),
                        label2=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFreezeInvisibleDisplayLayers' ],
                    ...
                    with LayoutManager(cmds.rowLayout(numberOfColumns=4, columnAlign=[(1, 'right'), (2, 'center'), (3, 'center'), (4, 'center')])):
                        cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrozenNodes' ], width=kGroupLabelWidth)
                        ...
                        cmds.button(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kUnfreezeAll' ], width=BUTTON_WIDTH, command=callback_tool(self, callback_11_UnfreezeAllFrozenNodes))

                #}{---------------------------------------------------------------------
                # Scheduling Section
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameScheduling' ], **section_layout(True))):
                    ...
                    with LayoutManager(cmds.rowColumnLayout(**kSchedulingRowLayoutParams)):
                        cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSchedulingType' ])
                    ...
                    with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kRegisteredNodeTypes' ], **section_layout(False))):
                        with LayoutManager(cmds.rowColumnLayout(**kSchedulingRowLayoutParamsInFrame)):
                            ...
                            cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSchedulingOverrideForSelectedTypes' ])
                    ...
                    with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSelectedNodes' ], **section_layout(False))):
                        with LayoutManager(cmds.rowColumnLayout(**kSchedulingRowLayoutParamsInFrame)):
                            cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSchedulingOverrideForTypesOfSelectedNodes' ])
                            with LayoutManager(cmds.rowColumnLayout(numberOfColumns=2, columnSpacing=[(1,0), (2,COLUMN_SPACING)])):
                            ...
                            cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSchedulingUsedForSelectedNodes' ])
                            with LayoutManager(cmds.rowColumnLayout(numberOfColumns=2, columnSpacing=[(1,0), (2,COLUMN_SPACING)])):
                ...
                #}{---------------------------------------------------------------------
                # Caching Section
                self.sections[kSectionCaching] = EvaluationToolkitSectionCaching(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameCacheEvaluator' ], True)

                #}{---------------------------------------------------------------------
                # Invisibility Section
                with LayoutManager(cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameInvisibilityEvaluator' ], **section_layout(True))):
                    two_column_layout = dict(numberOfColumns=2, columnSpacing=[(1,COLUMN_SPACING), (2,COLUMN_SPACING)], columnAlign=[(1, 'right'), (2, 'center')])
                    with LayoutManager(cmds.rowColumnLayout(**two_column_layout)):
                        cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityMode' ],)
                        self.invisibilityModeList = cmds.optionMenu(
                            changeCommand=callback_tool(self, callback_14_UpdateInvisibilityMode)
                            )
                        for mode in kInvisibilityModes:
                            cmds.menuItem(parent=self.invisibilityModeList, label=mode[0], annotation=mode[2])

                        cmds.separator(style='none', height=20)
                        cmds.separator(style='none', height=20)

                        cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvalidateVisibility' ])
                        self.invisibilityInvalidateButton = cmds.button(
                            label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvalidateVisibilityLabel' ],
                            width=BUTTON_WIDTH,
                            command=callback_tool(self, callback_14_Invalidate),
                            annotation=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvalidateVisibilityAnnotation' ]
                            )

                    self.layoutInvisibilityAdvanced = cmds.frameLayout(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityAdvanced' ], **section_layout(True))
                    with LayoutManager(self.layoutInvisibilityAdvanced):
                        self.invisibilityNotificationModeList = cmds.optionMenuGrp(
                            label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kInvisibilityNotificationMode' ],
                            changeCommand=callback_tool(self, callback_14_UpdateInvisibilityNotificationMode)
                            ) + '|OptionMenu'
                        for mode in kInvisibilityNotificationModes:
                            cmds.menuItem(parent=self.invisibilityNotificationModeList, label=mode[0], annotation=mode[2])
    ...
    def _createGraphWidget(defaultPath, defaultBaseName, command):
        ...
        def callbackFolderChooser(widget, textfield):
            ...
            result = cmds.fileDialog2(
                caption=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kChooseOutputFolder' ],
                fileMode=3,
                okCaption=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kChooseButton' ],
                startingDirectory=os_path.dirname(currentFolder + '/')
                )
            if result:
                assert(len(result) == 1)
                chosenFile = os_path.normpath(result[0])
        ...
        def callbackOpenFile(widget, textfieldFolder, textfieldBaseName):
            ...
            from os import path as os_path
            open_file(os_path.join(folder, baseName + '.pdf'))

        with LayoutManager(cmds.rowColumnLayout(numberOfColumns=4)) as layout:
            cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kOutputFolder' ])
            from os import path as os_path
            textfieldFolder = cmds.textField(
                width=FILE_TEXT_FIELD_WIDTH,
                text=os_path.normpath(defaultPath)
                )
            ...
            cmds.text(label=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kOutputBaseFileName' ])
...
def require_evaluation_graph(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if 'off' == getEvaluationManagerMode():
            cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEvaluationManagerNotActive' ])
            return
...
def callback_CFG_PrintGraphvizVersion(tool):
    ...
    windowTitleString = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kGraphvizVersionTitle' ]
...
def updateUI_01_Mode(self):
    ...
    if mode not in modeToIndex:
        ...
        cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kWarningUnknownEvaluationMode' ])
        ...
        cmds.checkBoxGrp(self.checkboxManipulationPrevalidation, edit=True, enable=False)
        cmds.checkBoxGrp(self.checkboxReduceGraphRebuild, edit=True, enable=False)
        ...
        manipulationActive = isManipulationActive()
        cmds.checkBoxGrp(self.checkboxManipulation, edit=True, enable=enabled, value1=manipulationActive)
        cmds.checkBoxGrp(self.checkboxManipulationPrevalidation, edit=True, enable=enabled and manipulationActive, value1=isManipulationPrevalidationActive())
        cmds.checkBoxGrp(self.checkboxReduceGraphRebuild, edit=True, enable=enabled, value1=isReduceGraphRebuild())
...
def callback_01_UpdateEvaluationMode(tool):
    ...
    for section in list(tool.sections.values()):
        section.update_ui()
...
def callback_01_UpdateReduceGraphRebuild(tool):
    value = cmds.checkBoxGrp(tool.checkboxReduceGraphRebuild, query=True, value1=True)
    setReduceGraphRebuild(value)
    updateUI_00_Viewport(tool)
    updateUI_01_Mode(tool)
...
def callback_01_UpdateManipulationPrevalidation(tool):
    value = cmds.checkBoxGrp(tool.checkboxManipulationPrevalidation, query=True, value1=True)
    setManipulationPrevalidationActive(value)
    ...
    with LayoutManager(self.layoutEvaluators):
        ...
        for evaluator in evaluators:
            ...
            cmds.button(label=' ? ', command=callback_tool(self, partial(callback_04_ShowHelpEvaluator, evaluator=evaluator))
                                   , annotation=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kShowEvaluatorHelp' ] % evaluator)
            cmds.button(label=' i ', command=callback_tool(self, partial(callback_04_PrintEvaluatorInfo, evaluator=evaluator))
                                   , annotation=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kPrintEvaluatorInfo' ] % evaluator)
            cmds.button(label=' n ', command=callback_tool(self, partial(callback_04_ShowEvaluatorNodes, evaluator=evaluator))
                                   , annotation=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kClaimedNodesAnnotation' ] % evaluator)
...
def callback_04_ShowHelpEvaluator(tool, evaluator):
    assert tool
    windowTitleString = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEvaluatorDescription' ]
    windowMessageString = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEvaluatorDescriptionHelpHeader' ] % evaluator
...
def callback_04_GetEvaluatorInfo(tool, evaluator):
    ...
    if evaluator != 'deformer':
        return maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEvaluatorInfoHeader' ].format(evaluator, cmds.evaluator(name=evaluator, query=True, info=True))
    ...
    try:
        ...
        for cluster in cluster_list:
            ...
            for chain in chains:
                ...
                if len(chain_list) == 0:
                    deformer_info += maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDeformerTitleNoChain' ]
                else:
                    deformer_info += maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDeformerTitleChain' ].format( chain_list[0] )
                    for chain_node in chain_list[1:]:
                        deformer_info += maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDeformerTitleChainContd' ].format( chain_node )
                    deformer_info += '\n'

                if 'vertexCount' in chain:
                    deformer_info += maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDeformerTitleVertexCount' ].format( chain['vertexCount'] )

            unchained = cluster.get( 'unchained', [] )
            if len(unchained) > 0:
                deformer_info += maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDeformerTitleUnchained' ].format( unchained[0] )
                for unchained_node in unchained[1:]:
                    deformer_info += maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDeformerTitleUnchainedContd' ].format( unchained_node )
                deformer_info += '\n'
            deformer_info += '\n'
        ...
        return maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDeformerInfoError' ].format( ex )

def callback_04_PrintEvaluatorInfo(tool, evaluator):
    assert tool
    scrollableMessageBox( title=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEvaluatorInfo' ]
...
def callback_04_GetClaimedNodes(tool, evaluator):
    ...
    if len(claimed_nodes or []) == 0:
        return maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kNoNodesClaimed' ] % evaluator

    return json.dumps( claimed_nodes, indent=4, separators=(',', ': ') )
...
def callback_04_ShowEvaluatorNodes(tool, evaluator):
    ...
    :param evaluator: The name of the evaluator whose claimed nodes are requested
    '''
    scrollableMessageBox( title=maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEvaluatorClaimedNodesTitle' ] % evaluator
                        , messageCallback=partial(callback_04_GetClaimedNodes, tool=tool, evaluator=evaluator)
                        )

# ----------------------------------------------------------------------
def updateUI_05_Dynamics(self):
    # If the dynamics evaluator isn't loaded then there is nothing to update
    if 'dynamics' not in cmds.evaluator( q=True ):
        return
    ...
    for option in kDynamicsOptions:
        ...
        if value in values:
            ...
            cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDynamicsUnknownValue' ] % (value, valueName))
...
def callback_08_GenerateFullGraph(tool):
    ...
    from os import path as os_path
    outDOT = os_path.join(outFolder, outBaseName + '.dot')
    outPDF = os_path.join(outFolder, outBaseName + '.pdf')
    ...
    if not gv_mgr.convert_dot_to(outDOT, outPDF, performTransitiveReduction):
        return
...
def callback_08_SelectCycleBasedOnSelection(tool):
        ...
        for item in sl:
            ...
            if item in cluster:
                if len(cluster) < tool.cycleClustersThreshold:
                    ...
                    cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSelectedNodeInCycleNotShown' ] % item, noContext=True)
                    cmds.textScrollList(tool.cyclesList, edit=True, deselectAll=True)
                    return

                if (tag is not None) and (tag != cluster[0]):
                    cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kNotInSameCluster' ], noContext=True)
                    cmds.textScrollList(tool.cyclesList, edit=True, deselectAll=True)
                    return
    ...
    if tag != None:
        ...
        cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSelectedNodesNotInCluster' ], noContext=True)
        cmds.textScrollList(tool.cyclesList, edit=True, deselectAll=True)
...
def callback_08_SelectNode(tool, textfield):
    ...
    if len(selection) == 0:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kNoSelectionError' ])
        return
    elif len(selection) > 1:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kTwoManyNodesError' ])
        return
...
def callback_08_GenerateCycleGraph(tool):
    selectedValue = cmds.textScrollList(tool.cyclesList, query=True, selectItem=True)
    if not selectedValue:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSelectACluster' ])
        return
    ...
    if sourceNode and destinationNode:
        if sourceNode == destinationNode:
            cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSourceAndDestinationNodesAreTheSame' ])
        elif sourceNode not in cycleCluster:
            cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSourceNodeNotInCluster' ] % sourceNode)
        elif destinationNode not in cycleCluster:
            cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kDestinationNodeNotInCluster' ] % destinationNode)
        else:
            shortestPathInfo = ((sourceNode, destinationNode), onlyShortestPath)
            if performTransitiveReduction:
                cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kTransitiveReductionWarning' ])
...
def callback_08_GenerateDependenciesGraph(tool):
    ...
    if not upstreamNodes:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kErrorSelectUpstreamNodes' ])
        return
    elif not downstreamNodes:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kErrorSelectDownstreamNodes' ])
        return
    else:
        commonNodes = set(upstreamNodes).intersection(downstreamNodes)
        if commonNodes:
            message = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kErrorCommonNodes' ]
...
def clear_09_Validation(tool):
    ...
    for field in list(tool.performance_result_fields.values()):
        cmds.text( field, edit=True, label=kTestNotRun )

    for field in list(tool.correctness_result_fields.values()):
        cmds.text( field, edit=True, label=kTestNotRun )

def callback_09_RunPerformanceTest(tool):
    for (run_type, speed) in list(runEMPerformanceTest().items()):
        cmds.text( tool.performance_result_fields[run_type], edit=True, label=speed )

def callback_09_RunCorrectnessTest(tool):
    for (run_type, error_count) in list(runEMCorrectnessTest().items()):
...
def updateUI_11_FreezeOptions(self):
    ...
    if downstream_mode not in mode_to_index:
        # This should not happen, it means there is a new unsupported mode.
        cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kWarningUnknownFreezeDownstreamMode' ])
    ...
    if upstream_mode not in mode_to_index:
        # This should not happen, it means there is a new unsupported mode.
        cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kWarningUnknownFreezeUpstreamMode' ])
...
def callback_11_SelectFrozenNodes(tool):
    ...
    if frozenNodes:
        ...
        print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kNoFrozenNodeToSelectMessage' ])
...
def callback_11_PrintFrozenNodes(tool):
    ...
    if frozenNodes:
        ...
        print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kNoFrozenNodeToPrintMessage' ])
...
def callback_11_UnfreezeAllFrozenNodes(tool):
    ...
    if not unfreeze_nodes(None):
        print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kNoFrozenNodeToUnfreezeMessage' ])
...
def callback_12_PrintSchedulingForTypes(tool):
    ...
    if not selectedTypes:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kPrintSchedulingForTypesErrorMessage' ])
        return
...
def callback_12_SetSchedulingForTypes(tool):
    selectedTypes = cmds.textScrollList(tool.nodeTypesList, query=True, selectItem=True)
    if not selectedTypes:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSetSchedulingForTypesErrorMessage' ])
        return
...
def callback_12_PrintSchedulingForTypesOfNodes(tool):
    ...
    selection = cmds.ls(selection=True)
    if not selection:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kPrintSchedulingForNodesErrorMessage' ])
        return
...
def callback_12_SetSchedulingForTypesOfNodes(tool):
    selection = cmds.ls(selection=True)
    if not selection:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kSetSchedulingForNodesErrorMessage' ])
        return
...
def callback_12_PrintSchedulingUsedForNodes(tool):
    ...
    selection = cmds.ls(selection=True)
    if not selection:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kPrintSchedulingUsedForNodesErrorMessage' ])
        return

    schedulingInfo = json.loads(cmds.dbpeek(operation='graph', evaluationGraph=True, argument='scheduling', all=True))
    scheduling = schedulingInfo['scheduling']['scheduling']
    for node in selection:
        nodeSchedulingType = []
        for schedulingType in kSchedulingTypes:
...
# ----------------------------------------------------------------------
def updateUI_14_Invisibility(self):
    # If the invisibility evaluator isn't loaded then there is nothing to update
    if 'invisibility' not in cmds.evaluator( q=True ):
        return

    # Gather current options for mode.
    currentOptionsMode = cmds.evaluator(query=True, name='invisibility', valueName='mode')

    # Update main option for mode.
    kModesCustomIndex = len(kInvisibilityModes) - 1
    selectedIndex = kModesCustomIndex
    for i, mode in enumerate(kInvisibilityModes):
        if mode[1] == currentOptionsMode:
            selectedIndex = i
            break
    cmds.optionMenu(self.invisibilityModeList, edit=True, select=1+selectedIndex)


    # Gather current options for notification mode.
    currentOptionsNotificationMode = cmds.evaluator(query=True, name='invisibility', valueName='notification')

    # Update main option.
    kNotificationCustomIndex = len(kInvisibilityNotificationModes) - 1
    selectedIndex = kNotificationCustomIndex
    for i, mode in enumerate(kInvisibilityNotificationModes):
        if mode[1] == currentOptionsNotificationMode:
            selectedIndex = i
            break
    cmds.optionMenu(self.invisibilityNotificationModeList, edit=True, select=1+selectedIndex)


def callback_14_UpdateInvisibilityMode(tool):
    selectedIndex = cmds.optionMenu(tool.invisibilityModeList, query=True, select=True) - 1
    valueToSet = kInvisibilityModes[selectedIndex][1]
    if valueToSet:
        cmds.evaluator(name='invisibility', configuration='mode=%s' % valueToSet)

    updateUI_14_Invisibility(tool)


def callback_14_Invalidate(tool):
    cmds.evaluator(name='invisibility', configuration='action=invalidate')

    updateUI_14_Invisibility(tool)


def callback_14_UpdateInvisibilityNotificationMode(tool):
    selectedIndex = cmds.optionMenu(tool.invisibilityNotificationModeList, query=True, select=True) - 1
    valueToSet = kInvisibilityNotificationModes[selectedIndex][1]
    if valueToSet:
        cmds.evaluator(name='invisibility', configuration='notification=%s' % valueToSet)
...
def setReduceGraphRebuild(state):
    """
    This method activates or deactivates the reduce graph rebuild option of the
    graph.
    """

    return cmds.evaluationManager(reduceGraphRebuild=state)

def isReduceGraphRebuild():
    """
    This method activates or deactivates the reduceGraphRebuild of the
    graph.
    """

    return cmds.evaluationManager(query=True, reduceGraphRebuild=True)
...
def isManipulationPrevalidationActive():
    """
    This method returns True if manipulation prevalidation is used
    for evaluation manager manipulation, False otherwise.
    """

    return cmds.evaluationManager(query=True, manipulationPrevalidation=True)

def setManipulationPrevalidationActive(state):
    """
    This method activates or deactivates manipulation prevalidation for 
    manipulation using the evaluation manager.
    """

    cmds.evaluationManager(manipulationPrevalidation=state)
...
def getEvaluationGraph(attributes, allObjects=False):
    ...
    try:
        ...
        cmds.warning(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEvaluationGraphError' ])
        return None
...
def selectNextNodes(upstream=True):
    ...
    if len(selectionList) == 0:
        cmds.error(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kNextNodesError' ])
        return
...
def dumpEvaluationGraphToDot(fileName):
    ...
    customEvaluatorClusters = get_all_custom_evaluators_clusters()

    assert('_Cycle_' not in customEvaluatorClusters)
    # Cycles must be processed last.
    allClusters = list(customEvaluatorClusters.items()) + [('_Cycle_', cycleClusters)]
...
def open_file(file_name):
    ...
    try:
        ...
        message = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kErrorFileOpen' ]
...
def runEMPerformanceTest():
    ...
    rowDictionary = dict(list(zip(csv[0].split(',')[1:], csv[1].split(',')[1:])))

    startFrameTitle = emPerformanceOptions.COLUMN_TITLE_START_FRAME
    endFrameTitle = emPerformanceOptions.COLUMN_TITLE_END_FRAME

    frameCount = 0.0
    raw_rate_fmt = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFramePerSecondString' ]
    ...
    if startFrameTitle in rowDictionary and endFrameTitle in rowDictionary:
        try:
            ...
            print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kFrameRangeNotRecognizedWarning' ] % param)

    print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kPlaybackSpeeds' ])
    print('=' * 15)
    returned_speeds = {}
    for (mode, mode_index) in kPerformanceModeNames:
        ...
        if title not in rowDictionary:
            print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kPlaybackTimeNotFound' ] % title)
            continue
        try:
            title = options.getColumnTitle(viewport, testType, mode, emPerformanceOptions.COLUMN_STAT_AVG)
            ...
            print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kPlaybackTimeNotRecognized' ] % rowDictionary[title])
...
def runEMCorrectnessTest():
    ...
    output will be shown in the script editor window.
    """
    results = emCorrectnessTest(verbose=True, modes=list(kCorrectnessModeNames.keys()), maxFrames=20)
    print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kEMCorrectnessResults' ])
    print('=' * 22)
    for (resultType, result) in list(results.items()):
        if len(result) > 0:
            print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kChangeFormatString' ].format( kCorrectnessModeNames[resultType] ))
            print('    ' + '\n    '.join(result))
    ...
    for (resultType, result) in list(results.items()):
        ...
        if resultLength > 1:
            resultString = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kChangeResultPlural' ]
        else:
            resultString = maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kChangeResultSingular' ]
...
def printReportExpressions():
    ...
    print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kExpressionNodesCountTotal'  ] % param[0])
    print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kExpressionNodesCountUnsafe' ] % param[1])
    print(maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kExpressionNodesCountSafe'   ] % param[2])
...
def printReportPerformance():
    ...
    try:
        ...
        print(maya.stringTable[ 'y_maya_app_evaluationToolkit_evaluationToolkit.kPerformanceInvalidData'  ])
        return

    if 0 == len(lint_information):
        print(maya.stringTable[ 'y_maya_app_evaluationToolkit_evaluationToolkit.kLintNoProblem'  ])
    else:
        print(maya.stringTable[ 'y_maya_app_evaluationToolkit_evaluationToolkit.kLintProblemsFound'  ])
        print(json.dumps( lint_information, indent=4, separators=(',', ': ') ))
...
def getReports():
    ...
    return [
        ('expression', maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kExpressions' ], printReportExpressions),
        ('performance', maya.stringTable['y_maya_app_evaluationToolkit_evaluationToolkit.kPerformance' ], printReportPerformance),
        ]
