"""Property editor container factory.

   The property editor supports different UIs for different container
   types.  The property editor container factory provides an extensible
   mechanism to create the UI for various container types.

   To create a property editor UI for a container class, a creator
   callable is registered on the data model container class type.
   ...
   The container factory is a singleton."""
import maya
...
kAlreadyRegistered = maya.stringTable['y_maya_app_renderSetup_views_propertyEditor_containerFactory.kAlreadyRegistered' ]
...
def register(typeName, creator):
    """Register a property editor UI creator for container type.
...
def unregister(typeName):
    """Unregister a property editor UI creator for container type.
...
def create(proxyItem, parent):
    """Create a property editor UI for container type.
