...
kPlugHasConnectedParent = maya.stringTable['y_maya_app_renderSetup_model_plug.kPlugHasConnectedParent' ]
kPlugHasNotSettableChild = maya.stringTable['y_maya_app_renderSetup_model_plug.kPlugHasNotSettableChild' ]
kUnsupportedAttribute   = maya.stringTable['y_maya_app_renderSetup_model_plug.kUnsupportedAttribute' ] 
kUnknownType            = maya.stringTable['y_maya_app_renderSetup_model_plug.kUnknownType' ] 
kArityMismatch          = maya.stringTable['y_maya_app_renderSetup_model_plug.kArityMismatch' ] 
kNotOverridablePlug     = maya.stringTable['y_maya_app_renderSetup_model_plug.kNotOverridablePlug' ]
kPlugWithoutLimits      = maya.stringTable['y_maya_app_renderSetup_model_plug.kPlugWithoutLimits' ]
kAddAttributePrivate    = maya.stringTable['y_maya_app_renderSetup_model_plug.kAddAttributePrivate' ]


kVectorTypeStr = maya.stringTable['y_maya_app_renderSetup_model_plug.kVectorTypeStr' ]
kCompoundTypeStr = maya.stringTable['y_maya_app_renderSetup_model_plug.kCompoundTypeStr' ]
...
def toUiUnits(type, value):
    if isinstance(type, list):
        return [ toUiUnits(t, v) for t, v in zip(type, value) ]
...
def toInternalUnits(type, value):
    if isinstance(type, list):
        return [ toInternalUnits(t, v) for t, v in zip(type, value) ]
...
class UnlockedGuard(object):
    ...
    def __exit__(self, type, value, traceback):
        ...
        plg = self.plg
        for plg, locked in zip(relatives(plg), self.lockedState):
...
class Plug(object):
    ...
    })(_absoluteOverridableTypes, _relativeOverridableTypes, _connectionOverridableTypes, list(range(1, kLast)))
    ...
    _stringsToTypes = {v: k for k, v in list(_typesToStrings.items())}
    @staticmethod
    ...
    _typesToLocalizedStrings = {
        kInvalid  : maya.stringTable['y_maya_app_renderSetup_model_plug.kInvalid' ],
        kFloat    : maya.stringTable['y_maya_app_renderSetup_model_plug.kFloat' ],
        kDouble   : maya.stringTable['y_maya_app_renderSetup_model_plug.kDouble' ],
        kInt      : maya.stringTable['y_maya_app_renderSetup_model_plug.kInt' ],
        kByte     : maya.stringTable['y_maya_app_renderSetup_model_plug.kByte' ],
        kBool     : maya.stringTable['y_maya_app_renderSetup_model_plug.kBool' ],
        kColor    : maya.stringTable['y_maya_app_renderSetup_model_plug.kColor' ],
        kEnum     : maya.stringTable['y_maya_app_renderSetup_model_plug.kEnum' ],
        kString   : maya.stringTable['y_maya_app_renderSetup_model_plug.kString' ],
        kFilename : maya.stringTable['y_maya_app_renderSetup_model_plug.kFilename' ],
        kObject   : maya.stringTable['y_maya_app_renderSetup_model_plug.kObject' ],
        kMessage  : maya.stringTable['y_maya_app_renderSetup_model_plug.kMessage' ],
        kTime     : maya.stringTable['y_maya_app_renderSetup_model_plug.kTime' ],
        kAngle    : maya.stringTable['y_maya_app_renderSetup_model_plug.kAngle' ],
        kDistance : maya.stringTable['y_maya_app_renderSetup_model_plug.kDistance' ],
        kArray    : maya.stringTable['y_maya_app_renderSetup_model_plug.kArray' ]
        }
    @staticmethod
    ...
    def type(self):
        ...
        if self._type is None:
            ...
            elif attr.hasFn(OpenMaya.MFn.kMatrixAttribute):
                self._type = Plug.kInvalid
    ...
    def _children(self):
        ...
        if isinstance(self._type, list):
            ...
            for child, t in zip(children, self.type):
                child._type = t
        return children
    ...
    def _createAttribute(self, nodeObj, longName, shortName, dict, undoable = kUndoable):
        ...
        if copy.plug.isCompound:
            for i in range(0, copy.plug.numChildren()):
    ...
    def _decodeProperties(self, dict):
        ...
        if plugType == Plug.kEnum and 'enum' in dict:
            enum = dict['enum']
            for val, name in list(enum.items()):
