...
# Errors
kRendererMismatch   = maya.stringTable['y_maya_app_renderSetup_model_aovs.kRendererMismatch' ]
kImportWrongRSFile        = maya.stringTable['y_maya_app_renderSetup_model_aovs.kImportWrongRSFile'       ]
...
def decode(aovsData, decodeType):
    ...
    try:
        ...
        raise RuntimeError(kRendererMismatch % (currentRenderer, list(aovsData.keys())[0]))
