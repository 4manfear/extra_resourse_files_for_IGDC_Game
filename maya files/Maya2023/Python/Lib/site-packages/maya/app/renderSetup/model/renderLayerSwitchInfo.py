...
kApplyLayer = maya.stringTable['y_maya_app_renderSetup_model_renderLayerSwitchInfo.kApplyLayer' ]
kUnapplyLayer = maya.stringTable['y_maya_app_renderSetup_model_renderLayerSwitchInfo.kUnapplyLayer' ]
kApplyOverride = maya.stringTable['y_maya_app_renderSetup_model_renderLayerSwitchInfo.kApplyOverride' ]
kUnapplyOverride = maya.stringTable['y_maya_app_renderSetup_model_renderLayerSwitchInfo.kUnapplyOverride' ]
kReadResolveConflicts = maya.stringTable['y_maya_app_renderSetup_model_renderLayerSwitchInfo.kReadResolveConflicts' ]
kImporting = maya.stringTable['y_maya_app_renderSetup_model_renderLayerSwitchInfo.kImported' ]
kReferencing = maya.stringTable['y_maya_app_renderSetup_model_renderLayerSwitchInfo.kReferenced' ]

IMPORT = 0
REFERENCE = 1

class RenderLayerSwitchInfo(with_metaclass(commonUtils.SingletonMetaClass, object)):
