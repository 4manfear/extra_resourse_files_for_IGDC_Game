...
import maya.app.renderSetup.model.group as groupModel
...
import maya.app.renderSetup.model.expandedState as expandedState
...
# Localized texts
kFile                 = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kFile'                 ]
kRenderSetup          = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kRenderSetup'          ]
kExportAll            = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportAll'            ]
kExportAllOptionsUIBuilder = "exportAllOptionsUIBuilder"
kExportSelectedOptionsUIBuilder = "exportSelectedOptionsUIBuilder"
kExportSelected       = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportSelected'       ]
kImportAll            = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportAll'            ]
kExportSceneRenderSettings = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportSceneRenderSettings' ]
kImportRenderSettings = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportRenderSettings' ]
kExportSceneAOVs           = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportSceneAOVs' ]
kImportAOVs           = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportAOVs'           ]
kImportLightGroups    = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportLightGroups'    ]
kExportVisibleLayerRenderSettings = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportVisibleLayerRenderSettings' ]
kExportVisibleLayerAOVs           = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportVisibleLayerAOVs' ]
kExportLightGroups                = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportLightGroups' ]
kHelp                 = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kHelp'                 ]
kMayaHelp             = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kMayaHelp'             ]
kRenderSetupHelp      = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kRenderSetupHelp'      ]
kOptions              = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kOptions'              ]
kPreferences          = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kPreferences'          ]
kRenderingPrefs       = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kRenderingPrefs'       ]
kRenderSettings       = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kRenderSettings'       ]
kAOVs                 = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kAOVs'                 ]
kUntitledCollection   = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kUntitledCollection'   ]
kUntColToolTip        = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kUntColToolTip'        ]
kLightsAddedByDefault = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kLightsAddedByDefault' ]
kLightsAddedToolTip     = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kLightsAddedToolTip' ]
kDisplayRSNodesEditors   = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kDisplayRSNodesEditors'   ]
kDisplayNodesToolTip    = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kDisplayNodesToolTip'      ]
kAlwaysListVisibleLayer = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kAlwaysListVisibleLayer'   ]
kAlwaysListVisibleLayerToolTip = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kAlwaysListVisibleLayerToolTip' ]
kShowWarningIcons     = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kShowWarningIcons'     ]
kShowWarningIconsToolTip       = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kShowWarningIconsToolTip' ]
kEdit                 = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kEdit'                 ]
kCut                  = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kCut'                  ]
kCopy                 = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kCopy'                 ]
kPaste                = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kPaste'                ]
kCutShortcut          = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kCutShortcut'          ]
kCopyShortcut         = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kCopyShortcut'         ]
kPasteShortcut        = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kPasteShortcut'        ]

kExportAllTitle         = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportAllTitle'        ]
kExportSelectedTitle    = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportSelectedTitle'   ]
kImportAllTitle         = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportAllTitle'        ]
kImportWrongFile        = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportWrongFile'       ]
kImportWrongRSFile        = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportWrongRSFile'       ]
kImportWrongFileWasTemplate = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportWrongFileWasTemplate' ]
kExportSelectionError   = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportSelectionError'  ]
kImportWrongContent     = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportWrongContent'    ]
kExportAVOsNoHandler    = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportAVOsNoHandler'   ]
kImportAVOsNoHandler    = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportAVOsNoHandler'   ]

kAvailableGlobalTemplates = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kAvailableGlobalTemplates'  ]
kAvailableUserTemplates   = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kAvailableUserTemplates'    ]

kCreateLayerButton  = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kCreateLayerButton'  ]
kImportLayerButton  = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kImportLayerButton'  ]
kListOnlySelectedLayersButton = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kListOnlySelectedLayersButton' ]
kListOnlyVisibleSelectedLayersButton = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kListOnlyVisibleSelectedLayersButton' ]

kAcceptImportButton = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kAcceptImportButton' ]
kRefreshLayerButton = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kRefreshLayerButton' ]

kCreateOverrideToolTip = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kCreateOverrideToolTip' ]
kSetLocalRenderToolTip = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kSetLocalRenderToolTip' ]

kCutAndCopyFailureMessage = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kCutAndCopyFailureMessage' ]

kExportAllHiddenLayersInfo = maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kExportAllHiddenLayersInfo' ]
...
def _exportLightGroups():
    prefs._exportNodesofGivenType(renderSettings.encode, kExportLightGroups, "\" LightGTemplates")
...
def _confirmDialogExportLights():
    maya.mel.eval("confirmDialogExportCurrentValues \"" + kExportLightGroups + "\" LightEditorTemplates;")

def _importAOVsFromPath(path):
    with open(path, "r") as file:
        aovData = json.load(file)
        if not isinstance(aovData, dict):
...
class SceneView(QTreeView):
    ...
    def __init__(self, parent):
        ...
        self.setStyle(RenderSetupStyle())
        ...
        # MAYA-95175:
        # 4k workaround to remove unnecessary scroll bar
        # Since SceneView's height is fixed and every row item is always shown, a scrollbar is never needed
        self.verticalScrollBar().setValue(0)
        self.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOff)

        self.buttonPressed = None

        self.setVisibilityAction = action.Action(scene.SET_VISIBILITY_ACTION, self)
        self.setVisibilityAction.triggered.connect(self._setVisibility)
        self.setRenderableAction = action.Action(scene.SET_RENDERABLE_ACTION, self)
        ...
        self.presetMenu = menu.Menu(scene.PRESET_MENU, self)
        self.presetMenuAction = action.Action(scene.PRESET_MENU, self.presetMenu, triggered=self._popupPresetMenu)

        self.aovsMenu = menu.Menu(scene.AOVS_MENU, self)
        self.aovsMenuAction = action.Action(scene.AOVS_MENU, self.aovsMenu, triggered=self._popupAOVsMenu)
        self.aovsExportCurrentAction = action.Action(scene.EXPORT_CURRENT_ACTION, self.aovsMenu)
        ...
        self.lightsMenu = menu.Menu(scene.LIGHTS_MENU, self)
        self.lightsMenuAction = action.Action(scene.LIGHTS_MENU, self.lightsMenu, triggered=self._popupLightsMenu)
        self.lightsExportAction = action.Action(scene.EXPORT_LIGHTGROUPS_ACTION, self.lightsMenu)
        self.lightsMenu.addAction(self.lightsExportAction)
        self.lightsExportAction.triggered.connect(lightEditorUI._exportLightGroups)
        self.lightsMenu.addSeparator()
        self.lightsImportAction = action.Action(scene.IMPORT_LIGHTGROUPS_ACTION, self.lightsMenu)
        self.lightsMenu.addAction(self.lightsImportAction)
        self.lightsImportAction.triggered.connect(lightEditorUI._importLightGroupSchema)


        self.expandCollapseAction = action.Action(scene.EXPAND_COLLAPSE_ACTION, self, triggered=self._toggleExpandCollapse)
    ...
    def _popupPresetMenu(self):
        ...
        exportCurrentPresetAction = action.Action(scene.EXPORT_CURRENT_ACTION, self.presetMenu)
        ...
        defaultPresetAction = action.Action(scene.DEFAULT_PRESET_ACTION, self.presetMenu)
        ...
        if len(globalPresets) > 0:
            globalPresetsAction = action.Action(scene.GLOBAL_PRESETS_ACTION, self.presetMenu)
            globalPresetsAction.setSeparator(True)
            self.presetMenu.addAction(globalPresetsAction)

            for globalPreset in globalPresets:
                globalPresetAction = action.Action(globalPreset, self.presetMenu)
        ...
        if len(userPresets) > 0:
            userPresetsAction = action.Action(scene.USER_PRESETS_ACTION, self.presetMenu)
            userPresetsAction.setSeparator(True)
            self.presetMenu.addAction(userPresetsAction)

            for userPreset in userPresets:
                userPresetAction = action.Action(userPreset, self.presetMenu)
    ...
    def _popupLightsMenu(self):
        self.lightsMenu.popup(QCursor.pos())
    ...
    def _getCurrentAction(self, point, index):
        ...
        if item:
            ...
            if actionName != None:
                ...
                elif (actionName == scene.LIGHTS_MENU):
                    return self.lightsMenuAction
...
class RenderSetupView(QTreeView):
    ...
    def __init__(self, parent):
        ...
        self.createGroupAction = action.Action(renderSetup.CREATE_GROUP_ACTION, self.contextMenu)
        self.createGroupAction.triggered.connect(partial(self._createGroup, groupModel.Group.kTypeId))
        ...
        if enableMtlAssign:
            self.createMaterialTemplateOverrideAction = action.Action(renderSetup.CREATE_MATERIAL_TEMPLATE_OVERRIDE_ACTION, self.contextMenu)
            self.createMaterialTemplateOverrideAction.triggered.connect(partial(self._createOverride, overrideTypeId=connectionOverrideModel.MaterialTemplateOverride.kTypeId))
        ...
        if enableMtlAssign:
            # insert the action after the material override action
            idx =  self.staticActions.index(self.createMaterialOverrideAction)
            self.staticActions.insert(idx+1, self.createMaterialTemplateOverrideAction)
    ...
    def applyItemChangeToAllRenderSetupItems(self):
        """ Updates the models and view of all collections, layers and attributes in Render Setup"""
        renderSetupLayers = renderSetupModel.instance().getChildren()
        for layer in renderSetupLayers:
            layer.itemChangedRecursive(refreshSelf = True)

    def updatePropertyEditorsLightsCollectionView(self):
        """ Updates the Property Editor view of lights collection when the
            include all lights in each render layer by default is enabled/disabled."""
        selectedIndexes = self.selectedIndexes()
        for selectedIndex in selectedIndexes:
            item = self._getCorrespondingItem(selectedIndex)
            if item.typeIdx() == renderSetup.LIGHTS_TYPE_IDX:
                item.modelChanged()

    def rowsInserted(self, parent, start, end):
        """ This method is called on two occasions:
                1. We create new layers, collections, overrides via the UI
                   - In this case the expandedState values will always be True
                   - We don't need to set the expandedState values as it's expected to be True
                   - If we set the expandedState value this will add "Set Expanded State" to the undo stack and
                     if a user created a collection via the UI they would have to press undo twice,
                     once to remove the "Set Exapnded State" call and a second time to remove the "Create Collection" call
                2. We import a JSON file
                   - In this case the expandedState value can be false and we must set the correct value for
                     the node, else default is true"""
        super(RenderSetupView, self).rowsInserted(parent, start, end)
        index = QModelIndex(parent)
        for row in range(start, end+1):
            index = index.child(row, 0)
            if self._getCorrespondingItem(index):
                expandedStateValue = expandedState.getExpandedStateValue(self._getCorrespondingItem(index).model)
                if not expandedStateValue:
                    self.setExpanded(index, False)
                else:
                    self.setExpanded(index, True, viewsOnly=True)

    @undo.chunk('Set Expanded State')
    def setExpanded(self, index, state, viewsOnly=False):
        """ Override from the Qt class
        Expands the group and saves its state """
        super(RenderSetupView, self).setExpanded(index, state)
        # The viewsOnly variable is set to True when this method is called as a
        # result of a notification from the model. We assume that the model is
        # already up-to-date, so we only update the views.
        if not viewsOnly:
            expandedState.setExpandedStateValue(self._getCorrespondingItem(index).model, state, notifyObservers=False)
    ...
    def dropEvent(self, event):
        ...
        index = self.indexAt(event.pos())
        if not index.isValid():
            self.restoreExpandedState(self.localModelRef, viewsOnly=True)
            return
        item = self.model().itemFromIndex(index)
        self.restoreExpandedState(item, viewsOnly=True)
    ...
    def paintEvent(self, e):
        ...
        if self.model().rowCount() == 0:
            ...
            painter.drawText(textRect, Qt.AlignCenter, maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kNoLayers' ])
    ...
    def showContextMenu(self, point):
        ...
        if numIndexes > 0:
            ...
            # Create group should be the second option in the dropdown menu
            if self.createGroupAction in applicableStaticActions:
                # Add collection option to the menu
                # addActions requires a list of list to process
                groupStaticAction = list([applicableStaticActions[0]])
                self.contextMenu.addActions(groupStaticAction)
                applicableStaticActions.pop(0)

            # Add the dynamic menus to the context menu for render layers and collections
            if numIndexes==1 and (self._getCorrespondingItem(selectedIndexes[0]).genericTypeIdx() == renderSetup.RENDER_LAYER_TYPE_IDX or self._getCorrespondingItem(selectedIndexes[0]).genericTypeIdx() == renderSetup.COLLECTION_TYPE_IDX or self._getCorrespondingItem(selectedIndexes[0]).genericTypeIdx() == renderSetup.GROUP_TYPE_IDX):
                self._clearTemplates()
    ...
    def _getCurrentAction(self, modifiers, point, index):
        ...
        if item:
            ...
            if item.rowCount() > 0:
                ...
                if item.type() == renderSetup.LIGHTS_CHILD_COLLECTION_TYPE:
                    leftOffset = indent + RenderSetupDelegate.LEFT_NON_TEXT_OFFSET
                else:
    ...
    def _createGroup(self, nodeType):
        item = self._getCorrespondingItem(self.currentIndex())
        if item:
            groupIndex = item.createGroup("", nodeType)
            if groupIndex!=self.currentIndex():
                self.expand(self.currentIndex())
                self.setCurrentIndex(groupIndex)
                if userPrefs.getEditMode():
                    self.edit(groupIndex)
    ...
    def _addTemplateMenusFromList(self, templateList, templateMenu):
        ...
        if templateList:
            ...
            loading = action.Action(maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kEmpty' ], templateMenu)
    ...
    def _initTemplatesThread(self, index, menuName, templateDir, topMenu, model):
        ...
        if  self.threads[index][-1].isRunning() == False:
            # The thread for this index was either just created or
            # it was stopped in _clearTemplates and needs to be restarted.
    ...
    def _exportFileBrowser(self, proxies, caption=kExportAllTitle, exportOptionsUIBuilder=kExportAllOptionsUIBuilder, message=None):
        ...
        if not os_path.exists(basePath):
            os_makedirs(basePath)
        ...
        selectedFilepath = cmds.fileDialog2(caption=caption,
                                            ...
                                            selectionChanged="exportOptionsUIContentBuilder",
    ...
    def restoreExpandedState(self, proxy, viewsOnly=False):
        ...
        for child in proxies:
            self.setExpanded(child.index(), expandedState.getExpandedStateValue(child.model), viewsOnly=viewsOnly)
            self.restoreExpandedState(child, viewsOnly=viewsOnly)
...
class RenderSetupCentralWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.importLightsAction = action.Action(kImportLightGroups, self.fileMenu)
        ...
        self.exportLightGroupsLightsAction = action.Action(kExportLightGroups, self.fileMenu)
        ...
        self.fileMenu.addAction(self.importLightsAction)
        ...
        self.fileMenu.addAction(self.exportLightGroupsLightsAction)
        ...
        self.importLightsAction.triggered.connect(lightEditorUI._importLightGroupSchema)
        ...
        self.exportLightGroupsLightsAction.triggered.connect(lightEditorUI._exportLightGroups)
        ...
        self.showWarningIcons = addMenuItemToOptionsMenu(kShowWarningIcons, kShowWarningIconsToolTip, userPrefs.ShowWarningIcons)

        self._includeAllLights = False
        self.addIncludeAllLightsSettingsObserver()
        self._hasAlwaysListVisibleLayerObserver = False
        self._hasRenderSetupIssuesObserver = False
        self._hasActiveLayerObserver = False
        self._showWarningIcons = False
        self.addShowWarningIconsSettingsObserver()
        ...
        expandedState.ExpandedStateChangedObservable().addItemObserver(self.setExpandedRenderSetupView)

    def setExpandedRenderSetupView(self, *posArgs, **kwArgs):
        if len(posArgs) == 0:
            self.restoreExpandedStateOfModel(viewsOnly=True)
            return
        dataModelNode = posArgs[0]
        # We react to the expanded state being changed within the model by
        # updating the views only.
        self.renderSetupView.setExpanded(renderSetup.getProxy(dataModelNode).index(), expandedState.getExpandedStateValue(dataModelNode), viewsOnly=True)
    ...
    def aboutToDelete(self):
        ...
        self.removeIncludeAllLightsSettingsObserver()
        self.removeShowWarningIconsSettingsObserver()
    ...
    def renderSetupAdded(self):
        ...
        self.restoreExpandedStateOfModel()
        self.addActiveLayerObserver()
    ...
    def restoreExpandedStateOfModel(self, viewsOnly=False):
        self.renderSetupView.restoreExpandedState(self.renderSetupView.localModelRef, viewsOnly=viewsOnly)
    ...
    def _optionsMenuAboutToBeShown(self):
        ...
        self._setStateOptionMenuItem(self.showWarningIcons, userPrefs.ShowWarningIcons)
    ...
    def _createToolBar(self):
        ...
        self.issueButton.setToolTip(maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kRenderSetupIssue' ])
    ...
    def addShowWarningIconsSettingsObserver(self):
        """ The showWarningIcons option should listen to changes made to
            the setting and update the property editor accordingly."""
        if not self._showWarningIcons:
            userPrefs.ShowWarningIcons.addOptionChangeObserver(self._updateWarningIconsDisplay)
            self._showWarningIcons = True

    def removeShowWarningIconsSettingsObserver(self):
        if self._showWarningIcons:
            userPrefs.ShowWarningIcons.removeOptionChangeObserver(self._updateWarningIconsDisplay)
            self._showWarningIcons = False

    def _updateWarningIconsDisplay(self):
        self.renderSetupView.applyItemChangeToAllRenderSetupItems()

    def addIncludeAllLightsSettingsObserver(self):
        """ The includeAllLights option should listen to changes made to
            the setting and update the property editor accordingly."""
        if not self._includeAllLights:
            userPrefs.IncludeAllLightsSetting.addOptionChangeObserver(self._updateLightCollectionsView)
            self._includeAllLights = True

    def removeIncludeAllLightsSettingsObserver(self):
        if self._includeAllLights:
            userPrefs.IncludeAllLightsSetting.removeOptionChangeObserver(self._updateLightCollectionsView)
            self._includeAllLights = False

    def _updateLightCollectionsView(self):
        self.renderSetupView.updatePropertyEditorsLightsCollectionView()
    ...
    def _issuesChanged(self):
        ...
        if issue:
            ...
            self.issueButton.setToolTip(issue.description+maya.stringTable['y_maya_app_renderSetup_views_renderSetupWindow.kDetails' ])
    ...
    def _importAllFromPath(self, path):
        try:
            # We impose the creation of the Render Setup node
            renderSetupModel.instance().importAllFromFile(path,
    ...
    def _importRenderSettingsFromPath(self, path):
        with open(path, "r") as file:
            ...
            if not isinstance(renderSettingsData, dict):
