...
def initialize(mplugin):
    ...
    for m in _initializeModules:
        m.initialize()
    utils.ProgressBar().registerAsProgressObserver()

def uninitialize(mplugin):

    # revert MAYA-71702: apparently unsufficient
    #from maya.app.renderSetup.views.renderSetup import renderSetupWindow
    #if renderSetupWindow:
    #    renderSetupWindow.close()

    utils.ProgressBar().unregisterAsProgressObserver()
