...
kParsingError             = maya.stringTable['y_maya_app_renderSetup_views_viewCmds.kParsingError'             ]
kAddAndDeselectEditOnly   = maya.stringTable['y_maya_app_renderSetup_views_viewCmds.kAddAndDeselectEditOnly'   ]
kNotEditableFlags         = maya.stringTable['y_maya_app_renderSetup_views_viewCmds.kNotEditableFlags'         ]
kAddAndDeselectNoTogether = maya.stringTable['y_maya_app_renderSetup_views_viewCmds.kAddAndDeselectNoTogether' ]
kSelectionEditFailed      = maya.stringTable['y_maya_app_renderSetup_views_viewCmds.kSelectionEditFailed'      ]
...
class RenderSetupSelectCmd(OpenMaya.MPxCommand):
    ...
    def doIt(self, args):
        ...
        if argDb.isQuery:
            ...
            models = [_f for _f in (utils.nameToUserNode(item) for item in itemsToSelect) if _f]
...
class RenderSetupHighlightCmd(OpenMaya.MPxCommand):
    ...
    def doIt(self, args):
        names = set((args.asString(i) for i in range(len(args))) \
