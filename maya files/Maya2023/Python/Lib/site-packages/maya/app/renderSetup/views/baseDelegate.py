...
class BaseDelegate(QStyledItemDelegate):
    ...
    GROUP_TEXT_RIGHT_OFFSET = utils.dpiScale(70)
    ...
    def paint(self, painter, option, index):
        ...
        # self._getItem is overriden in derived classes.
        item = self._getItem(index) # pylint: disable=assignment-from-no-return
