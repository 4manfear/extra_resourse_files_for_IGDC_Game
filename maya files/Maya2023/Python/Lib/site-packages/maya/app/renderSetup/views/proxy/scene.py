...
SCENE_STR           = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kScene' ]
RENDER_SETTINGS_STR = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kRenderSettings' ]
CAMERAS_STR         = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kCameras' ]
LIGHTS_STR          = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kLights' ]
AOVS_STR            = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kAOVs' ]
SELECTION_SETS_STR  = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kSelectionSets' ]

ROW_HEIGHT = 30

EXPAND_COLLAPSE_ACTION     = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kExpandCollapseAction' ]
SET_VISIBILITY_ACTION      = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kSetVisibilityAction' ]
SET_RENDERABLE_ACTION      = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kSetRenderableAction' ]
PRESET_MENU                = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kPresetMenu' ]
AOVS_MENU                  = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kAOVsMenu' ]
LIGHTS_MENU                = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kLightsMenu' ]
EXPORT_CURRENT_ACTION      = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kExportCurrentAction' ]
EXPORT_LIGHTGROUPS_ACTION  = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kExportLightgroupsAction' ]
DEFAULT_PRESET_ACTION      = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kDefaultPresetAction' ]
GLOBAL_PRESETS_ACTION      = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kGlobalPresetAction' ]
USER_PRESETS_ACTION        = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kUserPresetAction' ]
USER_LIGHTGROUPS_ACTION    = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kLightgroupsAction' ]
IMPORT_LIGHTGROUPS_ACTION  = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kImportLightgroupsAction' ]

RS_DEFAULT_RENDER_GLOBALS = "defaultRenderGlobals"
RS_START_FRAME = "startFrame"
RS_END_FRAME = "endFrame"
RS_ANIMATION = "animation"
RS_INVALID_NODE_NAME = maya.stringTable['y_maya_app_renderSetup_views_proxy_scene.kInvalidNodeName' ]
...
class SceneProxy(QStandardItemModel):
    ...
    def __init__(self, parent=None):
        ...
        if self.renderLayerManagerChangeCallback == 0:
