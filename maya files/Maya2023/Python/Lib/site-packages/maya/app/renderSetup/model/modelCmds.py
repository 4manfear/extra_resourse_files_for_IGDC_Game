...
kNotInNeedAListToFilter = maya.stringTable['y_maya_app_renderSetup_model_modelCmds.kNotInNeedAListToFilter' ]
kInvalidNodeName = maya.stringTable['y_maya_app_renderSetup_model_modelCmds.kInvalidNodeName' ]
...
class RenderLayerMembersCmd(OpenMaya.MPxCommand):
    ...
    def doIt(self, args):
        ...
        indices = iter(list(range(len(args))))
...
class RenderSetupCmd(OpenMaya.MPxCommand):
    ...
    def doIt(self, args):
        ...
        try:
            ...
            errorMsg = maya.stringTable['y_maya_app_renderSetup_model_modelCmds.kRenderSetupCmdParsingError' ]
            errorMsg += str(e)
        ...
        if not argDb.isQuery or not argDb.isFlagSet(RenderSetupCmd.kRenderLayersFlag):
            errorMsg = maya.stringTable['y_maya_app_renderSetup_model_modelCmds.kRenderSetupCmdInvalidUsage' ]
            OpenMaya.MGlobal.displayError(errorMsg)
            raise RuntimeError(errorMsg)
