...
class ApplyRelOverride(ApplyValueOverride, ApplyOverride):
    ...
    def _compute(self, plug, dataBlock, getMtd, setMtd, getModifierMtd):
        if (plug == self.out):
            ...
            if enabled:
                ...
                value = list(map(lambda orig, mult, ofs: orig*mult+ofs, value, multiply, offset)) \
    ...
    def setOverrideValue(self, overriddenPlug, autoKeyed):
        ...
        outValue0 = list(map(computeOutput, orig, mult, offset0)) if \
        ...
        offset1 = list(map(computeOffset, outValue1, outValue0, offset0)) if \
