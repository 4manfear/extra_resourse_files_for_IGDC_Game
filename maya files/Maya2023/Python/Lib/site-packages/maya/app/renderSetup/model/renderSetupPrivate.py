...
kCmdPrivate = maya.stringTable['y_maya_app_renderSetup_model_renderSetupPrivate.kCmdPrivate' ]
kSwitchVisibleRenderLayer = maya.stringTable['y_maya_app_renderSetup_model_renderSetupPrivate.kSwitchVisibleRenderLayer' ]
...
class SwitchVisibleRenderLayerCmd(OpenMaya.MPxCommand):
    ...
    def _switchToLayer(self, oldLayer, newLayer):
        ...
        startLayerSwitch = time.perf_counter()
        ...
        endLayerSwitch = time.perf_counter()
