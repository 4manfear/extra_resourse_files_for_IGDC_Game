...
class MemberGuardCtx(object):
    ...
    def __init__(self, obj, member, newVal=None):
        ...
        self.singleMember = isinstance(self.member, string_type)
...
class EnvironGuardCtx(object):
    ...
    Example:
        ...
        # At this point, os_environ['a'] == 'oldValue'
    ...
    def __init__(self, key, value):
        ...
        self.unsetenv = key not in os_environ
        self.key      = key
        self.value    = value
        self.oldValue = None
    ...
    def __enter__(self):
        ...
        if not self.unsetenv:
            self.oldValue = os_environ[self.key]
        os_environ[self.key] = self.value
        return None

    def __exit__(self, type, value, traceback):
        from os import environ as os_environ
        if self.unsetenv:
            del os_environ[self.key]
        else:
            os_environ[self.key] = self.oldValue
