...
class IncludeExpressionLabel(QLabel):
    ...
    def createStandardContextMenu(self, position):
        ...
        menu = QMenu()
        self.addIncludeExpressionAction = menu.addAction(maya.stringTable['y_maya_app_renderSetup_views_propertyEditor_expressionLabels.kAddIncludeExpression' ])
...
class ExcludeExpressionLabel(QLabel):
    ...
    def createStandardContextMenu(self, position):
        ...
        menu = QMenu()
        self.addExcludeExpressionAction = menu.addAction(maya.stringTable['y_maya_app_renderSetup_views_propertyEditor_expressionLabels.kAddExcludeExpression' ])
