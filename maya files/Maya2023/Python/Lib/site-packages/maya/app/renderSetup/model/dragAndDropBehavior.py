...
class DragAndDropBehavior(OpenMayaUI.MPxDragAndDropBehavior):
    ...
    # Error messages
    kErrorMsg_NoAttributeFound     = maya.stringTable['y_maya_app_renderSetup_model_dragAndDropBehavior.kNoAttributeFound'     ]
    kErrorMsg_NoSurfaceShader      = maya.stringTable['y_maya_app_renderSetup_model_dragAndDropBehavior.kNoSurfaceShader'      ]
    kErrorMsg_NoShadingGroup       = maya.stringTable['y_maya_app_renderSetup_model_dragAndDropBehavior.kNoShadingEngine'      ]
    kErrorMsg_NoSurfaceShaderFound = maya.stringTable['y_maya_app_renderSetup_model_dragAndDropBehavior.kNoSurfaceShaderFound' ]
    kErrorMsg_NoShadingGroupFound  = maya.stringTable['y_maya_app_renderSetup_model_dragAndDropBehavior.kNoShadingGroupFound'  ]
    kErrorMsg_IncompatibleTypes    = maya.stringTable['y_maya_app_renderSetup_model_dragAndDropBehavior.kIncompatibleTypes'    ]
