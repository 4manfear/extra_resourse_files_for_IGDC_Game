...
kCmdPrivate = maya.stringTable['y_maya_app_renderSetup_model_childNode.kCmdPrivate' ]

kOrderingFailure = "Nodes '%s' and '%s' cannot be ordered."
kRename = maya.stringTable['y_maya_app_renderSetup_model_childNode.kRename' ]
...
class ChildNode(Observable, NodeNotes, SerializableNode, LabelColor, nodeList.ListItem):
    ...
    def _encodeProperties(self, dict):
        ...
        expandedState._encodeProperties(self, dict)
    ...
    def _decodeProperties(self, dict, mergeType, prependToName):
        ...
        expandedState._decodeProperties(self, dict, mergeType, prependToName)
