...
class Override(MayaQWidgetBaseMixin, QGroupBox):
    ...
    def _setupFinalizationWidget(self, layout):
        ...
        finalizeLayout.addWidget(utils.Separator(maya.stringTable['y_maya_app_renderSetup_views_propertyEditor_override.kSmallOr' ]))

        # setup type attribute label/text field/button
        self.typeAttr = utils.LabelFieldButtonGrp(
            label=maya.stringTable['y_maya_app_renderSetup_views_propertyEditor_override.kTypeAttribute' ],
            placeholder=maya.stringTable['y_maya_app_renderSetup_views_propertyEditor_override.kNodeDotAttribute' ],
            tooltip=maya.stringTable['y_maya_app_renderSetup_views_propertyEditor_override.kTypeAttributeTooltip' ],
            button=maya.stringTable['y_maya_app_renderSetup_views_propertyEditor_override.kCreate' ])
    ...
    def _setupOverridePathName(self, mainGroupBoxLayout):
        ...
        mainGroupBoxLayout.addRow(kPath, self.path)
