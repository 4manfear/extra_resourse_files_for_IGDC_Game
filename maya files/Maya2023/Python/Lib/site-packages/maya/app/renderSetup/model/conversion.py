...
kConvertTitle   = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConvertTitle' ]
kConvertMessage = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConvertMessage' ]
kConvertYes     = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConvertYes' ]
kConvertNo      = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConvertNo' ]
kConvertHelp    = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConvertHelp' ]
kIssueShortDescription = maya.stringTable['y_maya_app_renderSetup_model_conversion.kIssueShortDescription' ]

kConvertBatchError = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConvertBatchError' ]

kConversionCompletedTitle = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConversionCompletedTitle' ]
kConversionCompletedMessage = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConversionCompletedMessage' ]
kConversionCompletedForMessage = "Conversion successfully completed for collections: %s."

kConversionFailedTitle = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConversionFailedTitle' ]
kConversionCompletedWithErrorsMessage = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConversionCompletedWithErrorsMessage' ]
kConversionFailedForMessage = "Conversion failed for collections: %s."

kConversionCompletedOk = maya.stringTable['y_maya_app_renderSetup_model_conversion.kConversionCompletedOk' ]
...
def _findCollections(encodedData):
    ...
    for value in list(encodedData.values()):
...
def convertCollection(collection):
    ...
    selectorAttrs = [attr for attr in ('typeFilter', 'pattern', 'staticSelection', 'customFilterValue', 'includeHierarchy') if attr in collection]
...
class Observer2016R2(object):
        ...
        def convert():
            ...
            for selname in cmds.ls(type=BasicSelector.kTypeName):
                ...
                for colname in collections: # there should be only one
                    ...
                    # by children classes
                    collection.Collection.setSelectorType(col, list(list(dic.values())[0]['selector'])[0])
                    col._decodeProperties(list(dic.values())[0], DECODE_AND_MERGE, None)
                    yield colname
    ...
    def assistedResolve(self):
        ...
        try:
            ...
            convert, remember = (False, False) if os_getenv('MAYA_IGNORE_DIALOGS', "0") != "0" else ConvertDialog().prompt() 
            if remember: 
