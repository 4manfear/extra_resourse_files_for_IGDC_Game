...
# Errors
kRendererMismatch   = maya.stringTable['y_maya_app_renderSetup_model_renderSettings.kRendererMismatch' ]
kCreateDefaultNodesFailed = maya.stringTable['y_maya_app_renderSetup_model_renderSettings.kCreateDefaultNodesFailed' ]
...
def decode(dict):
    ...
    currentRenderer = list(dict.keys())[0]
    _registerSelectedRender(currentRenderer)
