...
# Text to localize
kNotes                  = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kNotes'   ]
kPreview                = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kPreview' ]
kOverwrite              = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kOverwrite' ]
kOverwriteExplanation   = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kOverriteExplanation' ]
kMerge                  = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kMerge' ]
kMergeExplanation       = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kMergeExplanation' ]
kMergeAOVExplanation    = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kMergeAOVExplanation' ]
kRename                 = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kRename' ]
kRenameExplanation      = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kRenameExplanation' ]
kTextToPrepend          = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kTextToPrepend' ]
kDefaultTextToPrepend   = 'Import_'
kGeneralOptions         = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kGeneralOptions' ]
kLabelColorOptions              = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kLabelColorOptions' ]
kLabelColorImport              = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kLabelColorImport' ]
kLabelColorImportExplanation   = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kLabelColorImportExplanation' ]
kLabelColorExport              = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kLabelColorExport' ]
kLabelColorExportExplanation   = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kLabelColorExportExplanation' ]
kRenderSettingsOptions         = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kRenderSettingsOptions' ]
kRenderSettingsExport          = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kRenderSettingsExport' ]
kRenderSettingsExportExplanation = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kRenderSettingExportExplanation' ]

# List of all error messages
kUnknownFile = maya.stringTable['y_maya_app_renderSetup_views_importExportUI.kUnknownFile' ]
...
def updateContent(parent, selectedFilename, isImport):
    """
    ...
    if os_path.isfile(selectedFilename):
        with open(selectedFilename, 'r') as file:
            try:
                ...
                if jsonTranslatorUtils.isRenderSetup(dict):
                    ...
                    if isImport:
                        previewText = json.dumps(dict, indent=2, sort_keys=True, separators=(',', ': '))
                else:
    ...
    if isImport:
        ...
        ExportUI.notesText = notesText
        cmds.scrollField(ExportUI.notesTextEditor, edit=True, text=notesText)
