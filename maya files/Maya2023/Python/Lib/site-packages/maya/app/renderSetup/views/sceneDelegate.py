...
class SceneDelegate(BaseDelegate):
    ...
    CURRENT_FRAME = maya.stringTable['y_maya_app_renderSetup_views_sceneDelegate.kCurrentFrame' ]
    FRAME_RANGE = maya.stringTable['y_maya_app_renderSetup_views_sceneDelegate.kFrameRange' ]
    
    QUICK_SETTINGS_IMAGE = createPixmap(":/RS_quick_settings_popup.png")

    kTooltips = {scene.SET_VISIBILITY_ACTION : maya.stringTable['y_maya_app_renderSetup_views_sceneDelegate.kVisibilityToolTip' ],
                 scene.SET_RENDERABLE_ACTION : maya.stringTable['y_maya_app_renderSetup_views_sceneDelegate.kRenderableToolTip' ],
                 scene.PRESET_MENU : maya.stringTable['y_maya_app_renderSetup_views_sceneDelegate.kPresetMenuToolTip' ],
                 scene.AOVS_MENU : maya.stringTable['y_maya_app_renderSetup_views_sceneDelegate.kAovsMenuToolTop' ],
                 scene.LIGHTS_MENU : maya.stringTable['y_maya_app_renderSetup_views_sceneDelegate.kLightsMenuToolTop' ]}
    ...
    def _addActionIcons(self, painter, rect, item, highlightedColor):
        ...
        if item.type() != scene.SCENE_CATEGORY_RENDER_SETTINGS_TYPE and item.type() != scene.SCENE_CATEGORY_AOVS_TYPE and item.type() != scene.SCENE_CATEGORY_LIGHTS_TYPE:
        ...
        for iconIndex in range(0, toolbarCount):
            ...
            elif (actionName == scene.PRESET_MENU or actionName == scene.AOVS_MENU or actionName == scene.LIGHTS_MENU):
