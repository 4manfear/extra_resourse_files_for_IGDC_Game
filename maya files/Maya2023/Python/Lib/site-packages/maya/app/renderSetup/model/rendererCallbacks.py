...
# Errors
kDefaultNodeMissing = maya.stringTable['y_maya_app_renderSetup_model_rendererCallbacks.kDefaultNodeMissing' ]
kDefaultNodeAttrMissing = maya.stringTable['y_maya_app_renderSetup_model_rendererCallbacks.kDefaultNodeAttrMissing' ]
kUnableToSet = maya.stringTable['y_maya_app_renderSetup_model_rendererCallbacks.kUnableToSet' ]
kAttributesNotExportable = maya.stringTable['y_maya_app_renderSetup_model_rendererCallbacks.kAttributesNotExportable' ]
...
class NodeExporter(object):
    ...
    def decode(self, encodedData):
        ...
        for (key, value) in list(encodedData.items()):
            ...
            if node is None:
                ...
                try:
                    ...
                    OpenMaya.MGlobal.displayWarning(kUnableToSet % (nodeName, attrName))
