...
kSymmetryOptions = [
    ( maya.stringTable['y_maya_app_quickRig_quickRigUI.kSymmetryBoundingBox' ] , True  , None   ) ,
    ( maya.stringTable['y_maya_app_quickRig_quickRigUI.kSymmetryHips' ]                , True  , 'Hips' ) ,
    ( maya.stringTable['y_maya_app_quickRig_quickRigUI.kSymmetryNoSymmetry' ]   , False , None   ) ,
    ]

# List of options for joint orientation.
kOrientJointsOptions = [
    # Left is towards child, right is not.
    ( maya.stringTable['y_maya_app_quickRig_quickRigUI.kMirroredBehavior' ]     , True  , ( True , False ) ) ,
    # Left is towards child, right is too.
    ( maya.stringTable['y_maya_app_quickRig_quickRigUI.kXTowardsNextJoint' ] , True  , ( True , True  ) ) ,
    # No alignment.
    ( maya.stringTable['y_maya_app_quickRig_quickRigUI.kWorldNoAlignment' ]  , False , None             ) ,
    ]

# List of options for skin binding.
kSkinBindingOptions = [
    maya.stringTable['y_maya_app_quickRig_quickRigUI.kGVBBindingMethod' ] ,
    maya.stringTable['y_maya_app_quickRig_quickRigUI.kCurrentSettingsBindingMethod' ] ,
    ]
...
class QuickRigTool(object):
    ...
    def __init__( self , windowName="quickRigWindowId" ):
        ...
        self.windowTitle = maya.stringTable['y_maya_app_quickRig_quickRigUI.kQuickRigWindowName' ]
            ...
            with LayoutManager( cmds.columnLayout( adjustableColumn=True ) ):
                ...
                with LayoutManager( cmds.rowLayout( numberOfColumns=5 , adjustableColumn=1 ) ):
                    self.characterMenu = cmds.optionMenuGrp(
                        label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kCharacter' ] ,
                        cw=( 1 , 60 ) ,
                    ...
                    cmds.iconTextButton(
                        ...
                        annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kRefreshCharacterList'  ]
                        )
                    cmds.iconTextButton(
                        image='QR_add.png' ,
                        command=self._callbackTool( callback_step0_CreateCharacter ) ,
                        annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kCreateCharacter'  ]
                        )
                    self.buttonRename = cmds.iconTextButton(
                        image='QR_rename.png' ,
                        command=self._callbackTool( callback_step0_RenameCharacter ) ,
                        annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kRenameCharacter'  ]
                        )
                    self.buttonDelete = cmds.iconTextButton(
                        image='QR_delete.png' ,
                        command=self._callbackTool( callback_step0_DeleteCharacter ) ,
                        annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kDeleteCharacter'  ]
                        )
                ...
                with LayoutManager( self.layoutModes ):
                    ...
                    self.radioButtonOneClick   = cmds.radioButton( onCommand=self._callbackTool( callback_step0_ChangeMode ) , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kOneClick' ] )
                    self.radioButtonStepByStep = cmds.radioButton( onCommand=self._callbackTool( callback_step0_ChangeMode ) , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kStepByStep' ] )
                ...
                with LayoutManager( self.layoutOneClick ):
                    with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kOneClickTitle' ] , **kFrameParam ) ):
                        cmds.separator( style='none', height=5 , width=kOptionsButtonWidth )
                        textOneClick = cmds.text( align='center' , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSelectedCharacterMeshes' ] )
                        cmds.separator( style='none', height=5 , width=kOptionsButtonWidth )
                        with LayoutManager( cmds.formLayout() ) as buttonLayout:
                            buttonOneClick = cmds.button( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kAutoRig' ] , command=self._callbackTool( callback_AutoRig ) )
                ...
                with LayoutManager( self.layoutStepByStep ):
                    # Geometry selection.
                    with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kGeometry' ] , **kFrameParam ) ):
                        with LayoutManager( cmds.rowLayout( numberOfColumns=3 ) ) as geometryLayout:
                            cmds.iconTextButton(
                                ...
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kAddSelectedMeshes'  ]
                                )
                            cmds.iconTextButton(
                                image='QR_selectAll.png' ,
                                command=self._callbackTool( callback_step1_SelectAllMeshes ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSelectAllMeshes'  ]
                                )
                            cmds.iconTextButton(
                                image='QR_delete.png' ,
                                command=self._callbackTool( callback_step1_ClearMeshes ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kCleanMeshes'  ]
                                )
                        self.meshesList = cmds.textScrollList( height=80 )
                    
                    # Guides.
                    with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kGuides' ] , **kFrameParam ) ):
                        with LayoutManager( cmds.rowLayout( numberOfColumns=3 , adjustableColumn=2 , columnAlign3=( 'left', 'left', 'right' ) , height=kRowLayoutHeight ) ):
                            ...
                            cmds.text( width=kOptionsTextWidth , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kEmbedMethod' ] )
                            self.segmentationMethodList = cmds.optionMenuGrp( w=1 , adjustableColumn=1 ) + '|OptionMenu'
                            cmds.menuItem( parent=self.segmentationMethodList , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kPerfectMeshNoVoxelization' ] )
                            cmds.menuItem( parent=self.segmentationMethodList , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kWatertightMeshFloodFill' ] )
                            cmds.menuItem( parent=self.segmentationMethodList , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kImperfectMeshFloodFillGrowing' ] )
                            cmds.menuItem( parent=self.segmentationMethodList , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kPolygonSoupRepair' ] )
                            cmds.menuItem( parent=self.segmentationMethodList , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kNoEmbedding' ] )
                        ...
                        with LayoutManager( cmds.rowLayout( numberOfColumns=3 , adjustableColumn=2 , columnAlign3=( 'left', 'left', 'right' ) , height=kRowLayoutHeight ) ):
                            # Second line, 
                            cmds.text( width=kOptionsTextWidth , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kResolution' ] )
                        ...
                        with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kGuideSettings' ] , marginWidth=kFrameMarginWidth , collapse=True , collapsable=True ) ):
                            cmds.text( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kCharacterOrientation' ] )
                            with LayoutManager( cmds.rowLayout( numberOfColumns=2 , adjustableColumn=2 , columnAlign2=( 'left', 'left' ) , height=kRowLayoutHeight ) ):
                                cmds.text( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSymmetry' ] )
                            ...
                            with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kCenter' ] , marginWidth=kFrameMarginWidth , collapse=False , collapsable=True ) ):
                                with LayoutManager( cmds.formLayout( ) ) as centerForm:
                                    # These values are copied from hikSkeletonUI.mel.
                                    textSpine = cmds.text( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSpineCount' ] )
                                    fieldSpine = cmds.intField( width=kSkeletonFieldWidth , minValue=1 , maxValue=10 , value=3 , step=1 )
                                    
                                    textNeck = cmds.text( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kNeckCount' ] )
                                    fieldNeck = cmds.intField( width=kSkeletonFieldWidth , minValue=0 , maxValue=10 , value=1 , step=1 )
                                    
                                    textShoulder = cmds.text( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kShoulderCount' ] )
                            ...
                            with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kExtra' ] , marginWidth=kFrameMarginWidth , collapse=False , collapsable=True ) ):
                                self.checkboxHipsTranslation = cmds.checkBox( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kHipsTranslation' ] , value=False )
                        
                        with LayoutManager( cmds.rowLayout( numberOfColumns=2 , adjustableColumn=1 ) ):
                            cmds.button( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kGuidesCreateUpdate' ] , command=self._callbackTool( callback_step2_CreateGuides ) )
                            cmds.iconTextButton(
                                image='QR_delete.png' ,
                                command=self._callbackTool( callback_step2_DeleteGuides ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kGuidesDelete'  ]
                                )
                    
                    # User adjustments.
                    with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kUserAdjustmentOfGuides' ] , **kFrameParam ) ):
                        with LayoutManager( cmds.rowLayout( numberOfColumns=7 ) ):
                            cmds.iconTextButton(
                                ...
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kMirrorSelectedGuidesLeftToRight'  ]
                                )
                            cmds.iconTextButton(
                                image='QR_mirrorGuidesRightToLeft_150.png' ,
                                command=self._callbackTool( callback_step3_MirrorGuidesRightToLeft ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kMirrorSelectedGuidesRightToLeft'  ]
                                )
                            cmds.iconTextButton(
                                image='QR_selectAll_150.png' ,
                                command=self._callbackTool( callback_step3_SelectAllGuides ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSelectAllGuides'  ]
                                )
                            cmds.iconTextButton(
                                image='QR_show_150.png' ,
                                command=self._callbackTool( callback_step3_ShowAllGuides ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kShowAllGuides'  ]
                                )
                            cmds.iconTextButton(
                                image='QR_hide_150.png' ,
                                command=self._callbackTool( callback_step3_HideAllGuides ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kHideAllGuides'  ]
                                )
                            cmds.iconTextButton(
                                image='QR_xRay_150.png' ,
                                command=self._callbackTool( callback_step3_EnableXRayJoints ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kEnableXRayJoints'  ]
                                )
                            with LayoutManager( cmds.formLayout( width=kColorSwatchWidth , height=kColorSwatchHeight ) ) as colorLayout:
                                self.guidesColorButton = cmds.button(
                                    ...
                                    annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kChooseGuidesColor'  ]
                                    )
                        ...
                        with LayoutManager( cmds.formLayout( ) ) as adjustmentLayout:
                            textAdjustment = cmds.text( align='center' , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kManuallyMoveGuides' ] )
                    ...
                    with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSkeletonGeneration' ] , **kFrameParam ) ):
                        with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSkeletonSettings' ] , marginWidth=kFrameMarginWidth , collapse=True , collapsable=True ) ):
                            self.checkboxTStanceCorrection = cmds.checkBox( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kTStanceCorrection' ] , value=True )
                            with LayoutManager( cmds.rowLayout( numberOfColumns=2 , adjustableColumn=2 , columnAlign2=( 'left', 'left' ) , height=kRowLayoutHeight ) ):
                                cmds.text( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kJointXAxisAlignment' ] )
                        ...
                        cmds.menuItem( parent=self.skeletonControlRigList , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kGenerationSkeletonOnly' ] )
                        cmds.menuItem( parent=self.skeletonControlRigList , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kGenerationSkeletonAndControlRig' ] )
                        cmds.optionMenu( self.skeletonControlRigList , edit=True , select=2 )
                        with LayoutManager( cmds.rowLayout( numberOfColumns=2 , adjustableColumn=1 ) ):
                            cmds.button( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSkeletonCreateUpdate' ] , command=self._callbackTool( callback_step4_CreateSkeleton ) )
                            cmds.iconTextButton(
                                image='QR_delete.png' ,
                                command=self._callbackTool( callback_step4_DeleteSkeleton ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSkeletonDelete'  ]
                                )
                    
                    # Skinning.
                    with LayoutManager( cmds.frameLayout( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.Skinning' ] , **kFrameParam ) ):
                        with LayoutManager( cmds.rowLayout( numberOfColumns=3 , adjustableColumn=2 , columnAlign3=( 'left', 'left', 'right' ) , height=kRowLayoutHeight ) ):
                            cmds.text( width=kOptionsTextWidth , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kBindingMethod' ] )
                        ...
                        with LayoutManager( cmds.rowLayout( numberOfColumns=2 , adjustableColumn=1 ) ):
                            cmds.button( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSkinCreateUpdate' ] , command=self._callbackTool( callback_step5_BindSkin ) )
                            cmds.iconTextButton(
                                image='QR_delete.png' ,
                                command=self._callbackTool( callback_step5_DeleteSkin ) ,
                                annotation=maya.stringTable['y_maya_app_quickRig_quickRigUI.kSkinDelete'  ]
                                )
    ...
    def __handleError( message ):
        ...
        showMessageBox(
            title=maya.stringTable['y_maya_app_quickRig_quickRigUI.kErrorTitle' ] ,
            message=message ,
            icon='critical'
            )
...
def getInput_step0( input ):
    ...
    if not input.character:
        message = maya.stringTable['y_maya_app_quickRig_quickRigUI.kNoCharacterErrorMessage' ]
...
def getOutput_step0( input ):
    ...
    if input.character:
        objects.append( maya.stringTable['y_maya_app_quickRig_quickRigUI.kStepOutputCharacter' ] )
...
def getInput_step2( input ):
    ...
    if not input.meshes:
        message = maya.stringTable['y_maya_app_quickRig_quickRigUI.kNoMeshErrorMessage' ]
        raise UserException( message )
...
def getOutput_step2( input ):
    ...
    if guidesNode:
        objects.append( maya.stringTable['y_maya_app_quickRig_quickRigUI.kStepOutputGuides' ] )
...
def getInput_step3( input ):
    ...
    if not input.guidesNode:
        message = maya.stringTable['y_maya_app_quickRig_quickRigUI.kNoEmbeddingErrorMessage' ]
        raise UserException( message )
...
def getInput_step4( input ):
    ...
    guides = list(qrGetGuidesNodesFromGuidesNode( input.guidesNode ).keys( ))
    guides.sort( )
    requiredGuides = qrGetRequiredGuides( input.skeletonParameters )
    requiredGuides.sort( )
    if guides != requiredGuides:
        message = maya.stringTable['y_maya_app_quickRig_quickRigUI.kWrongParametersErrorMessage' ]
        raise UserException( message )
...
def getOutput_step4( input ):
    ...
    if hikGetControlRig( input.character ):
        objects.append( maya.stringTable['y_maya_app_quickRig_quickRigUI.kStepOutputControlRig' ] )
    
    if hikGetSkeletonGeneratorNode( input.character ):
        objects.append( maya.stringTable['y_maya_app_quickRig_quickRigUI.kStepOutputSkeletonGeneratorNode' ] )
    
    if qrGetSkeletonRootNode( input.character ):
        objects.append( maya.stringTable['y_maya_app_quickRig_quickRigUI.kStepOutputSkeleton' ] )
...
def getInput_step5( input ):
    ...
    input.skeletonNodes    = list(hikGetSkeletonNodesMap( input.character ).values( ))
    
    if not input.skeletonRootNode or not input.skeletonNodes:
        message = maya.stringTable['y_maya_app_quickRig_quickRigUI.kNoSkeletonErrorMessage' ]
        raise UserException( message )
...
def getOutput_step5( input ):
    ...
    if meshes:
        if checkIfSkinExists( meshes ):
            objects.append( maya.stringTable['y_maya_app_quickRig_quickRigUI.kStepOutputSkin' ] )
...
def getInputs( tool , level , deleteOutput ):
    ...
    if deleteOutput:
        ...
        if outputs:
            ...
            title = maya.stringTable['y_maya_app_quickRig_quickRigUI.kStepConfirmDeletion' ]
            message = ( maya.stringTable['y_maya_app_quickRig_quickRigUI.kStepConfirmDeletionList' ] % ( 's' if len( outputs ) > 1 else '' ) )
            for item in outputs:
                message += '\n- ' + item
...
def callback_step0_RenameCharacter( tool ):
    character = qruiGetCharacter( tool )
    if not character:
        tool.handleError( maya.stringTable['y_maya_app_quickRig_quickRigUI.kRenameCharacterError' ] )
        return
...
def callback_step1_AddSelectedMeshes( input ):
    ...
    if warningShapes:
        ...
        if len( warningShapes ) == 1:
            message = maya.stringTable['y_maya_app_quickRig_quickRigUI.kWarningNonMeshShapeSingular' ]
        else:
            message = maya.stringTable['y_maya_app_quickRig_quickRigUI.kWarningNonMeshShapePlural' ]
...
def callback_step2_ShowSegmentationHelp( tool ):
    ...
    helpStrings = {
        1 : {
            'title' : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kPerfectMeshTitleString'   ] ,
            'help'  : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kPerfectMeshHelpString'    ]
        } ,
        2 : {
            'title' : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kWatertightMeshTitleString'   ] ,
            'help'  : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kWatertightMeshHelpString'    ]
        } ,
        3 : {
            'title' : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kImperfectMeshTitleString'   ] ,
            'help'  : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kImperfectMeshHelpString'    ]
        } ,
        4 : {
            'title' : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kPolygonSoupTitleString'   ] ,
            'help'  : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kPolygonSoupHelpString'    ]
        } ,
        5 : {
            'title' : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kNoEmbeddingTitleString'   ] ,
            'help'  : maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kNoEmbeddingHelpString'    ]
        }
    }
    windowTitleString = maya.stringTable['y_maya_app_quickRig_quickRigUI.kSegmentationDescription' ]
...
def callback_step2_CreateGuides( input ):
    ...
    try:
        ...
        message  = maya.stringTable['y_maya_app_quickRig_quickRigUI.kEmbeddingErrorMessage1' ]
        message += '\n\n---\n%s---\n\n' % str( e )
        message += maya.stringTable['y_maya_app_quickRig_quickRigUI.kEmbeddingErrorMessage2' ]
        raise UserException( message )
    ...
    try:
        ...
        message  = maya.stringTable['y_maya_app_quickRig_quickRigUI.kJSONErrorMessage' ]
        message += '\n\n---\n%s\n---\n\n' % str( result )
        message += '\n\n---\n%s\n---\n\n' % str( e )
        raise UserException( message )
...
def callbackUtil_step3_MirrorGuides( input , leftToRight ):
    ...
    if not joint in positions:
        message = maya.stringTable['y_maya_app_quickRig_quickRigUI.kMirroringErrorMessage' ]
...
def callback_step4_CreateSkeleton( input ):
    ...
    if input.skeletonControlRig >= 1:
        ...
        if not skeletonRoot:
            message = maya.stringTable['y_maya_app_quickRig_quickRigUI.kSkeletonCreationErrorMessage' ]
            raise UserException( message )
    ...
    if input.skeletonControlRig < 2 and useTStanceCorrection:
        ...
        rotations = [ ( node, cmds.getAttr( '%s.rotate' % node )[ 0 ] ) for node in list(skeletonNodes.values( )) ]
...
def callback_AutoRig( tool ):
    ...
    window = cmds.window( title=maya.stringTable['y_maya_app_quickRig_quickRigUI.kAutoRigProgress' ] )
    ...
    try:
        ...
        progressText    = cmds.text( label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kProgressAutoRig' ] , width=300 )
        cmds.showWindow( window )
        
        # 1) Geometry
        cmds.text( progressText , edit=True , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kProgressGeometry' ] )
        ...
        # 2) Guides
        cmds.text( progressText , edit=True , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kProgressGuides' ] )
        cmds.progressBar( progressControl , edit=True , step=1 )
        if not callback_step2_CreateGuides( tool=tool ):
            return
        
        # 3) User Adjustment of Guides
        cmds.text( progressText , edit=True , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kProgressUserAdjustmentOfGuides' ] )
        cmds.progressBar( progressControl , edit=True , step=1 )
        ...
        cmds.text( progressText , edit=True , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kProgressSkeletonAndRigGeneration' ] )
        cmds.progressBar( progressControl , edit=True , step=1 )
        if not callback_step4_CreateSkeleton( tool=tool ):
            return
        
        # 5) Skinning
        cmds.text( progressText , edit=True , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kProgressSkinning' ] )
        cmds.progressBar( progressControl , edit=True , step=1 )
        ...
        # All done!
        cmds.progressBar( progressControl , edit=True , step=1 )
        cmds.text( progressText , edit=True , label=maya.stringTable['y_maya_app_quickRig_quickRigUI.kProgressDone' ] )
    finally:
...
def qrGetGuidesFromEmbedding( skeletonParameters , tweakParameters , embedding ):
    ...
    for side in [ 'left' , 'right' ]:
        ...
        skeletonJoints.update( { targetSide + name : position for name, position in list(footJoints.items( )) } )
    ...
    for side in [ 'left' , 'right' ]:
        ...
        targetSide = side.capitalize( )
        skeletonJoints.update( { targetSide + name : position for name, position in list(handJoints.items( )) } )
    
   # Copy everything and add the guides.
    guides = { name : [ position.x, position.y, position.z ] for name, position in list(skeletonJoints.items( )) }
...
def qrSetGuidesColor( guidesNode , color ):
    ...
    allGuides = [ guidesNode ] + list(mapGuideToScene.values( ))
...
def qrGetGuidesPositions( character ):
    ...
    positions = { guide : cmds.xform( node, worldSpace=True, translation=True, query=True ) for guide, node in list(guides.items()) }
...
class HIKContext(object):
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        if exc_type:
            ...
            print(u'%s : %s'%(exc_type, exc_value))
        if self.objs:
            cmds.select(self.objs)
        return True


class HIKManipulationScope(object):
    """
...
class Vector3(object):
    ...
    def __init__( self , *args ):
        if len( args ) == 1:
            ...
            raise RuntimeError( maya.stringTable['y_maya_app_quickRig_quickRigUI.kInvalidParameterToConstructor' ] )
    ...
    def __getitem__( self , key ):
        if key == 0:
            ...
            raise RuntimeError( maya.stringTable['y_maya_app_quickRig_quickRigUI.kInvalidParameterToGetItem' ] )
    ...
    def __setitem__( self , key , value ):
        if key == 0:
            ...
            raise RuntimeError( maya.stringTable['y_maya_app_quickRig_quickRigUI.kInvalidParameterToSetItem' ] )
    ...
    def project( self , target ):
        return self - target * safeDivide( self.dot( target ) , float( target.dot( target ) ) )
...
def convertNeck( tweakParameters , neckCount , shouldersPosition , headPosition , boundingBox ):
    ...
    if tweakParameters.tweak:
        ...
        if factor <= 0:
            cmds.warning( maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kWarningReverseHead'   ] )
...
def listMirroredJoints( mapGuideToScene , guidesNode , items , leftToRight ):
    ...
    mapSceneToGuide = {}
    mapSceneToGuide.update( reversed( i ) for i in list(mapGuideToScene.items( )) )
    nodesToProcess = []
    for item in items:
        if item == guidesNode:
            # Add all the guides.
...
def createReferential( xVector , zTargetVector , zBackupTargetVector ):
    ...
    if u1.length( ) == 0:
        raise RuntimeError( maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kNullXVector'   ] )
    ...
    if u3.length( ) == 0:
        raise RuntimeError( maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kNullZVector'   ] )
    
    # Y axis is orthogonal to both axis.
    u2 = u3.cross( u1 )
    if u2.length( ) == 0:
        raise RuntimeError( maya.stringTable[ 'y_maya_app_quickRig_quickRigUI.kNullYVector'   ] )
...
def createHikSkeleton( character , skeletonParameters ):
    ...
    for parameter, value in list(skeletonParameters.items( )):
...
def getCharacterDefiniton( character ):
    ...
    for hikInfo in list(hikInfos.values( )):
    ...
    for joint in definition.orderedJoints:
        ...
        if not hikInfo.effector:
            ...
            if joint in [ 'LeftToeBase' , 'RightToeBase' ]:
                ...
                Ny = Ty * sqrt( safeDivide( Ol*Ol - Oy*Oy , Tl*Tl - Ty*Ty ) )
                
                directionVector[ kCharacterUpAxis ] = Ny
                directionLength = directionVector.length( )
            
            newPos = computedParentWorldPos + directionVector * safeDivide( targetBoneLength , directionLength )
