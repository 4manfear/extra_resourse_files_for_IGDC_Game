...
def _createMrLightShaderMenuItems(node):
    ...
    if lightArray:
        selectObjString = maya.stringTable[ 'y_maya_app_general_nodeEditorRendererMenus.kSelectObjectsIlluminated'  ]
        frameObjString = maya.stringTable[ 'y_maya_app_general_nodeEditorRendererMenus.kFrameObjectsIlluminated'  ]
...
def _createMrTextureShaderMenuItems(node):
    ...
    if len(existingAttr) > 0:
        ...
        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorRendererMenus.kMentalRayTextureShadersAssign' ],
        radialPosition = 'N',
        c = assignCB)
