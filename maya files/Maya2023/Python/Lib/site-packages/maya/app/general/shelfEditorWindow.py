...
class shelfEditorWindow(object):
  # ---------------------------------------------------------------------------
  def __init__(self, windowName="shelfEditor"):
    ...
    self.moveUpStr   = maya.stringTable[ 'y_maya_app_general_shelfEditorWindow.kMoveUp'  ]
    self.moveDownStr = maya.stringTable[ 'y_maya_app_general_shelfEditorWindow.kMoveDown'  ]
  ...
  def itemIcon(self, internalIcon, data):
    ...
    if internalIcon:
      ...
      openStr = maya.stringTable['y_maya_app_general_shelfEditorWindow.kPickIconCaption' ]
  ...
  def createMenus(self):
    ...
    cmds.menu(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kOptions' ], tearOff=True)

    # Item style
    shelfItemLayout = cmds.optionVar(query='shelfItemStyle')

    cmds.radioMenuItemCollection()
    cmds.menuItem(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kIconOnly' ],
                  radioButton=(shelfItemLayout=='iconOnly'),
                  command=partial(self.setStyle, 'iconOnly'))
    cmds.menuItem(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kTextOnly' ],
                  radioButton=(shelfItemLayout=='textOnly'),
                  command=partial(self.setStyle, 'textOnly'))
    cmds.menuItem(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kTextBelow' ],
                  radioButton=(shelfItemLayout=='iconAndTextVertical'),
                  command=partial(self.setStyle, 'iconAndTextVertical'))
    cmds.menuItem(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kTextBeside' ],
    ...
    cmds.radioMenuItemCollection()
    cmds.menuItem(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kSaveAutomatically' ],
                  radioButton=saveMode,
                  command=partial(self.setSaveMode, 1))
    cmds.menuItem(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kSaveonRequest' ],
                  radioButton=not saveMode,
                  command=partial(self.setSaveMode, 0))

    cmds.setParent('..', menu=True)

    cmds.menu(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kHelp' ], helpMenu=True)
    cmds.menuItem(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kHelponShelves' ],
  ...
  def createShelfLists(self):
    ...
    # Shelf list
    child1 = cmds.frameLayout(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfList' ])
    ...
    cmds.symbolButton(image="newLayerEmpty.png",
                      annotation=maya.stringTable['y_maya_app_general_shelfEditorWindow.kNewShelf' ],
                      command=self.newShelf)
    cmds.symbolButton(image="smallTrash.png",
                      annotation=maya.stringTable['y_maya_app_general_shelfEditorWindow.kDeleteShelf' ],
    ...
    # Shelf name
    self.wShelfName = cmds.textFieldGrp(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfName' ],
                                        adjustableColumn=2,
    ...
    # Shelf alignment
    self.wShelfAlign = cmds.optionMenuGrp(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfAlignment' ],
                      adjustableColumn=2,
                      columnAttach=[(1, "right", 5), (2, "both", 0)],
                      columnWidth=[(1, 75), (2, 75)],
                      changeCommand=self.shelfAlignment)
    cmds.menuItem( label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfLeft' ] )
    cmds.menuItem( label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfRight' ] )
    ...
    # Shelf Contents
    child2 = cmds.frameLayout(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfContent' ])
    form = cmds.formLayout()
    ...
    cmds.symbolButton(image="moveLayerDown.png", annotation=self.moveDownStr,
                      command=partial(self.moveItem, 1))
    cmds.symbolButton(image="newLayerEmpty.png",
                      annotation=maya.stringTable['y_maya_app_general_shelfEditorWindow.kNewItem' ],
                      command=self.newItem)
    cmds.symbolButton(image="smallTrash.png",
                      annotation=maya.stringTable['y_maya_app_general_shelfEditorWindow.kDeleteItem' ],
    ...
    # Item name
    self.wItemName = cmds.textFieldGrp(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kItemName' ],
                                       adjustableColumn=2,
                                       columnAttach=[(1, "right", 5), (2, "both", 0)],
                                       columnWidth=[(1, 75), (2, 75)],
  ...
  def createShelfPreview(self):
    ...
    self.wItemPreviewLabel = cmds.text(align="right",
                                       label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kIcon' ])
  ...
  def createIconNameControls(self):
    ...
    self.wIconNameLabel = cmds.text(align="right",
                                    label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kIconName' ])
    self.wIconName = cmds.textField(changeCommand=self.itemData)

    self.wItemButton = cmds.symbolButton(image='fileOpen.png',
                                         annotation=maya.stringTable['y_maya_app_general_shelfEditorWindow.kBrowseImage' ],
                                         command=partial(self.itemIcon, False))
    self.wItemResButton = cmds.symbolButton(image='factoryIcon.png',
                                            annotation=maya.stringTable['y_maya_app_general_shelfEditorWindow.kMayaIcons' ],
  ...
  def createShelfData(self):
    ...
    self.wIconWidthOptionMenu = cmds.optionMenuGrp(
        label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfIconWidth' ],
        adjustableColumn=2,
        columnAttach=[(1, "right", 0), (2, "left", 0)],
        columnWidth=[(1, self.col1width), (2, 75)],
        changeCommand=self.flexibleWidthChange)

    cmds.menuItem( label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kIconWidthStandard'  ] )
    cmds.menuItem( label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kIconWidthCustom'    ] )
    cmds.menuItem( label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kIconWidthAutomatic' ] )
    ...
    self.wItemTip = cmds.textFieldGrp(
      label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kItemTooltip' ],
      adjustableColumn=2,
      columnWidth=(1, self.col1width),
    ...
    self.wItemLabel = cmds.textFieldGrp(
      label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kItemLabel' ],
      adjustableColumn=2,
      columnWidth=(1, self.col1width),
      columnAttach=(2, "both", 0),
      changeCommand=self.itemData)
    ...
    self.wItemLabelColor = cmds.colorSliderGrp(
      label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kTextColor' ],
      columnWidth=(1, self.col1width),
      changeCommand=self.itemData)

    self.wItemLabelBckColor = cmds.colorSliderGrp(
      label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kBackgroundColor' ],
      columnWidth=(1, self.col1width),
      changeCommand=self.itemData)

    self.wItemLabelBckTransp = cmds.floatSliderGrp(
      label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kBackgroundTransparency' ],
      columnWidth=(1, self.col1width),
      field=True, minValue=0, maxValue=1.,
      changeCommand=self.itemData)

    self.wItemUserColor = cmds.checkBoxGrp(
      label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kItemUserColor' ],
      columnWidth=(1, self.col1width),
      changeCommand=self.itemData)
    self.wItemBckColor = cmds.colorSliderGrp(
      label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kButtonBackgroundColor' ],
      columnWidth=(1, self.col1width),
      changeCommand=self.itemData)

    self.wItemRepeatable = cmds.checkBoxGrp(
      label="", label1=maya.stringTable['y_maya_app_general_shelfEditorWindow.kRepeatable' ],
      columnWidth=(1, self.col1width),
      changeCommand=self.itemData)
  ...
  def createCommandTabs(self):
    ...
    langStr = maya.stringTable['y_maya_app_general_shelfEditorWindow.kLanguage' ]
  ...
  def createButtons(self):
    ...
    b1 = cmds.button(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kSaveAllShelves' ],
                command=self.saveAllShelves)
    b2 = cmds.button(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kClose' ],
                command=self.close)
  ...
  def currentMenuItemList(self, at=1):
    ...
    for item in itemList:
      if cmds.menuItem( item, query=True, divider=True ):
        continue
      if cmds.menuItem( item, query=True, optionBox=True ):
        continue      
      ...
      if itemName is not None:
        ...
        if isinstance(itemCommand, string_type) and itemCommand.startswith( '/*dSBRMBMI*/' ):
          continue
  ...
  def createMenuItemsTab(self):
    ...
    # Menu item list
    child1 = cmds.frameLayout(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kMenuItems' ])
    form = cmds.formLayout()
    ...
    cmds.symbolButton(image="moveLayerDown.png", annotation=self.moveDownStr,
                      command=partial(self.moveMenuItem, 1))
    cmds.symbolButton(image="newLayerEmpty.png",
                      annotation=maya.stringTable['y_maya_app_general_shelfEditorWindow.kNewMenuItem' ],
                      command=self.newMenuItem)
    cmds.symbolButton(image="smallTrash.png",
                      annotation=maya.stringTable['y_maya_app_general_shelfEditorWindow.kDeleteMenuItem' ],
    ...
    # Menu item name
    self.wMenuItemName = cmds.textFieldGrp(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kMenuItemName' ],
                                       adjustableColumn=2,
                                       columnAttach=[(1, "right", 5), (2, "both", 0)],
                                       columnWidth=[(1, 75), (2, 75)],
    ...
    child2 = cmds.frameLayout(label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kMenuItemCommand' ])
    child2Form = cmds.formLayout()
    self.wMenuItemLanguage = cmds.radioButtonGrp(
      label=maya.stringTable['y_maya_app_general_shelfEditorWindow.kLanguage2' ],
      numberOfRadioButtons=2,
      labelArray2=("MEL", "Python"),
      columnWidth=(1, 100),
  ...
  def create(self, selectedShelfButton=None, selectedTabIndex=2):
    ...
    shelves = maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelves' ]
    cmds.window(self.winName,
                title=maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfEditor' ],
    ...
    cmds.tabLayout(tabs, edit=True,
                   tabLabel=[(form,           shelves)
                           , (commandTabs[0], maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfCommand' ])
                           , (commandTabs[1], maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfDblCommand' ])
                           , (menuItemsTab, maya.stringTable['y_maya_app_general_shelfEditorWindow.kShelfMenuItems' ])
                             ])
