...
def _loadUIString(strId):
    try:
        return {
            'kEditTexture': maya.stringTable['y_maya_app_general_nodeEditorMenus.kEditTexture' ],
            'kSelectStream': maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectStream' ],
            'kSelectUpDownstream': maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectUpDownstream' ],
            'kSelectUpDownstreamAnnot': maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectUpDownstreamAnnot' ],
            'kSelectUpstream': maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectUpstream' ],
            'kSelectUpstreamAnnot': maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectUpstreamAnnot' ],
            'kSelectDownstream': maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectDownstream' ],
            'kSelectDownstreamAnnot': maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectDownstreamAnnot' ],
            'kToggleSelectedSwatch': maya.stringTable['y_maya_app_general_nodeEditorMenus.kToggleSelectedSwatch' ],
            'kToggleSelectedSwatchAnnot': maya.stringTable['y_maya_app_general_nodeEditorMenus.kToggleSelectedSwatchAnnot' ],
            'kEditCustomAttrList': maya.stringTable['y_maya_app_general_nodeEditorMenus.kEditCustomAttrList' ],
            'kEditCustomAttrListAnnot': maya.stringTable['y_maya_app_general_nodeEditorMenus.kEditCustomAttrListAnnot' ],
            'kSoloMaterial' : maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kSoloMaterial'  ],
            'kRemoveMaterialSoloing' : maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kRemoveMaterialSoloing'  ],
        }[strId]
    except KeyError:
        return " "
...
def createNodeEditorMarkingMenu(ned):
    ...
    def connectedGraphingModeCB(*args):
        connectedMode = cmds.menuItem(connectedMenuItem, q=True, checkBox=True)
        nEd(ned, e=True, connectedGraphingMode=connectedMode)
    ...
    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kCreateNode' ], radialPosition = 'N',
    ann= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kCreateNodeAnnot' ],
    c = createNodeCB)

    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectAll' ], radialPosition = 'E',
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectAllAnnot' ],
    c = selectAllCB)
    ...
    if inLookDev:
        ...
        cmds.menuItem(label=maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kSoloLastConnection'  ], radialPosition = 'SW', c = soloLastCB, version = '2016', enable = (not inContainer))

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kGraphMaterialsOnViewportSelection'  ], radialPosition = 'S',
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kGraphMaterialsOnViewportSelectionAnnot' ],
    c = graphCB, enable = (not inContainer))

    selection = nEd(ned, q=True, syncedSelection=True)
    cmds.menuItem(selectionMenuItem, label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kSyncOnSelection' ], checkBox = selection,
    ann= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kSyncOnSelectionAnnot'  ],
    c = syncOnSelectionCB, enable = (not inContainer))

    creation = nEd(ned, q=True, addNewNodes=True)
    cmds.menuItem(creationMenuItem, label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kAddOnCreate' ], checkBox = creation,
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kAddOnCreateAnnot' ],
    c = addOnCreateCB, enable = (not inContainer))

    connected = nEd(ned, q=True, connectedGraphingMode=True)
    cmds.menuItem(connectedMenuItem, label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kConnectedGraphingMode' ], checkBox = connected,
    ann = maya.stringTable['y_maya_app_general_nodeEditorMenus.kConnectedGraphingModeAnn' ],
    c = connectedGraphingModeCB, enable = (not inContainer))

    additive = nEd(ned, q=True, additiveGraphingMode=True)
    cmds.menuItem(additiveMenuItem, label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kAdditiveGraphingMode' ], checkBox = additive,
    ann = maya.stringTable['y_maya_app_general_nodeEditorMenus.kAdditiveGraphingModeannot' ],
    c = additiveGraphingModeCB, enable = (not inContainer))

    pinned = nEd(ned, q=True, defaultPinnedState=True)
    cmds.menuItem(pinnedMenuItem, label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPinByDefault' ], checkBox = pinned,
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPinByDefaultAnn' ],
    c = pinByDefaultCB, enable = (not inContainer))

    parent = cmds.setParent(q=True, menu=True)
    displayMenuItem = mel.eval('nodeEdCreateDisplayMarkingMenu("%s", "%s")' % (ned, parent))
    cmds.menuItem(displayMenuItem, e=True, enable = (not inContainer))
    ...
    if ned != maya.mel.eval('$temp = $gHypershadeNodeEditor'):
        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kHypershade' ],
        ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kHypershadeAnnot' ],
        c = hyperShadeCB, enable = (not inContainer))

    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kHypergraph' ],
    ann= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kHypergraphAnnot' ],
...
def _createPlace3dTextureMenuItems(node):
    ...
    cmds.menuItem(label=maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kFitToGroupBoundingBox'  ], c = fitCB)
    ...
    if len(selectionList) > 0:
        ...
        parentPlacementString = cmds.format(maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kParentPlacement'  ], stringArg=selectionList[0])
        cmds.menuItem(label=parentPlacementString, c = parentCB)
    else:
        cmds.menuItem(label=maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kParentPlacementToSelection'  ], enable=False)
...
def _createShaderMenuItems(ned, node):
    ...
    if(not cmds.mayaHasRenderSetup()):
        ...
        if len(layer) > 0 and layer != 'masterLayer':
            ...
            assignMaterialOverString = cmds.format(maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kAssignMaterialOverride'  ], stringArg=layer)
            cmds.menuItem(label=assignMaterialOverString, radialPosition = 'W', c = assignCB)

    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kShaderGenSwatch' ], radialPosition = 'SW',
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kShaderGenSwatchAnnot' ],
    c = refreshCB)
    ...
    if groupSize <= 1:
        ...
        assignMaterialSelString = maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kAssignMaterialToViewportSelection'  ]
        type = cmds.nodeType(node)
        if type == 'oceanShader':
            ...
            cmds.menuItem(label=maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kPaintAssignShader'  ], radialPosition = 'NE',
            c = paintCB)

        cmds.menuItem(label=maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kSelectObjectsWithMaterial'  ], radialPosition = 'E',
        c = selectCB)
        ...
        cmds.menuItem(label=maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kFrameObjectsWithMaterial'  ], c = frameCB)
        ...
        if (not cmds.mayaHasRenderSetup()):
            ...
            cmds.menuItem(removeMenuItem, label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRemoveMaterialOverride' ],
        ...
        assignToSelectionString = maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kAssignToViewportSelection'  ]
        selectObjString = maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kSelectObjects'  ]
        frameObjString = maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kFrameObjects'  ]
...
def _createPsdFileTexMenuItems(ned, node):
    ...
    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kConvertToLayeredTexture' ], radialPosition = 'SW',
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kConvertToLayeredTextureAnnot' ],
    c = convertLayerCB)

    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kConvertToFileTexture' ], radialPosition = 'NW',
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kConvertToFileTextureAnnot' ],
    c = convertFileCB)
...
def _createFileMenuItems(ned, node):
    ...
    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kReloadImageFile'  ],
    c = reloadCB)
...
def _createTextureUtilityMenuItems(ned, node):
    ...
    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kAssignTextureMaterialToSelection' ],
    radialPosition = 'N',
    c = assignCB)
    ...
    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kTestTexture' ], radialPosition = 'W',
    ...
    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRenderTextureRange' ], radialPosition = 'E',
...
def _createTextureMenuItems(ned, node):
    ...
    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kTextureGenSwatch' ], radialPosition = 'SW',
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kTextureGenSwatchAnnot' ],
    c = refreshCB)
...
def _createLightMenuItems(node):
    ...
    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kMakeLinksWithSelectedViewportObjects'  ],
    c = makeCB)

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kBreakLinksWithSelectedViewportObjects'  ],
    c = breakCB)

    cmds.menuItem( divider=True )

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kSelectObjectsIlluminatedByLight'  ],
    radialPosition = 'E',
    c = selectCB)

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kFrameObjectsIlluminatedByLight'  ],
    c = frameCB)
...
def _createBakeSetMenuItems(node):
    ...
    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kAssignViewportSelectionToBakeSet'  ],
    radialPosition = 'N',
    c = assignCB)

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kSelectObjectsInBakeSet'  ],
    radialPosition = 'E',
    c = selectCB)

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kFrameObjectsInBakeSet'  ],
    c = frameCB)
...
def _createAnimClipMenuItems(node):
    ...
    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kCopy'  ],
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kCopyAnnot' ],
    c = copyCB)

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kInstance'  ],
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kInstanceAnnot' ],
    c = instanceCB)

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kDuplicate'  ],
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kDuplicateClip' ],
    c = duplicateCB)

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kExport'  ],
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kExportClip' ],
    c = exportCB)

    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kApplyPose'  ],
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kApplyPoseAnnot' ],
    c = applyCB)
...
def _createColorProfileMenuItems(node):
    ...
    cmds.menuItem(label= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kApplyColorProfileToSelected'  ],
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kApplyColorProfileToViewportSelectedAnnotaton' ],
    c = applyCB)
...
def createNodeItemMarkingMenu(ned, node):
    ...
    if not editMode:
        if inContainer:
            if isContainerNode:
                cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kOpenContents' ], radialPosition = 'N',
                ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kOpenContentsAnnot' ],
                c = openContainerViewCB)

                cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kOpenContentsInNewTab' ], radialPosition = 'E',
                ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kOpenContentsInNewTabAnnot' ],
                c = openContainerViewInNewTabCB)
        elif not menuHasCustomRadialMenuItems:
            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRegraphStream' ], radialPosition = 'N',
            subMenu = True)

            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRegraphUpDownStream' ], radialPosition = 'W',
            ann= (mel.eval('getRunTimeCommandAnnotation ("NodeEditorGraphUpDownstream")')),
            c = graphUpDownstreamCB)

            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRegraphUpStream' ], radialPosition = 'N',
            ann= (mel.eval('getRunTimeCommandAnnotation ("NodeEditorGraphUpstream")')),
            c = graphUpstreamCB)

            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRegraphDownStream' ], radialPosition = 'S',
            ann= (mel.eval('getRunTimeCommandAnnotation ("NodeEditorGraphDownstream")')),
            c = graphDownstreamCB)

            cmds.setParent('..', menu=True)

            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRemoveStream' ], radialPosition = 'E',
            subMenu = True)

            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRemoveUnselected' ], radialPosition = 'W',
            ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRemoveUnselectedAnnot' ],
            c = removeUnselectedCB)

            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRemoveSelected' ], radialPosition = 'E',
            ann= (mel.eval('getRunTimeCommandAnnotation ("NodeEditorGraphRemoveSelected")')),
            c = removeSelectedCB)

            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRemoveUpStream' ], radialPosition = 'N',
            ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRemoveUpStreamAnnot' ],
            c = removeUpstreamCB)

            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRemoveDownStream' ], radialPosition = 'S',
            ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRemoveDownStreamAnnot' ],
        ...
        if not inContainer:
            cmds.menuItem(inputsMenuItem, label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kInputs' ], subMenu = True)
            cmds.menu(inputsMenuItem, e=True, pmc=inputsCB)
            cmds.setParent(parent, menu=True)

            cmds.menuItem(outputsMenuItem, label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kOutputs' ], subMenu = True)
            cmds.menu(outputsMenuItem, e=True, pmc=outputsCB)
            cmds.setParent(parent, menu=True)

            cmds.menuItem( divider=True )

        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRename' ], c = renameCB)

        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kToggleSwatchSize' ],
        ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kToggleSwatchSizeAnnot' ],
        c = toggleSwatchCB)
    ...
    if not editMode:
        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kShowAllAttributes' ],
        ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kShowAllAttributesAnnot' ],
        c = showCB)

        if not inContainer:
            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kAddAttributes' ], c = addCB)

            cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kDeleteAttributes' ], c = deleteCB)

    if not inContainer:
        cmds.menuItem( divider=True )

        helpString = cmds.format(maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kHelpMenuLabel'  ], stringArg=type)
    ...
    if inContainer:
        if isContainerNode:
            if mel.eval('nodeEdCanResetToFactory'):
                ...
                cmds.menuItem(label = maya.stringTable['y_maya_app_general_nodeEditorMenus.kResetToFactory' ], 
                ann = maya.stringTable['y_maya_app_general_nodeEditorMenus.kResetToFactoryAnn' ],
                c = resetToFactoryCB)
    ...
    if isContainerNode and inContainer:
        ...
        cmds.menuItem(label = maya.stringTable['y_maya_app_general_nodeEditorMenus.kEditCompound' ],
            annotation = maya.stringTable['y_maya_app_general_nodeEditorMenus.kEditCompoundAnnot' ],
            command = editCompoundCB,
            enable = True)

        cmds.menuItem(label = maya.stringTable['y_maya_app_general_nodeEditorMenus.kImportCompound' ],
            annotation = maya.stringTable['y_maya_app_general_nodeEditorMenus.kImportCompoundAnnot' ],
            command = importCompoundCB,
            enable = isReferenced)

        cmds.menuItem(label = maya.stringTable['y_maya_app_general_nodeEditorMenus.kPublishCompound' ],
            annotation = maya.stringTable['y_maya_app_general_nodeEditorMenus.kPublishCompoundAnnot' ],
            command = publishCompoundCB,
            enable = True)

        cmds.menuItem(label = maya.stringTable['y_maya_app_general_nodeEditorMenus.kRevertCompound' ],
            annotation = maya.stringTable['y_maya_app_general_nodeEditorMenus.kRevertCompoundAnnot' ],
            command = revertCompoundCB,
            enable = canBeReverted)

        cmds.menuItem( divider=True )

        cmds.menuItem(label = maya.stringTable['y_maya_app_general_nodeEditorMenus.kDeleteCompound' ],
            annotation = maya.stringTable['y_maya_app_general_nodeEditorMenus.kDeleteCompoundAnnot' ],
...
def createConnectionMarkingMenu(ned):
    ...
    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kBreakConnection' ], radialPosition = 'N',
    ann= maya.stringTable[ 'y_maya_app_general_nodeEditorMenus.kCBreakConnectionAnnot' ],
    c = breakCB)

    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectConnectedNodes' ], radialPosition = 'E',
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kSelectConnectedNodesAnnot' ],
    c = selectCB)

    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kIsolateSelectedNodes' ], radialPosition = 'W',
    ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kIsolateSelectedNodesAnnot' ],
    c = isolateCB, enable = (not inContainer))

    if inContainer:
        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kAddWatchpoint' ], radialPosition = 'S',
        ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kAddWatchpointAnnot' ],
...
def createPlugMarkingMenu(ned, node, plug):
    ...
    if customEditNode:
        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugPreview' ],
        ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugPreviewAnnot' ],
        c = previewCB)

        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugHideAll' ],
        ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugHideAllAnnot' ],
        c = hideAllCB)

        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugShowAll' ],
        ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugShowAllAnnot' ],
        c = showAllCB)

        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugRevert' ],
        ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugRevertAnnot' ],
        c = revertCB)

        cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugReset' ],
        ann= maya.stringTable['y_maya_app_general_nodeEditorMenus.kPlugResetAnnot' ],
        c = resetCB)
    #else:
...
def createTabContextMenu(ned, tabIndex):
    ...
    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kCloseTab' ],
    c = closeTabCB)

    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kDuplicateTab' ],
    enable = allowNewTabs,
    c = duplicateTabCB)

    cmds.menuItem(label= maya.stringTable['y_maya_app_general_nodeEditorMenus.kRenameTab' ],
    c = renameTabCB)
# ===========================================================================
