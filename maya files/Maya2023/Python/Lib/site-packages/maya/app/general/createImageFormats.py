...
class ImageFormats(object):
  ...
  def __init__(self):
    ...
    self.addFormat( 0, "gif", maya.stringTable['y_maya_app_general_createImageFormats.kGIF' ])
    self.addFormat( 1, "pic", maya.stringTable['y_maya_app_general_createImageFormats.kSoftImage' ], imfKey="si")
    self.addFormat( 2, "rla", maya.stringTable['y_maya_app_general_createImageFormats.kRLA' ])
    self.addFormat( 3, "tif", maya.stringTable['y_maya_app_general_createImageFormats.kTiff' ])
    self.addFormat( 4, "tif", maya.stringTable['y_maya_app_general_createImageFormats.kTiff16' ],
                   properties = ImageDescriptor.kIsImage + ImageDescriptor.kIsSixteen)
    self.addFormat( 5, "sgi", maya.stringTable['y_maya_app_general_createImageFormats.kSGI' ])

    self.addFormat( 7, "iff", maya.stringTable['y_maya_app_general_createImageFormats.kMayaIFF' ], imfKey="maya")
    self.addFormat( 6, "als", maya.stringTable['y_maya_app_general_createImageFormats.kAliasPIX' ])
    self.addFormat( 8, "jpg",maya.stringTable['y_maya_app_general_createImageFormats.kJPEG' ], imfKey="jpg", otherExtensions="jpeg")
    self.addFormat( 9, "eps", maya.stringTable['y_maya_app_general_createImageFormats.kEPS' ],
                   properties = ImageDescriptor.kIsImage + ImageDescriptor.kIsVector)
    self.addFormat(10, "iff", maya.stringTable['y_maya_app_general_createImageFormats.kMaya16IFF' ],
                   imfKey="maya",
                   properties = ImageDescriptor.kIsImage + ImageDescriptor.kIsSixteen)
    self.addFormat(12, "yuv", maya.stringTable['y_maya_app_general_createImageFormats.kQuantel' ])
    self.addFormat(13, "sgi", maya.stringTable['y_maya_app_general_createImageFormats.kSGI16' ],
                   properties = ImageDescriptor.kIsImage + ImageDescriptor.kIsSixteen)
    # 14-18 are not used any more
    self.addFormat(19, "tga", maya.stringTable['y_maya_app_general_createImageFormats.kTarga' ])
    self.addFormat(20, "bmp", maya.stringTable['y_maya_app_general_createImageFormats.kWindowsBitmap' ])

    self.addFormat(31, "psd", maya.stringTable['y_maya_app_general_createImageFormats.kPSD' ])
    self.addFormat(32, "png", maya.stringTable['y_maya_app_general_createImageFormats.kPNG' ])
    self.addFormat(35, "dds", maya.stringTable['y_maya_app_general_createImageFormats.kDDS' ])
    self.addFormat(36, "psd",maya.stringTable['y_maya_app_general_createImageFormats.kPSDLayered' ],
                   imfKey="psdLayered",
                   properties = ImageDescriptor.kIsImage + ImageDescriptor.kIsLayered)

    if cmds.about(mac=True):
      self.addFormat(22, "mov", maya.stringTable['y_maya_app_general_createImageFormats.kQuicktimeMovie' ],
                     imfKey="qt", properties = ImageDescriptor.kIsMovie)
      self.addFormat(30, "pntg", maya.stringTable['y_maya_app_general_createImageFormats.kMacPaint' ])
      self.addFormat(33, "pict", maya.stringTable['y_maya_app_general_createImageFormats.kQuickDraw' ])
      self.addFormat(34, "qtif", maya.stringTable['y_maya_app_general_createImageFormats.kQuicktimeImage' ])

    if cmds.about(nt=True):
      self.addFormat(23, "avi", maya.stringTable['y_maya_app_general_createImageFormats.kAVI' ], properties = ImageDescriptor.kIsMovie)

    # Add the vector only formats
    self.addFormat(60, "swf", maya.stringTable['y_maya_app_general_createImageFormats.kMacromediaSWF' ],
                   properties=ImageDescriptor.kIsVector)
    self.addFormat(63, "swft", maya.stringTable['y_maya_app_general_createImageFormats.kSwift3DImporter' ],
                   properties=ImageDescriptor.kIsVector)
    self.addFormat(61, "ai", maya.stringTable['y_maya_app_general_createImageFormats.kAdobeIllustrator' ],
                   properties=ImageDescriptor.kIsVector)
    self.addFormat(62, "svg", maya.stringTable['y_maya_app_general_createImageFormats.kSVG' ],
                   properties=ImageDescriptor.kIsVector)
