...
def zipScene(archiveUnloadedReferences):
    ...
    # If the scene has been modified    
                ...
                if(cmds.about(batch=True)):
                        ...
                        dismissStr = 'dismiss'
                        result = cmds.confirmDialog( title=maya.stringTable['y_maya_app_general_zipScene.kArchiveSceneTitle' ], message=maya.stringTable['y_maya_app_general_zipScene.kArchiveSceneMsg' ], \
