...
def addAndConnectObjAttrsToContainer(obj,inAttrs):
	...
	if containerNode:
		...
		for attr in attrs:
			...
			msg = maya.stringTable['y_maya_app_general_publishAttrToContainer.kPublishingAttrMsg'] % (obj,attr,containerNode)
			print(msg)
	else:
		warnings.warn(maya.stringTable['y_maya_app_general_publishAttrToContainer.kNotInContainer'])
...
def removePublishedAttrsFromContainer(obj,inAttrs):
	...
	if containerNode:
		...
		warnings.warn(maya.stringTable['y_maya_app_general_publishAttrToContainer.kNotInContainer2'])
...
def unpublishAttrFromContainer():
	...
	if not foundObjects:
		pyError( maya.stringTable['y_maya_app_general_publishAttrToContainer.kNoChannelBoxSelection'])
