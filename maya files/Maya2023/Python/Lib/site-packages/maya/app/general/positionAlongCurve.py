	...
	if (objects.__len__()>2):
		...
		for object in objects:
			...
			if (cmds.nodeType( child ) == r'nurbsCurve'):
				print (maya.stringTable['y_maya_app_general_positionAlongCurve.kTest' ])
				curve = object

		if (curve == r'temporaryCurveNamePlaceholder'):
			errorString = maya.stringTable['y_maya_app_general_positionAlongCurve.kNoCurve' ]
		...
		errorString = maya.stringTable['y_maya_app_general_positionAlongCurve.kNoSelection' ]
