...
class NodeEditorBookmarksWindow(object):
    ...
    def _createEditMenu(self, parent):
        ...
        cmds.menuItem(label=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kDeleteBookmark' ],
                      c = self._onDelete)
        ...
        cmds.menuItem(label=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kDeleteAllBookmarks' ],
                      c = deleteAllBookmarks)
        
        cmds.menuItem(label=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kRenameBookmark' ],
                      c = self._onRename)

        cmds.menuItem(label=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kReplaceBookmark' ],
                      c = self._onReplace)
    
    def _createUI(self):
        # build the window UI

        cmds.window(windowName, title=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kBookmarks' ],
                    width=150, height=400, menuBar=True, 
                    minimizeButton=True, maximizeButton=False)

        # create the menubar
        mnu = cmds.menu(label=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kEdit' ], to=False)
        ...
        btn = cmds.button(label=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kCreate' ], c = self._onCreate)
...
def buildMenu(ned):
    ...
    def bookmarksPMC(*args):
        ...
        cmds.menuItem(label=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kCreateBookmark'],
                      ann=maya.stringTable[ 'y_maya_app_general_nodeEditorBookmarks.kCreateBookmarkAnnot'  ],
                      image= "addBookmark.png",
                      c=partial(createBookmark, ned))
        cmds.menuItem(label=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kBookmarkEditor'],
                      ann=maya.stringTable[ 'y_maya_app_general_nodeEditorBookmarks.kBookmarkEditorAnnot'  ],
                      image= "editBookmark.png",
                      c=partial(showWindow, ned))
        cmds.menuItem(divider=True)

        for name,info in _getBookmarkInfos():
            cmds.menuItem(label=name, ann=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kLoadBookmarkAnnot' ],
                          c=partial(loadBookmark, ned, info) )
            cmds.menuItem(ob=True, ann=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kRenameBookmarkAnnot' ],
                          c=partial(renameBookmark, ned, name, info) )
    cmds.menu(menuName, label=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kBookmarks2'], pmc=bookmarksPMC)
...
def buildToolbar(ned):
	...
	addBookmarkItem,
        i1 = "addBookmark.png",
        w = isz,h = isz,
        ann = maya.stringTable[ 'y_maya_app_general_nodeEditorBookmarks.kCreateBookmarkAnnot2'  ],
        c = partial(createBookmark, ned))
    cmds.iconTextButton(
	editBookmarkItem,
        i1 = "editBookmark.png",
        w = isz,h = isz,
        ann = maya.stringTable[ 'y_maya_app_general_nodeEditorBookmarks.kBookmarkEditorAnnot2'  ],
        c = partial(showWindow, ned))
    cmds.iconTextButton(
	fileDialogBackItem,
        i1 = "SP_FileDialogBack.png",
        w = isz,h = isz,
        ann = maya.stringTable[ 'y_maya_app_general_nodeEditorBookmarks.kPreviousBookmarkAnnot'  ],
        c = partial(loadPreviousBookmark, ned))
    cmds.iconTextButton(
	fileDialogForwardItem,
        i1 = "SP_FileDialogForward.png",
        w = isz,h = isz,
        ann = maya.stringTable[ 'y_maya_app_general_nodeEditorBookmarks.kNextBookmarkAnnot'  ],
...
def _getBookmarkName(name):
    ...
    ok = maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kOk']
    cancel = maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kCancel']
    result = cmds.promptDialog(
        title=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kNameBookmarkTitle'],
        message=maya.stringTable['y_maya_app_general_nodeEditorBookmarks.kNameMessage'],
