...
class TselectionWin(object):
	...
	def getWindowTitle(self):
		...
		suffix = maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kNothingIsSelected' ]
		if len(self.objects):
...
class TadjustBackgroundImageWin( TselectionWin ):
	...
	def __init__(self, editor):
		...
		TselectionWin.__init__(self, 
							   maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kAttributeWndTitle' ],
	...
	def onLoadImage(self):
		...
		try:
			...
			theFile = cmds.fileDialog2( fileMode=1,
										okCaption=maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kLoad' ],
										caption=maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kLoadImage' ],
										fileFilter=filter,
	...
	def show(self):
		...
		self.imageNameField = cmds.textFieldButtonGrp( 
			label= maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kImageName' ],
			fileName= "",
			editable= True,
			buttonLabel= maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kLoad2' ],
			buttonCommand= self.onLoadImage,
			changeCommand = self.onImageFieldChange)
		self.adjustImageHPositionSlider = cmds.floatSliderGrp(
			label= maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kHorizontalPosition' ],
			field= True,
			min= 0,
			max= 1000.0,
			precision= 2,
		...
		self.adjustImageVPositionSlider = cmds.floatSliderGrp(
			label= maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kVerticalPosition' ],
			field= True,
			min= 0,
			max= 1000.0,
			precision= 2,
		...
		self.adjustImageScaleSlider = cmds.floatSliderGrp(
			label= maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kScale' ],
			field= True,
			min= 0.1,
			max= 10.0,
		...
		adjustImageFitToWidthButton = cmds.button(
			label = maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kFitToWidth' ],
			command = self.onFitToWidth )

		adjustImageFitToHeightButton = cmds.button(
			label= maya.stringTable['y_maya_app_general_adjustBackgroundImageWin.kFitToHeight' ],
