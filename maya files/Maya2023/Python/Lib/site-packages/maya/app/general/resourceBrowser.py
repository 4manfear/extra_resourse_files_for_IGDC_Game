...
class resourceBrowser(object):
  ...
  def saveCopy(self, data):
    ...
    ext = os_path.splitext(resName)[1]
    if ext == '':
      ext = '.png'

    # Bring a file browser to select where to save the copy
    captionStr = maya.stringTable['y_maya_app_general_resourceBrowser.kPickIconCaption' ];
  ...
  def populateUI(self):
    ...
    self.wFilter = cmds.textFieldGrp(label=maya.stringTable['y_maya_app_general_resourceBrowser.kFilter' ],
    ...
    b1 = cmds.button(label=maya.stringTable['y_maya_app_general_resourceBrowser.kSelect' ],
                     command=partial(self.buttonCallback, dismissMsg="valid"))
    b2 = cmds.button(label=maya.stringTable['y_maya_app_general_resourceBrowser.kSaveCopy' ],
                     annotation=maya.stringTable['y_maya_app_general_resourceBrowser.kSaveCopyAnn' ],
                     command=self.saveCopy)
    b3 = cmds.button(label=maya.stringTable['y_maya_app_general_resourceBrowser.kCancel' ],
  ...
  def run(self):
    ...
    result = cmds.layoutDialog(title = maya.stringTable['y_maya_app_general_resourceBrowser.kShelves' ],
                               ui=self.populateUI)
