...
class MyCustom(Custom):
            ...
            with self.newTab('kGeometry'):
                ...
                with self.frameLayout('kMeshSettings', True):
                    ...
                    with self.frameLayout('kDeformableType'):
                        ...
                        self.addSlider('maxEdgeLength', label= 'kRefineThreshold', node='remeshNode')
                        self.addSlider('collapseThreshold', label= 'kReduceThreshold', node='remeshNode')
    ...
    def updateFont(self):
        ...
        for i in range(self.font_menu.count()):
    ...
    def updateFontStyle(self):
        ...
        for i in range(self.font_style_menu.count()):
    ...
    def updateWritingSystem(self):
        ...
        for i in range(self.writingSystemMenu.count()):
...
def HexToUni(hexStr):
    ...
    value_list = hexStr.split()
    for value in value_list:
        number = int(value, 16)
        bytes.append(chr(number))
