            ...
            with self.newTab('kSVGGeometryLbl'):
                with self.frameLayout('kSVGMeshSettingsLbl', True):
                    ...
                    with self.frameLayout('kSVGDeformableMeshLbl'):
                        ...
                        self.addSlider('maxEdgeLength', label= 'kSVGMaxRefineThreshLbl', node='remeshNode')
                        self.addSlider('collapseThreshold', label= 'kSVGReduceThreshLbl', node='remeshNode')
