...
def rigRoot( dagObject ):
	...
	"""
	ufeRuntime = cmds.nodeType(dagObject, ufeRuntimeName=True)
	# if ufeRuntime is available, do not use standard stereo camera rig
	if (ufeRuntime != "" and ufeRuntime != 'Maya-DG'): return ''
