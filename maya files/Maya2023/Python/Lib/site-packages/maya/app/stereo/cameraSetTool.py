...
class NamingTemplateUI( BaseUI ):
	...
	def deleteLayer( self, args, layer=0 ):
		...
		layerL10N = maya.stringTable['y_maya_app_stereo_cameraSetTool.kLayerId'  ] 
	...
	def layoutForLayer( self, layer ):
		...
		locLayer = maya.stringTable['y_maya_app_stereo_cameraSetTool.kLayerNumberString' ]
		frlt = cmds.frameLayout( collapsable=True, label= locLayer + " %d" % layer )
		ui['frame'] = frlt
		self._layerFrameUI.append(ui)

		cmds.columnLayout( adjustableColumn=True )
		ui['layerPrefix'] = cmds.textFieldGrp( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kLabelPrefix'],
											   text=self._template.layerPrefixForLayer(layer))
		ui['menuGrp'] = cmds.optionMenuGrp( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kRigType'] )
		...
		ui['ckbox'] = cmds.checkBox( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kAutoCreate' ] )
		ui['icon'] = cmds.iconTextButton(style="iconOnly",
										 image="removeRenderable.png",
										 annotation=maya.stringTable['y_maya_app_stereo_cameraSetTool.kDelete' ],
										 width=20, height=20)
		cmds.checkBox( ui['ckbox'], edit=True,
	...
	def buildLayout( self ):
		...
		labelL10N = maya.stringTable[ 'y_maya_app_stereo_cameraSetTool.kMultiRigName'  ]
		...
		labelL10N = maya.stringTable[ 'y_maya_app_stereo_cameraSetTool.kMultiRigPrefix'  ]
		...
		if len(availCameraSets) > 1: 
			labelL10N = maya.stringTable[ 'y_maya_app_stereo_cameraSetTool.kCameraSetNodeType'  ]
		...
		cmds.setParent('..')
		form = cmds.formLayout()
		b1 = cmds.button( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kCreateIt' ],
						  command=self.createIt )
		b2 = cmds.button( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kRemoveIt' ],
						  command=self.removeDef )
		b3 = cmds.button( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kAddIt' ],
...
class CameraSetEditor( BaseUI ):
	...
	"""
	_EditorName = maya.stringTable['y_maya_app_stereo_cameraSetTool.kEditorName' ]
	...
	def buildLayout( self ):
		...
		button = cmds.button( label= maya.stringTable['y_maya_app_stereo_cameraSetTool.kEditorNew' ], command=self._newUI.newTemplate )
		attForm = [
				   (layout, 'top', 0),
				   (layout, 'right', 0),
				   (layout, 'left', 0),
	...
	def create( self ):
		...
		cmds.menu( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kEditMenu' ] )
		cmds.menuItem( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kSaveSettings' ],
					   command=self._newUI.saveSettings )
		cmds.menuItem( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kResetSettings' ],
					   command=self._newUI.resetSettings )
		cmds.menu( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kHelpMenu' ] )
		cmds.menuItem( label=maya.stringTable['y_maya_app_stereo_cameraSetTool.kHelpOnMultiRig' ], 
