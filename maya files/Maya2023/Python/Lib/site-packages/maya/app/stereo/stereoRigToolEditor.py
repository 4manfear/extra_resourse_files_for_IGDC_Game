...
def __oneItem(layout, rig, definition, mode):
	...
	#----------------------------------------------------------------------
	if mode == 'maya':
		name = cmds.text(label=maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kReadOnly' ], align='right')
	else:
		cmds.text(label=maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kRigToolName' ], align='right')
	if rig == None:
		name = cmds.textField()
	else:
	...
	#----------------------------------------------------------------------
	cmds.text(label=maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kRigLanguage' ], align='right')
	if mode == 'custom':
	...
	if mode == 'custom':
		icon = cmds.iconTextButton(style="iconOnly",
				...
				annotation=maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kDelete' ],
				width=20, height=20)
	...
	#----------------------------------------------------------------------
	cmds.text(label=maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kRigCreate' ], align='right')
	text = cmds.textField(text=definition[1])
	cmds.text(label=maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kCameraSetCb' ], align='right')
...
def buildMainToolUI():
	...
	cmds.frameLayout(label=maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kEdit' ])
	cmds.columnLayout()
	...
	cmds.frameLayout(label=maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kRegister' ])
	cmds.columnLayout()
	cmds.separator(height=5, style='none')
	...
	cmds.rowColumnLayout(numberOfColumns=2,
						 ...
						 columnWidth=[[1,150],[2,300]])
	cmds.text(label='')
	btn = cmds.button( label=maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kNewRig' ])
...
def customRigEditor():
	...
	__mainWin = cmds.window( title = maya.stringTable['y_maya_app_stereo_stereoRigToolEditor.kRigWndTitle' ],
