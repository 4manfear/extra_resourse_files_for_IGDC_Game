...
class CacheCorrectnessContext(object):
    ...
    def comparison_is_valid(self):
        ...
        :return: True when the EM is still active, even if caching has been disabled
        '''
        return cmds.evaluationManager( query=True, disableInfo=True ) is None
    ...
    def __enter__(self):
        ...
        try:
            ...
            self.deformer_mgr.__exit__(*sys_exc_info())
            raise ex
        try:
