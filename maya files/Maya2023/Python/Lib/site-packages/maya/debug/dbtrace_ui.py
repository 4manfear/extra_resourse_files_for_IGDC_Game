...
def dbtrace_enable_change(checkbox_widget, trace_name, trace_level, new_state):
    ...
    try:
        ...
        cmds.confirmDialog( title=maya.stringTable['y_maya_debug_dbtrace_ui.kTraceModFailure'], message=fail_message )
...
def dbtrace_show_output(trace_object, output_file):
    ...
    scrollableMessageBox(
        title=maya.stringTable['y_maya_debug_dbtrace_ui.kDbTraceOutputTitle' ].format( trace_object, output_file)
...
def dbtrace_ui():
    ...
    if not cmds.window( DBTRACE_WINDOW, exists=True ):
        ...
        #
        cmds.text( label=maya.stringTable['y_maya_debug_dbtrace_ui.kFilter' ] )
        DBTRACE_FILTER_TEXT = cmds.textField( DBTRACE_FILTER_TEXT, text=filter_text, alwaysInvokeEnterCommandOnReturn=True,
                           annotation=maya.stringTable['y_maya_debug_dbtrace_ui.kShowFilterInfo' ] )
        ...
        DBTRACE_SHOW_DISABLED = cmds.checkBox( DBTRACE_SHOW_DISABLED,
                                     value=show_disabled,
                                     label=maya.stringTable['y_maya_debug_dbtrace_ui.kShowOff' ],
                                     annotation=maya.stringTable['y_maya_debug_dbtrace_ui.kShowOffInfo' ],
        ...
        DBTRACE_SHOW_ENABLED = cmds.checkBox( DBTRACE_SHOW_ENABLED,
                                    value=show_enabled,
                                    label=maya.stringTable['y_maya_debug_dbtrace_ui.kShowOn' ],
                                    annotation=maya.stringTable['y_maya_debug_dbtrace_ui.kShowOnInfo' ],
    ...
    cmds.text( label=maya.stringTable['y_maya_debug_dbtrace_ui.kTrace' ], font='boldLabelFont' )
    cmds.text( label=maya.stringTable['y_maya_debug_dbtrace_ui.kOutput' ], font='boldLabelFont' )
    cmds.text( label=maya.stringTable['y_maya_debug_dbtrace_ui.kShow' ], font='boldLabelFont' )
    cmds.text( label=maya.stringTable['y_maya_debug_dbtrace_ui.kDescription' ], font='boldLabelFont' )
