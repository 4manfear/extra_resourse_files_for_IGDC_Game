...
def list_frozen_in_scheduling():
    ...
    frozen_nodes = []
    try:
        clusters = json.loads( cmds.dbpeek( op='graph', evaluationGraph=True, all=True, a=['scheduling', 'verbose']) )['scheduling']['clusters']
        for cluster_name, cluster_members in list(clusters.items()):
