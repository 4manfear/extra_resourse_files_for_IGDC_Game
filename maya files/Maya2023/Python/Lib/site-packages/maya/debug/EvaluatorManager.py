...
class EvaluatorManager(DebugTrace):
    ...
    def __init__(self, name, plugin):
        ...
        # Uncomment these two lines if you want evaluator debug output
        #self.debugging = True
    ...
    def as_json(self):
        ...
        if not self.plugin_loaded:
            return { 'error' : maya.stringTable['y_maya_debug_EvaluatorManager.kEvaluatorDisabled' ] }
    ...
    def claimed_nodes(self, flatten):
        ...
        try:
            ...
            self.err( maya.stringTable['y_maya_debug_EvaluatorManager.kFailedClaim' ].format(self.evaluator_name, ex) )
    ...
    def set_state(self, new_state):
        ...
        self.dbg( 'EvaluatorManager.set_state({})'.format( new_state ) )
    ...
    def check_evaluator(self):
        ...
        if self.evaluator_name not in cmds.evaluator( query=True ):
            raise OptionVar.StateError( maya.stringTable['y_maya_debug_EvaluatorManager.kNoEvaluator' ].format( self.evaluator_name ) )
    ...
    def enabled(self, new_value):
        ...
        try:
            ...
            cmds.warning( maya.stringTable['y_maya_debug_EvaluatorManager.kErrSetEnabled' ].format(ex) )
    ...
    def priority(self, new_value):
        ...
        try:
            ...
            cmds.warning( maya.stringTable['y_maya_debug_EvaluatorManager.kErrSetPriority' ].format(ex) )
    ...
    def plugin_loaded(self, new_value):
        ...
        self.dbg( '   {0}oading plug-in {1}'.format('L' if new_value else 'Unl', self.plugin_name) )
        try:
            if new_value:
            ...
            cmds.warning( maya.stringTable['y_maya_debug_EvaluatorManager.kErrSetPluginLoaded' ].format(ex) )
    ...
    def node_types(self, new_value):
        ...
        try:
            ...
            cmds.warning( maya.stringTable['y_maya_debug_EvaluatorManager.kErrSetNodeTypes' ].format(ex) )
    ...
    def consolidation(self, new_value):
        ...
        try:
            ...
            cmds.warning( maya.stringTable['y_maya_debug_EvaluatorManager.kErrSetConsolidation' ].format(ex) )
# ===========================================================================
