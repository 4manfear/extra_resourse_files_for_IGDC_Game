...
class EMState(object):
    ...
    def __init__(self):
        ...
        self.manipulation_prevalidation = cmds.evaluationManager( query=True, manipulationPrevalidation=True )
    ...
    def __str__(self):
        ...
        state = { 'enabled'                      : self.enabled
                ...
                , 'manipulation_prevalidation'   : self.manipulation_prevalidation
                , 'mode'                         : self.mode
        ...
        for evaluator, evaluator_info in list(self.evaluators.items()):
            state['evaluators'][evaluator] = evaluator_info

        return json.dumps( { 'emState' : state }, indent=4, separators=(',', ': ') )
