...
class DGState(object):
    ...
    def scan_scene(self, do_eval, data_types):
        ...
        :param data_types: Type of data to look for - {mesh, matrix, number, vector}
        """

        # This is leftover from refactoring and should be cleaned up
        self.results_file = None
        self.image_file = None
        self.state = []
        self.md5_value = MD5_DEFAULT

        # Translate the method args into arguments for the dbpeek operations
        data_args = []
    ...
    def __executable(program_name):
        ...
        if sys_platform.startswith('win32') or sys_platform.startswith('cygwin'):
    ...
    def __compare_with_ImageMagick( self, other ):
        ...
        try:
            ...
            image_compare_output = subprocess_Popen(
                                    [ compare
                                    ...
                                    , stdout=subprocess_PIPE).communicate()
    ...
    def __compare_with_imf_diff( self, other ):
        ...
        try:
            ...
            imf_diff = self.__executable( os_path.join( os_getenv('MENTALRAY_BIN_LOCATION'), 'imf_diff' ) )
            from subprocess import Popen as subprocess_Popen, PIPE as subprocess_PIPE
            image_compare_output = subprocess_Popen(
                                      [ imf_diff
    ...
    def compare(self, other, output_mode, ignored_nodes=None, whitelist=None):
        ...
        for (name, value) in list(self_values.items()):
