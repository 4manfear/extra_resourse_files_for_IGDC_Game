...
COLOUR_INFO = { r'opacity' : [ [ r'cachedPlaybackFramesOPACITY',        maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kCachedPlaybackFramesOPACITY'      ]           ] ]
              , r'colour'  : [ [ r'cachedPlaybackCachedFrames',         maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kCachedPlaybackCachedFrames'       ]      ]
                             , [ r'cachedPlaybackCachedFxFrames',       maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kCachedPlaybackCachedFxFrames'     ] ]
                             , [ r'cachedPlaybackUncachedFrames',       maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kCachedPlaybackUncachedFrames'     ]    ]
                             , [ r'cachedPlaybackInvalidatedFrames',    maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kCachedPlaybackInvalidatedFrames'  ] ]
                             , [ r'cachedPlaybackCachedSubframes',      maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kCachedPlaybackCachedSubframes'    ]   ]
                             , [ r'cachedPlaybackInvalidatedSubframes', maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kCachedPlaybackInvalidSubframes'   ]  ]
                             , [ r'cachedPlaybackWarningFrames',        maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kCachedPlaybackWarningFrames'      ]     ]
                             ]
              }
OPACITY_NAMES = [name for [name, text] in COLOUR_INFO[r'opacity']]
COLOUR_NAMES  = [name for [name, text] in COLOUR_INFO[r'colour']]

#======================================================================
def colour_widget(colour_name):
    ''':return: Name of the RGB slider widget corresponding to the colour 'colour_name' '''
    return colour_name + r'RGBColorSlider'

#======================================================================
def opacity_widget(colour_name):
    ''':return: Name of the opacity slider widget corresponding to the colour 'colour_name' '''
    return colour_name + r'OPACITYColorSlider'

#======================================================================
class CacheUiColour(with_metaclass(Singleton, CacheUiBase)):
    '''
    ...
    FRAME_NAME = r'CacheUiColourPrefsFrame'
    ...
    def __init__(self):
        ...
        self.ui_key = r'cache_preferences_in_colour_preferences'
    ...
    def callback_update_ui(tool, plugin_loaded=None):
        ...
        if tool.ID_FRAME in tool.widgets:
            cmds.frameLayout( tool.widgets[tool.ID_FRAME], edit=True, visible=plugin_loaded, enable=cache_enabled )
            # If the cache is disabled then collapse the frame if it was expanded, otherwise leave it in its last state
            if not cache_enabled:
                cmds.frameLayout( tool.widgets[tool.ID_FRAME], edit=True, collapse=not cache_enabled )
        else:
            cmds.warning( maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kNoFrame' ] )
    ...
    def create_colour_slider(self, colour_name, colour_label):
        ...
        try:
            ...
            cmds.warning( maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kDuplicateColourSlider' ].format( colour_name ) )
    ...
    def create_opacity_slider(self, colour_name, colour_label):
        ...
        try:
            ...
            cmds.warning( maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kDuplicateOpacitySlider' ].format( colour_name ) )
    ...
    def create_frame(self):
        ...
        self.widgets[self.ID_FRAME] = cmds.frameLayout( self.FRAME_NAME, label=maya.stringTable['y_maya_plugin_evaluator_CacheUiColour.kCachedPlayback'], collapsable=True )
    ...
    def callback_populate_frame(tool):
        ...
        cmds.setUITemplate( r'DefaultTemplate', pushTemplate=True )
        cmds.columnLayout( adjustableColumn=True )

        # Fill in the colour preference sliders
        for [opacity_name, opacity_label] in COLOUR_INFO[r'opacity']:
            tool.create_opacity_slider( opacity_name, opacity_label )
        for [colour_name, colour_label] in COLOUR_INFO[r'colour']:
