...
from maya.plugin.evaluator.CacheScriptJobHelper import CacheScriptJobHelper, EVENT_CACHE_DESTROYED, EVENT_LIMIT_CHANGE
from future.utils import with_metaclass

__all__ = [r'CacheUiHud']

RUNTIME_TOGGLE_CMD = r'ToggleCacheVisibility'

#======================================================================
class CacheUiHud(with_metaclass(Singleton, CacheUiBase)):
    '''
    ...
    ID_TOOLKIT            = r'toolkit'
    ID_MENU               = r'menu'
    ID_PREVIOUS_MENU_ITEM = r'previousMenuItem'
    ID_MENU_ITEM_PARENT   = r'menuItemParent'

    # Data for the different HUD types.
    # KEY=Name of the HUD element, VALUE=[HUD label, HUD preset name]
    HUD_NAMES = [ r'HUDVP2ResourceLimit', r'HUDResourceLimit', r'HUDCacheState' ]
    HUD_DATA  = { HUD_NAMES[0] : [ maya.stringTable[ 'y_maya_plugin_evaluator_CacheUiHud.kHUDLabelVP2ResourceLimit'   ], r'Vp2ResourceLimit' ]
                , HUD_NAMES[1] : [ maya.stringTable[ 'y_maya_plugin_evaluator_CacheUiHud.kHUDLabelResourceLimit'   ],        r'resourceLimit' ]
                , HUD_NAMES[2] : [ maya.stringTable[ 'y_maya_plugin_evaluator_CacheUiHud.kHUDLabelCache'   ],                       r'cacheState' ]
                }
    ...
    def __init__(self):
        ...
        self.ui_key = r'cache_preferences_in_hud'
        ...
        if not cmds.runTimeCommand( RUNTIME_TOGGLE_CMD, exists=True ):
            cmds.runTimeCommand( RUNTIME_TOGGLE_CMD
                               , default=True
                               , label=maya.stringTable['y_maya_plugin_evaluator_CacheUiHud.kCacheHudLabel' ]
                               , annotation=maya.stringTable['y_maya_plugin_evaluator_CacheUiHud.kCacheHudAnnotation' ]
                               , category=(r'Menu items.Common.Display.Heads Up Display')
                               , commandLanguage=r'python'
                               , command=r'from maya.plugin.evaluator.CacheUiHud import CachePreferenceHud; CachePreferenceHud().set_value( not CachePreferenceHud().get_value() )'
                               )
    ...
    def create_toolkit_button(self):
        ...
        self.widgets[self.ID_TOOLKIT] = cmds.checkBoxGrp( label=''
                                                        , label1=maya.stringTable['y_maya_plugin_evaluator_CacheUiHud.kCacheHUD' ]
    ...
    def create_heads_up_display(self, section, label_width, starting_block):
        ...
        CacheScriptJobHelper().add_client( self, EVENT_LIMIT_CHANGE,    callback_tool( self, self.callback_memory_changed ) )
