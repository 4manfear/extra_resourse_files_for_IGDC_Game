...
__all__ = [r'CacheUiPreferencesTab']

#======================================================================
class CacheUiPreferencesTab(with_metaclass(Singleton, CacheUiBase)):
    '''
    ...
    def __init__(self):
        ...
        self.ui_key = r'cache_preferences_tab'
        self.ui_key_layout = r'cache_preferences_tab_layout'
    ...
    def plugin_state_change(self, new_state):
        ...
        if new_state:
            ...
            mel.eval( r'source preferencesWnd.mel; enableTab({})'.format( self.text_scroll_index ) )
        else:
            if self.text_scroll_widget is not None:
                ...
                mel.eval( r'source preferencesWnd.mel; disableTab({})'.format( self.text_scroll_index ) )

        mel.eval( r'source preferencesWnd.mel; switchPrefTabs {};'.format(last_selected)  )
    ...
    def create_ui(self, prefs_template):
        ...
        return maya.stringTable[ 'y_maya_plugin_evaluator_CacheUiPreferencesTab.kCachePreferencesTabTitle'  ]
    ...
    def create_list_entry(self, prefs_window, text_scroll_widget, text_scroll_index, new_state=None):
        ...
        cmds.textScrollList( text_scroll_widget, edit=True, appendPosition=[text_scroll_index, maya.stringTable['y_maya_plugin_evaluator_CacheUiPreferencesTab.kCachePreferencesTabText']], uniqueTag=r'CachedPlayback' )
        return True
    ...
    def update_ui(self):
        ...
        if (not self.widgets) or self.ui_key_layout not in CacheUiFullLayout.CONTROLS:
