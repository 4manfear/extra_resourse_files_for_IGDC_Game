...
__all__ = [r'CacheUiTimesliderPreferences']

#======================================================================
class CacheUiTimesliderPreferences(with_metaclass(Singleton, CacheUiBase)):
    '''
    ...
    ID_ROOT           = r'CacheTimeslider'
    ID_STATUS         = r'CacheTimesliderStatus'
    ID_POSITION       = r'CacheTimesliderPosition'
    ID_HEIGHT         = r'CacheTimesliderHeight'
    ID_SPACING        = r'CacheTimesliderSpacing'
    ID_SHOW_INVALID   = r'CacheTimesliderShowInvalid'
    ID_SHOW_SUBFRAMES = r'CacheTimesliderShowSubframes'
    ID_SHOW_WARNING   = r'CacheTimesliderShowWarnings'
    ...
    def __init__(self):
        ...
        self.ui_key = r'cache_preferences_in_timeslider_preferences'
    ...
    def callback_update_location(value, location, tool):
        ...
        CachePreferenceTimesliderBarPosition().set_value_directly( tool, [r'above',r'below'][location] )
    ...
    def create_ui(self):
        ...
        assert not self.widgets

        self.widgets[self.ID_ROOT] = cmds.frameLayout(self.ID_ROOT, label=maya.stringTable['y_maya_plugin_evaluator_CacheUiTimesliderPreferences.kFrameCachedPlaybackStatus' ])
        ...
        cmds.scriptJob( uiDeleted=(self.widgets[self.ID_ROOT], callback_tool(self, partial(self.callback_ui_deleted, element=self.widgets[self.ID_ROOT]))) )
