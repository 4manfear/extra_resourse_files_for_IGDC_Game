...
kAnalyticLabel = maya.stringTable['y_maya_analytics_analyticNodeTypes.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_maya_analytics_analyticNodeTypes.kAnalyticDescriptionShort' ]
...
class analyticNodeTypes(BaseAnalytic):
    ...
    def run(self):
        ...
        if self.option(OPTION_DETAILS):
            ...
            for (node_type, nodes_of_type) in list(node_type_list.items()):
