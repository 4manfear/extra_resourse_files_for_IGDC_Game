...
kAnalyticLabel = maya.stringTable['y_maya_analytics_analyticAnimation.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_maya_analytics_analyticAnimation.kAnalyticDescriptionShort' ]
    ...
    def run(self):
        ...
        for anim_curve in anim_curves:
            ...
            if self.option(OPTION_DETAILS):
                ...
                anim_curve_data = { self.KEY_KEYFRAMES : list(zip(keyframes[::2], keyframes[1::2])) }
        ...
        if self.option(OPTION_SUMMARY):
            ...
            for driven_data in list(driven_by_node_types.values()):
                for (driven_count, driven_per_count) in list(driven_data.items()):
                    if driven_count == 0:
