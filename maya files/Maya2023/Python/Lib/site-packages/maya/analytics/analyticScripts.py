...
kAnalyticLabel = maya.stringTable['y_maya_analytics_analyticScripts.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_maya_analytics_analyticScripts.kAnalyticDescriptionShort' ]
...
class analyticScripts(BaseAnalytic):
    ...
    def __reportFlag(self, name):
        ...
        if hasattr(self, name):
            ...
            if argList != None:
                for arg, count in list(argList.items()):
                    self.scriptCount += 1
