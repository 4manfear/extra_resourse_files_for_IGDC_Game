...
kAnalyticLabel = maya.stringTable['y_maya_analytics_analyticGPUClusters.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_maya_analytics_analyticGPUClusters.kAnalyticDescriptionShort' ]
    ...
    def run(self):
        ...
        for node in animated_nodes:
            if cmds.nodeType( node ) == 'cluster':
                ...
                cluster_geometry = dict( list(zip( geometry_indices, geometries )) )
                for index, geometry in list(cluster_geometry.items()):
