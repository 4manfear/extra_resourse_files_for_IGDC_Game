...
kAnalyticLabel = maya.stringTable['y_maya_analytics_analyticGPUDeformers.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_maya_analytics_analyticGPUDeformers.kAnalyticDescriptionShort' ]
    ...
    def run(self):
        ...
        for node in animated_nodes:
            ...
            if node_type in deformer_node_types:
                ...
                deformer_geometry = dict( list(zip( geometry_indices, geometries )) )
                for index, geometry in list(deformer_geometry.items()):
