...
class BaseAnalytic(object):
    ...
    def marker_file(self):
        ...
        return os_path.join( self.directory, '{0:s}.ANALYZING'.format(self.name()) )
    ...
    def json_file(self):
        ...
        if self.directory is None:
            ...
            return None
        from os import path as os_path
        return os_path.join( self.directory, '{0:s}.json'.format(self.name()) )
    ...
    def set_output_directory(self, directory):
        ...
        try:
            try:
                ...
                os_makedirs( directory, 0o777 )
            except OSError as err:
                # This is the "directory already exists" error; harmless here
                if err.errno!=17:
                    raise
            from os import W_OK as os_W_OK, access as os_access
            if not os_access( directory, os_W_OK):
