...
kAnalyticLabel = maya.stringTable['y_maya_analytics_AnalyticStaticNodeTypes.kAnalyticLabel' ]
kAnalyticDescriptionShort = maya.stringTable['y_maya_analytics_AnalyticStaticNodeTypes.kAnalyticDescriptionShort' ]
...
class AnalyticStaticNodeTypes(BaseAnalytic):
    ...
    def run(self):
        ...
        for (name, hierarchy) in list(node_type_hierarchy.items()):
