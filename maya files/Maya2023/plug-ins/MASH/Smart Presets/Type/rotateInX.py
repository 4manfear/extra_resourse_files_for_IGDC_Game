...
def onMayaDroppedPythonFile(object):
    def runPreset():
        ...
        inAngles = [0.0, 0.0]
        outAngles = [0.0, 0.0]
        inWeights = [16.333333333333336, 31.737597596813913]
        outWeights = [16.333333333333336, 31.737597596813913]
        ...
        inAngles = [0.0, 0.0]
        outAngles = [0.0, 0.0]
        inWeights = [0.3333333333333333, 0.3333333333333333]
        outWeights = [0.3333333333333333, 0.3333333333333333]
        ...
        outAngles = [3.0442141361521, 0.0]
        inWeights = [9.298075338208578, 33.662620157171716]
        outWeights = [9.29807504114183, 33.662620157171716]
