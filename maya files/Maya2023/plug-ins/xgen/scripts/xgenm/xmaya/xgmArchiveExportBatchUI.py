...
class xgmArchiveExportBatchUI( QDialog ):
    ...
    def createLodWidgets( self, lay ):
        ...
        self.lodEdit = self.createComboWidget( linelayout, maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kLevelOfDetail'  ],
                               [maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kDisabled'  ], 
                            maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kAutomatic'  ], 
                            maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kManual'  ]] )
        self.lodEdit.currentIndexChanged.connect( self.updateLodWidgets )
        self.loLabel = QLabel( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kLow'  ] )
        ...
        self.medLabel = QLabel( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kMedium'  ] )
    ...
    def createAnimWidgets( self, lay, labelText, v, startFrame, endFrame ):
        ...
        self.startFrameLabel = QLabel( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kStartFrame'  ] )
        ...
        self.endFrameLabel = QLabel( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kEndFrame'  ] )
    ...
    def createSourceWidgets( self, lay, labelText ):
        ...
        self.browseSource = QPushButton( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kBrowse'  ] )
        ...
        self.removeSource = QPushButton( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kRemove'  ] )
    ...
    def browseSourceClicked( self ):
        ...
        dlg.setWindowTitle( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kSelectScenesToBeConverted'  ] )
        dlg.setDirectory( self.sourceDir )
        dlg.setFileMode( QFileDialog.ExistingFiles )
        dlg.setNameFilter( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kMayaSceneFiles'  ] + "(*.ma *.mb)")
        dlg.setNameFilterDetailsVisible( False )
        dlg.setLabelText( QFileDialog.Accept, maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kSelect'  ] )
    ...
    def createDestinationWidgets( self, lay, labelText ):
        ...
        self.comboDestination = self.createComboWidget( vlayout, labelText, \
            [ \
            maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kUserArchives'  ], \
            maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kLocalArchives'  ], \
            maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kGlobalArchives'  ], \
            maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kCustom'  ] \
            ], False )
        ...
        if not self.batchMode:
            linelayout = QHBoxLayout()
            linelayout.setContentsMargins(DpiScale(0), DpiScale(0), DpiScale(0), DpiScale(0))
            label = QLabel( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kArchiveName'  ] )
            label.setFixedWidth( self.labelSize )
            label.setAlignment( self.labelAlign )
            linelayout.addWidget( label )
    ...
    def browseDestinationClicked( self ):
        dlg = QFileDialog( self )
        dlg.setWindowTitle( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kSelectCustomDestination'  ] )
        dlg.setOption( QFileDialog.ShowDirsOnly, True  )
        dlg.setFileMode( QFileDialog.Directory )
        dlg.setDirectory( self.customDest )
        dlg.setLabelText( QFileDialog.Accept, maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kSelect2'  ] )
        if dlg.exec_() == QDialog.Accepted and len( dlg.selectedFiles() ) > 0:
    ...
    def __init__(self, batchMode ):
        ...
        if self.batchMode:
            title = maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kBatchConvertScenesToXgenArchives'  ]
            okButtonText = maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kConvert2'  ]
        else:
            title = maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kExportSelectionAsArchives'  ]
            okButtonText = maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kExport2'  ]
        ...
        self.cancelButton = QPushButton( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kCancel2'  ])
        self.cancelButton.clicked.connect( self.onDialogCancel )
        self.helpButton = QPushButton( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kHelp2'  ])
        ...
        # add some widgets
        if self.batchMode:
            self.createSourceWidgets( self.toplayout, maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kScenesToBeConverted'  ] )
        self.createDestinationWidgets( self.toplayout, maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kDestinationFolder'  ] )
        ...
        self.createAnimWidgets( self.toplayout, maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kIncludeAnimation'  ], QtCore.Qt.Unchecked, 1, 24 )
        ...
        self.progress = QProgressDialog( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kProgressTitle'  ] % title, maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kCancel'  ], 0, 100)
        self.progress.reset() # hidden by default
        self.progress.setWindowFlags( QtCore.Qt.WindowStaysOnTopHint )
        self.progress.setWindowTitle( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kProgressWindowTitle'  ] % title )
    ...
    def onDialogExport(self):
        ...
        if len(self.sourceFiles) > 0 and ( self.batchMode or len(self.objects) > 0):
            ...
            if 'XGEN_EXPORT_ARCHIVE_STANDALONE' in os.environ and \
                ...
                self.progress.setLabelText( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kStartingProcess'  ] )
    ...
    def onProgressDone(self):
        ...
        self.progress.setLabelText( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kDoneCleaningUpProcess'  ] )
        self.exportCleanup()
        
    def onProgressCancel(self):
        '''Thread Cancel callback'''
        #print "xgmArchiveExportBatchUI ProgressCanceled"
        self.progress.setLabelText( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kCancelCleaningUpProcess'  ] )
        self.exportCleanup()
    ...
    def onProgressFailed(self):
        ...
        self.progress.setLabelText( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kFailedCleaningUpProcess'  ] )
        self.exportCleanup()
        
    def onProgressUpdate(self, percent):
        '''Thread Update callback'''
        #print "xgmArchiveExportBatchUI ProgressUpdate " + str(percent) + " " + message
        self.progress.setLabelText( maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kProcessing'  ] )   
        if percent!=-1:
    ...
    def exportInit( self ):
        try:
            ...
            print(maya.stringTable[ 'y_xgenm_xmaya_xgmArchiveExportBatchUI.kErrorCallingArchiveExportInit'  ])
    ...
    def export( self ):
        ...
        try:
            ...
            print(maya.stringTable['y_xgenm_xmaya_xgmArchiveExportBatchUI.kXgmArchiveExportLoggingTo' ] + self.logFile)
