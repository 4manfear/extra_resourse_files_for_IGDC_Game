...
class RendermanRendererTabUI(RendererTabUI):
    ...
    def primParamsUI(self):
        expand = ExpandUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kPrimitiveShaderParameters'  ])
        self.layout().addWidget( expand )

        self.prim1 = CheckBoxUI("",
                                ["length_XP","width_XP","T_XP","stray_XP"],
                                maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kOptions1Ann'  ],
                                k_RenderAPIRendererObj,self.checkFixedSize, 0,
                                [maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kLength'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kWidth'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kT'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kStray'  ]],
                                 self.checkStartSpacing )
        expand.addWidget(self.prim1)
        self.prim2 = CheckBoxUI("",
                                ["id_XP","descid_XP","ri_XP","rf_XP"],
                                maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kOptions2Ann'  ],
                                k_RenderAPIRendererObj,self.checkFixedSize, 0,
                                [maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kId'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kDescid'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kRi'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kRf'  ]],
                                 self.checkStartSpacing )
        expand.addWidget(self.prim2)

    def surfParamsUI(self):
        expand = ExpandUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kSurfaceShaderParameters'  ])
        self.layout().addWidget( expand )

        self.surf1 = CheckBoxUI("",
                                ["u_XS","v_XS","faceid_XS","geomid_XS"],
                                maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kOptions3Ann'  ],
                                k_RenderAPIRendererObj,self.checkFixedSize, 0,
                                [maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kU'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kV'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kFaceid'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kGeomid'  ]],
                                 self.checkStartSpacing )
        expand.addWidget(self.surf1)
        self.surf2 = CheckBoxUI("",
                                ["P_XS","Pref_XS","Pg_XS","Prefg_XS"],
                                maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kOptions4Ann'  ],
                                k_RenderAPIRendererObj,self.checkFixedSize, 0,
                                [maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kP'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kPref'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kPg'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kPrefg'  ]],
                                 self.checkStartSpacing )
        expand.addWidget(self.surf2)
        self.surf3 = CheckBoxUI("",
                                ["N_XS","Nref_XS","Ng_XS","Nrefg_XS"],
                                maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kOptions5Ann'  ],
                                k_RenderAPIRendererObj,self.checkFixedSize, 0,
                                [maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kN'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kNref'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kNg'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kNrefg'  ]],
                                 self.checkStartSpacing )
        expand.addWidget(self.surf3)
        self.surf4 = CheckBoxUI("",
                                ["dPdu_XS","dPduref_XS",
                                 "dPdug_XS","dPdurefg_XS"],
                                maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kOptions6Ann'  ],
                                k_RenderAPIRendererObj,self.checkFixedSize, 0,
                                [maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kDPdu'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kDPduref'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kDPdug'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kDPdurefg'  ]],
                                 self.checkStartSpacing )
        expand.addWidget(self.surf4)
        self.surf5 = CheckBoxUI("",
                                ["dPdv_XS","dPdvref_XS",
                                 "dPdvg_XS","dPdvrefg_XS"],
                                maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kOptions7Ann'  ],
                                k_RenderAPIRendererObj,self.checkFixedSize, 0,
                                [maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kDPdv'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kDPdvref'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kDPdvg'  ],
                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kDPdvrefg'  ]],
                                 self.checkStartSpacing )
        expand.addWidget(self.surf5)
        self.surf6 = CheckBoxUI("",
                                ["geomName_XS"],
                                maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kOptions8Ann'  ],
                                k_RenderAPIRendererObj,0, 0,
                                [maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kGeomName'  ]],
                                 self.checkStartSpacing )
        expand.addWidget(self.surf6)

    def customParamsUI(self):
        expand = ExpandUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kCustomShaderParameters'  ])
        self.layout().addWidget( expand )
        ...
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kName'  ])
        label.setFixedWidth(DpiScale(50))
        label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        label.setIndent(DpiScale(10))
        label.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kNameParameterAnn'  ])
        self.cattrName = QLineEdit()
        self.cattrName.setFixedWidth(DpiScale(150))
        self.cattrName.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kNameCustomParamAnn'  ])
        ...
        self.cattrType.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kTypeAnn'  ])
        self.cattrAddButton = QToolButton()
        self.cattrAddButton.setText("+")
        self.cattrAddButton.setFixedSize(DpiScale(20),DpiScale(25))
        self.cattrAddButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kAddParamAnn'  ])
        ...
        self.cattrRemButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kRemoveParamAnn'  ])
        ...
        for param in params:
            ...
            if not param.startswith("custom__"):
                ...
                item = ExpressionUI(param,
                                    maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kShaderAttrAnn'  ] % param,
    ...
    def rendererUI(self):
        ...
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kRenderer'  ])
        label.setFixedWidth(labelWidth())
        label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        label.setIndent(DpiScale(10))
        label.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kRendererAnn'  ])
        hbox.addWidget(label)
        self.renderer = _ComboBoxUI()
        self.renderer.addItem(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kNone'  ])
        self.renderer.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kRendererAnn2'  ])
        ...
        self.primBound = FloatUI("primitiveBound",
                  maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kPrimitiveBoundAnn'  ],
                  k_RenderAPIRendererObj,0.0,1000000,0.0,10,maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kPrimitiveBound'  ])
        self.layout().addWidget(self.primBound)
        if ( xgg.Maya ):
            self.pbButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kAutoSet'  ])
            self.pbButton.setFixedWidth(DpiScale(80))
            self.pbButton.setAutoRepeat(False)
            self.pbButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kCalculateAnn'  ])
            self.connect(self.pbButton, QtCore.SIGNAL("clicked()"),
                         self.autoSetValues)
            hbox = self.primBound.layout()
            hbox.addWidget(self.pbButton)
            self.inCamBox = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kInCameraOnly'  ],"inCameraOnly",
            						   maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kGenerateOnVisiblePatchesOnly'  ],
            		                   k_RenderAPIRendererObj)
            ...
            self.margin = FloatUI("inCameraMargin",
            					  maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kFrustumAngleAnn'  ],
            					  k_RenderAPIRendererObj,0.0,90.0,-1000,1000,maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kInCameraMargin'  ])
    ...
    def autoSetValues(self):
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_tabs_xgRendermanRendererTab.kComputingPrimitiveBound'  ])
