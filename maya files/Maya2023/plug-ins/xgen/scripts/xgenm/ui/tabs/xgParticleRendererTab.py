...
class ParticleRendererTabUI(RendererTabUI):
    def __init__(self):
        ...
        self.maskExpr = ExpressionUI("mask",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgParticleRendererTab.kMaskAnn'  ],
             "ParticleRenderer",maya.stringTable[ 'y_xgenm_ui_tabs_xgParticleRendererTab.kMask'  ])
        self.layout().addWidget(self.maskExpr)
        self.particleFile = BrowseUI("particleFile",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgParticleRendererTab.kParticleFileAnn'  ],
             "ParticleRenderer","*.pda *.pdb *.bgeo","out",maya.stringTable[ 'y_xgenm_ui_tabs_xgParticleRendererTab.kParticleFile'  ])
        ...
        if ( xgg.Maya ):
            ...
            self.goButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgParticleRendererTab.kCreateParticleFile'  ])
            self.goButton.setFixedWidth(DpiScale(145))
            self.goButton.setAutoRepeat(False)
            self.goButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgParticleRendererTab.kCreateParticleFileAnn'  ])
    ...
    def renderParticle(self):
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_tabs_xgParticleRendererTab.kRenderingProgressInfo'  ])
