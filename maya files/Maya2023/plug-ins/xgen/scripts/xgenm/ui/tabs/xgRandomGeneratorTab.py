...
class RandomGeneratorTabUI(GeneratorTabUI):
    def __init__(self):
        GeneratorTabUI.__init__(self,'Random',maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kRandom'  ])
        # Widgets
        self.baseTopUI()
        self.density = FloatUI("density",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kDensityAnn'  ],
             "RandomGenerator",0.000001,1000000.0, 0.01, 100, maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kDensity'  ] )
        self.layout().addWidget(self.density)
        self.maskExpr = ExpressionUI("mask",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kMaskAnn'  ],
             "RandomGenerator", maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kMask'  ])
        self.layout().addWidget(self.maskExpr)

        self.extraPointsBox = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kMorePrimitivesAt'  ],"usePoints",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kMorePrimitivesAtAnn'  ],
             "RandomGenerator")
        ...
        if ( xgg.Maya ):
            ...
            self.editButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kSpecifyPoints'  ])
            #self.editButton.setFixedWidth(DpiScale(80))
            self.editButton.setAutoRepeat(False)
            self.editButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kSpecifyPointsAnn'  ])
        ...
        self.scBox = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kCompensateForShapeStretching'  ],"scFlag",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kCompensateAnn'  ],
             "RandomGenerator")
        self.layout().addWidget(self.scBox)
        
        self.dcBox = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kCompensateForUnevenParameterization'  ],"dcFlag",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kCompensateUnevenAnn'  ],
             "RandomGenerator")
        ...
        self.genButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kGenerate'  ])
        self.genButton.setAutoRepeat(False)
        self.genButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kGenerateAnn'  ])
    ...
    def generateDC(self):
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kCalculatingDensityCompensationMaps'  ])
...
class EditExtraPointsUI(PointsBaseUI):
    ...
    """
    def __init__(self):
        PointsBaseUI.__init__(self,maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kSpecifyPointsTool'  ])
        
        self.toolDescription=QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kToolDescription'  ])
        ...
        self.pointDirUI(self.layout(),
                        "pointDir",
                        maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kPointDirAnn'  ],
                        "RandomGenerator",
                        maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kPointFileFolder'  ])
        ...
        ptLoadButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kLoad'  ])
        ptLoadButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kRevertToLastSavedAnn'  ])
        ptLoadButton.setAutoDefault(False)
        ptLoadButton.setDefault(False)
        ptButtonLayout.addWidget(ptLoadButton)
        ptClrButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kClear'  ])
        ptClrButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kClearAnn'  ])
        ptClrButton.setAutoDefault(False)
        ptClrButton.setDefault(False)
        ptButtonLayout.addWidget(ptClrButton)
        ptSaveButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kSave'  ])
        ptSaveButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kSaveNCloseAnn'  ])
        ptSaveButton.setAutoDefault(False)
        ptSaveButton.setDefault(False)
        ptButtonLayout.addWidget(ptSaveButton)
        ptCancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kCancel'  ])
        ptCancelButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgRandomGeneratorTab.kCloseAnn'  ])
