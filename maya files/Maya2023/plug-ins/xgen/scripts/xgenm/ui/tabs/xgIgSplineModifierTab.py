...
class IgSplineModifierTabUI(QWidget):
    ...
    def __init__(self, parent):
        ...
        modifiersFrameUI = ExpandUI(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kModifiers'], True)
        ...
        modifierAttrFrameUI = ExpandUI(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kModifierAttributes'], True)
...
class IgSplineModifiersUI(QWidget):
    ...
    def __createToolbar(self):
        ...
        buttonDescs = [
            (r'moveLayerUp',
             r':/moveLayerUp.png',
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kMoveSelectedModifierUp'],
                lambda: self.__moveModifier(1)),
            (r'moveLayerDown',
             r':/moveLayerDown.png',
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kMoveSelectedModifierDown'],
                lambda: self.__moveModifier(-1)),
            (r'newLayerEmpty',
             r':/newLayerEmpty.png',
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kAddNewModifier'],
                lambda: self.__addModifier()),
            (r'smallTrash',
             r':/smallTrash.png',
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kDeleteSelectedModifier'],
                lambda: self.__deleteModifier()),
            (r'refresh',
             r':/refresh.png',
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kRefreshModifiers'],
                lambda: self.refresh()),
            (r'xgMenu',
             r'xgMenu.png',
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kOpenModifierMenu'],
...
QHeaderView::section:horizontal::last
{
    border-right-style: solid;
        ...
        header.setText(self.TREE_COLUMN_NAME, maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kName'])
    ...
    def __refreshTreeUI(self):
        ...
        if not dagPath.isValid():
            xglog.XGDebug(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kNoActiveDescription'])
            return
        ...
        if plug.isNull():
            xglog.XGDebug(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kNoModifiersFound'])
            return
    ...
    def __deleteModifier(self):
        ...
        if not cmds.objExists(modifier):
            cmds.warning(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kModifierToDeleteNotExist'] % modifier)
            return
        ...
        if isReferenced:
            ...
            cmds.warning(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kCantDeleteReferencedNode'] % modifier)
    ...
    def __duplicateModifier(self):
        ...
        # The dg node is already deleted ?
        if not cmds.objExists(modifier):
            cmds.warning(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kModifierToDuplicateNotExist'] % modifier)
            return
    ...
    def __showContextMenu(self, pos):
        ...
        ctxMenu.addAction(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kContextMenuNewModifier'],
            self.__addModifier)
        ctxMenu.addAction(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kContextMenuDeleteSelected'],
            self.__deleteModifier)
        ctxMenu.addAction(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kContextMenuDuplicateSelected'],
    ...
    def __createIgToolUI(self):
        ...
        buttonDescs = [
            ...
            (   r'Clump',
                ...
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kClumpBrush'],
                lambda: self.setBrush(r'XgmSetClumpBrushTool'),
                lambda: self.setBrush(r'XgmSetClumpBrushToolOption')),
            # Part
            (   r'Part',
                r'iGroom_part.png',
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kPartBrush'],
            ...
            (   r'Freeze',
                r'iGroom_mask.png',
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kFreezeBrush'],
            ...
            (   r'Select',
                ...
                maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kSelectBrush'],
        ...
        self.igToolUI = ExpandUI(maya.stringTable['y_xgenm_ui_tabs_xgIgSplineModifierTab.kInteractiveGroomTools'], True)
