...
class BrushTabUI(QWidget):
    ...
    def __init__(self, parent):
        ...
        # empty container 
        emptyContainer = QLabel(maya.stringTable['y_xgenm_ui_tabs_xgBrushTab.kGroomingNotAvailable' ])
    ...
    def buildUI( self ):
        ...
        topWidget = ExpandUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kBrush'  ] )
    ...
    def brushUI( self, theLayout ):
        def button(brush):
            ...
            b.setToolTip( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kBrushAnn'  ] % text )
            b.setAutoRaise(True)
            b.setCheckable(True)
        ...
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kNoBrushSelected'  ])
        blankBrushLayout.addWidget( label )
        self.brushUIWidget.addWidget( blankBrushWidget )

    def settingsUI( self, theLayout ):
        settingWidget = ExpandUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kSettings'  ] )

        vis = bool(xg.igGetDescriptionVisibility())
        _addWidgetAndShow(settingWidget, _createWidget(  cmds.checkBoxGrp, "IG_VISIBILITY", l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kVisibility'  ]+self.spacing, cw=self.columnWidth, ncb=1, l1='', v1=vis,
                                                             ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kVisibilityAnn'  ],
        ...
        _addWidgetAndShow(densityLayout, _createWidget( cmds.floatSliderGrp, 'IG_DENSITY', l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kDensity'  ]+self.spacing, pre=4, f=True, 
                                                            min=0.001, max=500.0, fmx=25000.0, step=0.02, v=1.0, cw=self.columnWidth, 
                                                            ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kDensityAnn'  ],
                                                            cc='xgen.ui.tabs.xgBrushTab._onDensityChangeCB()' ))

        vis = True
        _addWidgetAndShow(densityLayout, _createWidget(  cmds.checkBoxGrp, "IG_SYNC_DENSITY", l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kSyncGen'  ]+self.spacing, cw=self.sideWidth, ncb=1, l1='', 
                                                             v1=vis,
                                                             ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kSyncGenAnn'  ] ))
        settingWidget.addWidget(densityWidget)

        _addWidgetAndShow(settingWidget, _createWidget( cmds.radioButtonGrp, 'IG_METHOD', l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kSampling'  ]+self.spacing, nrb=3, cw=self.columnWidth, sl=0,
                                                            ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kMethodAnn'  ],
                                                            la3=[maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kLinear'  ],maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kNearest'  ],maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kInterp'  ]],
        ...
        _addWidgetAndShow(maskLayout, _createWidget( cmds.textFieldGrp, 'IG_MASK', l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kMask'  ]+self.spacing, cw=self.columnWidth, 
                                                         ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kMaskAnn'  ] ))

        _addWidgetAndShow(maskLayout, _createWidget2( cmds.iconTextButton, style="iconOnly", width=22, height=22,
                                                          ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kRefreshAnn'  ],
        ...
        cmd = 'xgen.ui.tabs.xgBrushTab._igFileBrowserCB( "'+maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kXuvFolder'  ]+'", "IG_XUVDIR", 0 )'
        _addWidgetAndShow(xuvLayout, _createWidget( cmds.textFieldButtonGrp, 'IG_XUVDIR', l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kXuv'  ]+self.spacing, cw=self.columnWidth,
                                                        bl=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kBrowse'  ], bc=cmd, cal=[1,'right'], 
                                                        ann=( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kBrowseAnn'  ]) ))

        _addWidgetAndShow(xuvLayout, _createWidget2( cmds.iconTextButton, style="iconOnly", width=22, height=22,
                                                         ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kRefreshTheXuvPointsFromDisk'  ],
                                                         c='xgen.ui.tabs.xgBrushTab._igRefreshXUVCB("IG_XUVDIR")',
                                                         image=xg.iconDir()+"igRefresh.png" ))
        settingWidget.addWidget(xuvWidget)

        _addWidgetAndShow(settingWidget,_createWidget( cmds.attrColorSliderGrp, 'IG_TIPCOLOR', l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kTipColor'  ]+self.spacing, cw=self.columnWidth, sb=False,
                                                           ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kTipColorAnn'  ] ))

        _addWidgetAndShow(settingWidget, _createWidget( cmds.attrColorSliderGrp, 'IG_BASECOLOR', l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kBaseColor'  ]+self.spacing, cw=self.columnWidth, sb=False,
                                                            ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kBaseColorAnn'  ] ))

        _addWidgetAndShow(settingWidget, _createWidget( cmds.radioButtonGrp, 'IG_DISPLAYTYPE', l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kDisplay'  ]+self.spacing, nrb=2, cw=self.columnWidth,
                                                            ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kDisplayAnn'  ],
                                                            la2=[maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kLines'  ],
                                                                 maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kCards'  ]],
                                                            data1=0, data2=1,
                                                            onc='xgen.ui.tabs.xgBrushTab._onDisplayTypeCB()'))

        _addWidgetAndShow(settingWidget, _createWidget( cmds.floatSliderGrp, 'IG_LENGTH', l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kLength'  ]+self.spacing, pre=4, f=True, 
                                                            min=0.001, max=3.0, fmx=5000.0, step=0.02, v=0.5, cw=self.columnWidth, 
                                                            ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kLengthAnn'  ],
                                                            cc='xgen.ui.tabs.xgBrushTab._onSetLengthCB()' ))
        
        _addWidgetAndShow(settingWidget, _createWidget( cmds.floatSliderGrp, 'IG_WIDTH', l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kWidth'  ]+self.spacing, pre=4, f=True, 
                                                            min=0.001, max=3.0, fmx=1000.0, step=0.02, v=0.1, cw=self.columnWidth, 
                                                            ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kWidthAnn'  ],
                                                            cc='xgen.ui.tabs.xgBrushTab._onSetWidthCB()' ))
        
        # auto map export defaults        
        tpu = xg.igDescriptionTpu( xg.igCurrentDescription( ) )
        _addWidgetAndShow(settingWidget, _createWidget( cmds.floatSliderGrp, "IG_AUTOEXPORT_TPU", l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kTexelsPerUnit'  ]+self.spacing, f=True, cw=self.columnWidth,
                                                            min=0.001, max=100.0, fmx=10000.0, pre=3, step=0.001, v=tpu,
                                                            ann=( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kTexelsPerUnitAnn'  ]),
                                                            cc='xgen.ui.tabs.xgBrushTab._updateAutoExportTpuCB()' ))

        axDir = xg.getOptionVarString( 'igAutoExportFolder', '${DESC}/groom'  )
        bccb = 'xgen.ui.tabs.xgBrushTab._igFileBrowserCB( "'+maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kAutoExportDirectory'  ]+'", "IG_AUTOEXPORT_DIR", 1 )'
        cccb = 'xgen.ui.tabs.xgBrushTab._autoExportCB( )'
        _addWidgetAndShow(settingWidget, _createWidget( cmds.textFieldButtonGrp, "IG_AUTOEXPORT_DIR", l=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kExportFolder'  ]+self.spacing, cw=self.columnWidth,
                                                            bl=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kBrowse2'  ], bc=bccb, cc=cccb, cal=[1,'right'], text=axDir,
                                                            ann=maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kExportAnn'  ] ))
    ...
    def editUI( self, theLayout ):
        ...
        editWidget = ExpandUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kEdit'  ] )
        ...
        w = button( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kFlipToRight'  ], maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kFlipLeftToRight'  ], ('mel','igFlip 1'), 'iGroom_flipR.png' )
        hLayout.addWidget( w )
        w = button( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kFlipToLeft'  ], maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kFlipRightToLeft'  ], ('mel','igFlip 0'), 'iGroom_flipL.png' )
        hLayout.addWidget( w )
        w = button( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kAutoTwist'  ], maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kAutoTwist2'  ], ('mel','igAutoTwist'), 'iGroom_autoTwist.png' )
        hLayout.addWidget( w )
        w = button( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kReset'  ], maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kResetPrimitives'  ], ('py','_igResetPrims()'), 'iGroom_reset.png' )
        hLayout.addWidget( w )
        w = button( maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kClear'  ], maya.stringTable[ 'y_xgenm_ui_tabs_xgBrushTab.kClearCurrentMask'  ], ('mel','string $igDesc = igCurrentDescription();iGroom -cm -d $igDesc ;'), 'iGroom_unmask.png' )
        hLayout.addWidget( w )
