...
class LodTabUI(QWidget):
    def __init__(self):
        ...
        self.lodFlag = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kLodFlag'  ],"lodFlag",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kLodFlagAnn'  ],
             "Description")
        ...
        self.label0 = QLabel(makeLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kAverageWidth'  ]))
        ...
        self.label0.setToolTip(
            maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kAverageWidthAnn'  ])
        ...
        self.averageWidth.setToolTip(
            maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kAverageWidthAnn2'  ])
        self.connectIt("averageWidth",self.averageWidth)
        row.setLayout(layout)
        self.layout().addWidget(row)

        pixelFadeSizeAnn = maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kPixelFadeSizeAnn'  ]
        self.label1 = QLabel(makeLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kBeginSize'  ]))
        ...
        pixelCullSizeAnn = maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kPixelCullSizeAnn'  ]
        self.label2 = QLabel(makeLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kEndSize'  ]))
        ...
        minDensityAnn = maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kMinDensityAnn'  ]
        self.label3 = QLabel(makeLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kDensityScale'  ]))
        ...
        maxWidthRatioAnn = maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kMaxWidthRatioAnn'  ]
        self.label4 = QLabel(makeLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgLodTab.kWidthScale'  ]))
