...
class GeneratorTabUI(QWidget):
    def __init__(self,selfType,printableName = ""):
        ...
        self.topExpandUI = ExpandUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kGeneratingPrimitives' ] )
    ...
    def baseBottomUI(self):
        ...
        displacementText = maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kDisplacement'  ]
        expand = ExpandUI(displacementText)
        self.actualLayout().addWidget(expand)
        
        self.displacementExpr = ExpressionUI("displacement",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kDisplacementAnn'  ],
             self.type+"Generator",displacementText)
        expand.addWidget(self.displacementExpr)
        self.vecDispBox = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kUseVectorDisplacementForMaps'  ],"vectorDisplacement",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kVectorDisplacementAnn'  ],
             self.type+"Generator")
        expand.addWidget(self.vecDispBox)
        self.bumpExpr = ExpressionUI("bump",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kBumpAnn'  ],
             self.type+"Generator",maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kBump'  ])
        expand.addWidget(self.bumpExpr)
        self.offsetExpr = ExpressionUI("offset",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kOffsetAnn'  ],
             self.type+"Generator",maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kOffset'  ])
        expand.addWidget(self.offsetExpr)

        # culling options
        self.cullOptions = ExpandUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kCulling'  ])
        self.actualLayout().addWidget(self.cullOptions)

        self.cullFlag = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kEnableCulling'  ], "cullFlag",
                                   maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kEnableCullingAnn'  ],
                                   self.type+"Generator")
        ...
        self.dispCull = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kDisplayCulledPrimitives'  ],"culled",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kDisplayCulledPrimAnn'  ],"GLRenderer")
        ...
        self.backface = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kCullPrimitivesOnBackFaces'  ], "cullBackface",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kCullBackFacesAnn'  ],
             self.type+"Generator")
        ...
        self.backfaceAngle.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kBackfaceCullAnn'  ])
        self.connect(self.backfaceAngle,QtCore.SIGNAL("editingFinished()"),
                     lambda: self.setAttr("cullAngleBF",self.backfaceAngle))
        
        paddingAngleText = maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kPaddingAngle'  ]
        widget = createSubControlHolder(paddingAngleText, self.backfaceAngle)
        widget.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kPaddingAngleAnn'  ])        
        self.cullOptions.addWidget(widget)

        self.frustum = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kCullPrimitivesOutsideTheView'  ],"cullFrustrum",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kCullOutsideViewAnn'  ],
             self.type+"Generator")
        ...
        self.frustumAngle.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kFrustumCulling'  ])
        ...
        widget.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kPaddingAngleAnn2'  ])        
        self.cullOptions.addWidget(widget)

        self.cullExpr = ExpressionUI("cullExpr",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kCullExprAnn'  ],
             self.type+"Generator",maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kCullExpr'  ])
        ...
        if ( xgg.Maya ):
            ...
            cullButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kCullSelectedPrimitives'  ])
            cullButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kCullSelectedPrimitivesAnn'  ])        
            buttonLayout.addWidget(cullButton)
            self.connect(cullButton, QtCore.SIGNAL("clicked()"),
                         self.cullSlot)
            uncullButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kUncull'  ])
            uncullButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kUncullAnn'  ])                    
            buttonLayout.addWidget(uncullButton)
            self.connect(uncullButton, QtCore.SIGNAL("clicked()"),
                         self.uncullSlot)
            promoteStr = xg.promoteFunc()
            if promoteStr:
                promoteButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kPromote'  ])
    ...
    def typeUI(self):
        ...
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kGeneratePrimitives'  ])
        label.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kGeneratePrimitivesAnn'  ])
        ...
        longnames = [maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kRandomlyAcrossTheSurface'  ],
                     maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kInUniformRowsAndColumns'  ],
                     maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kAtSpecifiedLocations'  ],
                     maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kAtGuideLocations' ],
                     maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kFromXPDFile'  ]]
        ...
        self.generatorSeed = IntegerUI("descriptionId",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kGenerateSeedAnn'  ],
             "Description",0,1e7,maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kGeneratorSeed'  ])
        self.layout().addWidget(self.generatorSeed)

        self.generatorFlip = CheckBoxUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kGenerateOnBackFaces'  ], "flipNormals", maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kGenerateOnBackFacesAnn'  ], "Description" )
    ...
    def setActiveByTypeName(self,typename):
        ...
        for i in range(count):
            if self.active.itemData(i) == typename:
                ...
                break
        if not found:
            raise ValueError(maya.stringTable['y_xgenm_ui_tabs_xgGeneratorTab.kGeneratorTabUnknownType' ] % typename)
    ...
    def promoteSlot(self):
        ...
        if promoteModule:
            try:
                ...
                try:
                    ...
                    xglog.XGError(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kPromoteModuleDoesNotExist'  ] % promoteModule)
        ...
        try:
            ...
            xglog.XGError(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kPromoteFunctionDoesNotExist'  ] % promoteFunction)
...
class GeneratorTabBlankUI(GeneratorTabUI):
    ...
    def __init__(self, typename, printablename = None):
        ...
        if printablename:
            ...
            labeltext = typename
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeneratorTab.kNoExtraAttributesForGenerator'  ]
                             % labeltext)
