...
class GeometryRendererTabUI(RendererTabUI):
    def __init__(self):
        ...
        self.convertSelected = CheckBoxUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kConvertSelected'  ], "",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kConvertSelectedAnn'  ],
             "")
        ...
        self.combineMesh = CheckBoxUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kCombineMesh'  ],"combineMesh",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kCombineMeshAnn'  ],
             "GeometryRenderer")
        ...
        self.useWidthRamp = CheckBoxUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kUseWidthRamp'  ],"useWidthRamp",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kUseWidthRampAnn'  ],
             "GeometryRenderer")
        self.layout().addWidget(self.useWidthRamp)

        self.insertWidthSpan = CheckBoxUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kInsertWidthSpan'  ], "insertWidthSpan",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kInsertWidthSpanAnn'  ],
             "GeometryRenderer")
        ...
        self.widthSpanNum = IntegerUI("widthSpanNum",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kSpanNumAnn'  ],
             "GeometryRenderer",0,10,maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kSpanNum'  ])
        self.layout().addWidget(self.widthSpanNum)

        self.curvature = FloatUI("curvature",
             maya.stringTable['y_xgenm_ui_tabs_xgGeometryRendererTab.kCurvatureAnno' ],
             "GeometryRenderer",-1.0,1.0,-1.0,1.0,maya.stringTable['y_xgenm_ui_tabs_xgGeometryRendererTab.kCurvature' ])
        self.layout().addWidget(self.curvature)

        self.uvInTiles = CheckBoxUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kUVInTiles'  ], "uvInTiles",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kUVInTilesAnn'  ],
             "GeometryRenderer")
        self.layout().addWidget(self.uvInTiles)
        self.connect(self.uvInTiles.boxValue[0], QtCore.SIGNAL("clicked()"), self.__onClickPlaceUV)

        self.uvLayoutType = EnumUI("uvLayoutType", [ maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.k2x2'  ], maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.k3x3'  ], maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.k4x4'  ] ],
            maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kUVLayoutTypeAnn'  ],
            "GeometryRenderer",
            maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kUVLayoutType' ])
        self.layout().addWidget(self.uvLayoutType)

        self.uvTileSeparation = FloatUI("uvTileSeparation",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kTileSeparationAnn'  ],
             "GeometryRenderer",0.0,1.0,0.0,1.0,maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kTileSeparation'  ])
        ...
        self.createStripJoints = CheckBoxUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kCreateStripJoints'  ],"createStripJoints",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kCreateStripJointsAnn'  ],
             "GeometryRenderer")
        ...
        jointPlacementStr = maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kJointPlacement'  ]
        jointPerSpanStr = maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kJointPerSpan'  ]
        jointPerCVStr = maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kJointPerCV'  ]
        specifyJointNumStr = maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kSpecifyJointNum'  ]
        self.stripJointPlacementType = RadioUI("stripJointPlacementType",
             [jointPerSpanStr, specifyJointNumStr],
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kStripJointPlacementAnn'  ],
             "GeometryRenderer",
             jointPlacementStr)
        ...
        self.jointNumOnStrip = IntegerUI("jointNumOnStrip",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kStripJointNumAnn'  ],
             "GeometryRenderer",3,100,maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kStripJointNum'  ])
        self.layout().addWidget(self.jointNumOnStrip)

        self.autoBindSkin = CheckBoxUI( maya.stringTable['y_xgenm_ui_tabs_xgGeometryRendererTab.kAutoBindSkin' ],"",
             maya.stringTable['y_xgenm_ui_tabs_xgGeometryRendererTab.kAutoBindSkinAnn' ],
             "")
        ...
        self.maxInfluences = IntegerUI("",
             maya.stringTable['y_xgenm_ui_tabs_xgGeometryRendererTab.kMaxInfluencesAnn' ],
             "",0,10,maya.stringTable['y_xgenm_ui_tabs_xgGeometryRendererTab.kMaxInfluences' ])
        ...
        self.createGuideJoints = CheckBoxUI( maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kCreateGuideJoints'  ],"createGuideJoints",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kCreateGuideJointsAnn'  ],
             "GeometryRenderer")
        ...
        self.guideJointPlacementType = RadioUI("guideJointPlacementType",
             ...
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kGuideJointPlacementAnn'  ],
             "GeometryRenderer",
             jointPlacementStr)
        ...
        self.jointNumOnGuide = IntegerUI("jointNumOnGuide",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kGuideJointNumAnn'  ],
             "GeometryRenderer",3,100,maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kGuideJointNum'  ])
        ...
        if ( xgg.Maya ):
            ...
            self.p3dButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kCreateGeo'  ])
            self.p3dButton.setFixedWidth(DpiScale(160))
            self.p3dButton.setAutoRepeat(False)
            self.p3dButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kCreateGeoAnn'  ])
    ...
    def geomRender(self):
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kGeoProgressInfo'  ])
        cmd = 'xgmGeoRender -pb '
        cmd += ' -convertSelected '
    ...
    def rangeExport(self):
        print(maya.stringTable[ 'y_xgenm_ui_tabs_xgGeometryRendererTab.kFrameRangeRenderNotYetSupported'  ])
        pass
