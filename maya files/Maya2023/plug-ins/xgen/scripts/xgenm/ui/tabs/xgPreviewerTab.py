...
class PreviewerTabUI(QWidget):
    ...
    def baseTopUI(self):
        self.startPercent = FloatUI("startPercent",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgPreviewerTab.kStartPercentAnn' ],
             self.type+"Renderer", 0.0, 100.0,-1000,1000,maya.stringTable[ 'y_xgenm_ui_tabs_xgPreviewerTab.kStartPercent'  ])
        self.layout().addWidget( self.startPercent )

        self.percent = FloatUI("percent",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgPreviewerTab.kPercentAnn'  ],
             self.type+"Renderer", 0.0, 100.0,-1000,1000,maya.stringTable[ 'y_xgenm_ui_tabs_xgPreviewerTab.kPercent'  ])
