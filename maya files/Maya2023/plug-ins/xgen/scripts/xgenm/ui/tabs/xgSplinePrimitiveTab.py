...
class SplinePrimitiveTabUI(PrimitiveTabUI):
    def __init__(self):
        PrimitiveTabUI.__init__(self,'Spline',maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kSpline'  ])
        # Widgets
        self.baseTopUI()
        # Dont pass the object for attCVCount to avoid the auto-connect
        self.attrCount = IntegerUI("Attr CV Count",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kAttrCVCountAnn'  ],
             "",3,99,maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kAttrCvCount'  ])
        ...
        self.fxCount = IntegerUI("fxCVCount",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kFxCountAnn'  ],
             "SplinePrimitive",3,1e7,maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kFxCvCount'  ])
        self.layout().addWidget(self.fxCount)
        self.uniformCV = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kUniformCvs'  ], "uniformCVs",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kUniformCvsAnn'  ],
             "SplinePrimitive")
        self.layout().addWidget(self.uniformCV)
        self.lengthExpr = ExpressionUI("length",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kLengthAnn'  ]
            ,"SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kLength'  ])
        self.layout().addWidget(self.lengthExpr)
        self.widthExpr = ExpressionUI("width",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kWidthAnn'  ],
             "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kWidth'  ])
        self.layout().addWidget(self.widthExpr)
        self.widthRamp = RampUI("widthRamp",
            maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kWidthRampAnn'  ],
            "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kWidthRamp'  ])
        self.layout().addWidget(self.widthRamp)
        self.taperExpr = ExpressionUI("taper",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTaperANn'  ],
             "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTaper'  ])
        self.layout().addWidget(self.taperExpr)
        self.taperStartExpr = ExpressionUI("taperStart",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTaperStartAnn'  ],
             "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTaperStart'  ])
        self.layout().addWidget(self.taperStartExpr)
        self.offUExpr = ExpressionUI("offU",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTiltUAnn'  ],
             "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTiltU'  ])
        self.layout().addWidget(self.offUExpr)
        self.offVExpr = ExpressionUI("offV",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTiltVAnn'  ],
             "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTiltV'  ])
        self.layout().addWidget(self.offVExpr)
        self.offNExpr = ExpressionUI("offN",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTiltNAnn'  ],
             "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTiltN'  ])
        self.layout().addWidget(self.offNExpr)
        self.aboutNExpr = ExpressionUI("aboutN",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kAroundNAnn' ],
             "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kAroundN'  ])
        self.layout().addWidget(self.aboutNExpr)
        self.bendParam = []
        self.bendU = []
        self.bendV = []
        self.addJoints()
        self.optionsBox = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kOptions'  ],["displayWidth","faceCamera","tubeShade"],
             maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kOptionsAnn'  ],
             "SplinePrimitive",0,0,
             [maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kDisplayWidth'  ],
              maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kFaceCamera'  ],
              maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTubeShade'  ]])
        self.optionsBox.boxValue[0].setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kDisplayWidthAnn'  ])
        self.optionsBox.boxValue[1].setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kFaceCameraAnn'  ])
        self.optionsBox.boxValue[2].setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTubeShadeAnn'  ])
    ...
    def addTools(self):
        ...
        self.glabel = QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kGuideTools'  ])
        ...
        self.rebuildButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kRebuild'  ])
        self.rebuildButton.setAutoRepeat(False)
        self.rebuildButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kRebuildAnn'  ])
        self.connect(self.rebuildButton, QtCore.SIGNAL("clicked()"),
                     self.rebuildGuides)
        hbox.addWidget(self.rebuildButton)
        
        self.normalizeButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kNormalize'  ])
        self.normalizeButton.setAutoRepeat(False)
        self.normalizeButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kNormalizeAnn'  ])
        ...
        self.setLengthButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kSetLength'  ])
        self.setLengthButton.setAutoRepeat(False)
        self.setLengthButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kSetLengthAnn'  ])
        self.connect(self.setLengthButton, QtCore.SIGNAL("clicked()"),
                     self.setLengthGuides)
        hbox.addWidget(self.setLengthButton)
        
        self.tubeButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTubeGroom'  ])
        self.tubeButton.setAutoRepeat(False)
        self.tubeButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kTubeGroomAnn'  ])
    ...
    def refreshJoints(self):
        ...
        for i in range(len(self.bendParam),int(value)-2):
            self.bendParamUI = ExpressionUI("bendParam["+str(i)+"]",
                                            maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kBendParamAnn'  ],
                                            "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kBendParam'  ] % str(i))
    
            self.bendParam.append(self.bendParamUI)
            self.joints.layout().addWidget(self.bendParam[i])
            self.bendUUI = ExpressionUI("bendU["+str(i)+"]",
                                        maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kBendUAnn'  ],
                                        "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kBendU'  ] % str(i))
            
            self.bendU.append(self.bendUUI)
            self.joints.layout().addWidget(self.bendU[i])
            self.bendVUI = ExpressionUI("bendV["+str(i)+"]",
                                        maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kBendVAnn'  ],
                                        "SplinePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kBendV'  ] % str(i))
    ...
    def rebuildGuides(self):
        (res,ok) = QInputDialog.getInt(self,maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kRebuildGuides'  ],
                    maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kCvCount'  ],5,3)
        if ok:
    ...
    def setLengthGuides(self):
        (res,ok) = QInputDialog.getDouble(self,maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kSetGuideLength'  ],
                    maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kSetGuideLengthAnn'  ],
                    1.0,0.01,5000,2)
        if ok:
    ...
    def setMethod(self,method):
        ...
        if method == 0:
            self.lengthExpr.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kLengthOfTheSplinePrimitive'  ])
            ...
            self.lengthExpr.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgSplinePrimitiveTab.kLengthExprAnn'  ])
