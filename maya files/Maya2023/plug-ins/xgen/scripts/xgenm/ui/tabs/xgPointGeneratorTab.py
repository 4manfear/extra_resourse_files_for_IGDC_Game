...
class PointGeneratorTabUI(GeneratorTabUI):
    def __init__(self):
        GeneratorTabUI.__init__(self,'Point',maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kPoint'  ])
        # Widgets
        self.baseTopUI()
        if ( xgg.Maya ):
            row = QWidget()
            ...
            label = QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kPrimitiveLocations'  ])
            label.setFixedWidth(labelWidth())
            label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
            label.setIndent(DpiScale(10))
            hbox.addWidget(label)
            self.editButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kEdit'  ])
            self.editButton.setAutoRepeat(False)
            self.editButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kEditAnn'  ])
            ...
            self.pointDir = BrowseUI("pointDir",
                                     maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kPointDirAnn'  ],
                                     "PointGenerator","","in",maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kPointFileFolder'  ])
...
class EditPointsUI(PointsBaseUI):
    ...
    """
    def __init__(self):
        PointsBaseUI.__init__(self,maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kEditExtraPoints'  ])


        self.toolDescription=QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kToolDescription'  ])
        self.layout().addWidget(self.toolDescription)
        self.layout().addSpacing(DpiScale(5))

        self.pointDirUI(self.layout(),
                        "pointDir",
                        maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kPointDirAnn2'  ],
                        "PointGenerator",
                        maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kPrimitiveLocations2'  ])
        ...
        ptLoadButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kLoad'  ])
        ptLoadButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kRevertToLastSavedAnn'  ])
        ptLoadButton.setAutoDefault(False)
        ptLoadButton.setDefault(False)
        ptButtonLayout.addWidget(ptLoadButton)
        ptClrButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kClear'  ])
        ptClrButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kClearAnn'  ])
        ptClrButton.setAutoDefault(False)
        ptClrButton.setDefault(False)
        ptButtonLayout.addWidget(ptClrButton)
        ptSaveButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kSave'  ])
        ptSaveButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kSaveNCloseAnn'  ])
        ptSaveButton.setAutoDefault(False)
        ptSaveButton.setDefault(False)
        ptButtonLayout.addWidget(ptSaveButton)
        ptCancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kCancel'  ])
        ptCancelButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgPointGeneratorTab.kCloseAnn'  ])
