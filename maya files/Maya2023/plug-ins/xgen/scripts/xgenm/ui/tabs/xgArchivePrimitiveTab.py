...
class ArchivePrimitiveTabUI(PrimitiveTabUI):
    def __init__(self):
        # Widgets
        PrimitiveTabUI.__init__(self,'Archive',maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kArchive'  ])
        self.baseTopUI(True)
        
        self.lengthExpr = ExpressionUI("length","",
            "ArchivePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kLength'  ])
        self.attrGroup.addWidget(self.lengthExpr)
        self.widthExpr = ExpressionUI("width","","ArchivePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kWidth'  ])
        self.attrGroup.addWidget(self.widthExpr)
        self.depthExpr = ExpressionUI("depth","","ArchivePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kDepth'  ])
        self.attrGroup.addWidget(self.depthExpr)
        self.offUExpr = ExpressionUI("offU",
            maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kTiltUAnn'  ],
            "ArchivePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kTiltU'  ])
        self.attrGroup.addWidget(self.offUExpr)
        self.offVExpr = ExpressionUI("offV",
            maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kTiltVAnn'  ],
            "ArchivePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kTiltV'  ])
        self.attrGroup.addWidget(self.offVExpr)
        self.twistExpr = ExpressionUI("twist",
            maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kTwistAnn'  ],
            "ArchivePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kTwist'  ])
        self.attrGroup.addWidget(self.twistExpr)
        self.offNExpr = ExpressionUI("offN",
            maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kTiltNAnn'  ],
            "ArchivePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kTiltN'  ])
        self.attrGroup.addWidget(self.offNExpr)
        self.aboutNExpr = ExpressionUI("aboutN",
            maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kAroundNAnn' ],
            "ArchivePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kAroundN'  ])
        self.attrGroup.addWidget(self.aboutNExpr)
        
        self.aIndexExpr = ExpressionUI("aIndex",
                            maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kIndexAnn'  ],
                            "ArchivePrimitive", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kIndex'  ])
        self.attrGroup.addWidget(self.aIndexExpr)
        
        self.frameExpr = ExpressionUI("frame",
                            maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kFrameAnn'  ],
                            "ArchivePrimitive", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kFrame'  ])
        self.attrGroup.addWidget(self.frameExpr)
        self.aLODExpr = ExpressionUI("aLOD",
                            "",
                            "ArchivePrimitive",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kLod'  ])
    ...
    def syncDRABBoxValues(self):
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kFindingDraSize'  ])
        ...
        msg = maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kTheBoundingBoxValuesHaveBeenUpdated'  ]
        info = (maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kDraSize'  ] % (size))
        xgUtil.information(self, maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kXgenArchivePrimitive'  ], msg, informative_text=info)
    ...
    def customMenu(self,point):
        ...
        act = QAction(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kSavePilFile'  ],self.files.textEdit)
        if ( count <= 1 ):
    ...
    def lodControl(self,archiveLayout,attr):
        ...
        if attr.find("Upper") != -1:
            ...
            type = "Lower"
        val.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kImageResolutionAnn'  ] % type)
    ...
    def archiveFilesUI(self):
        self.archiveFilesGroup = ExpandUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kArchivesFiles'  ])
        self.actualLayout().addWidget(self.archiveFilesGroup)
        
        # Archive Files List.
        self.files = ArchiveFilesUI("files",
            maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kArchivesWithEachRowHoldingTheIndexAndPathToFile'  ],
            "ArchivePrimitive")
        self.files.label.setText(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kArchivesFiles2'  ])
        ...
        self.archiveSize = FloatUI("archiveSize",
                maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kArchiveSizeAnn'  ],
                "ArchivePrimitive",0.0,1000000,0.0,100.0,maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kSize'  ])
        self.archiveFilesGroup.addWidget(self.archiveSize)
        hbox = self.archiveSize.layout()
        self.pbButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kAutoSet'  ])
        self.pbButton.setFixedWidth(DpiScale(80))
        self.pbButton.setAutoRepeat(False)
        self.pbButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kAutoSetAnn'  ])
        hbox.addWidget(self.pbButton)
        self.connect(self.pbButton, QtCore.SIGNAL("clicked()"), self.syncDRABBoxValues)
        
    def advancedUI(self):
        
        self.archiveLODGroup = ExpandUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kAdvanced'  ])
        self.actualLayout().addWidget(self.archiveLODGroup)
        
        [self.hiIndex,  self.lodHiUpper,  self.lodHiLower]  = self.lodRow( "hiIndex", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kIndexToTheHighResArchive'  ], "lodHi", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kHiIndex'  ] )
        [self.medIndex, self.lodMedUpper, self.lodMedLower] = self.lodRow( "medIndex", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kIndexToTheMediumResArchive'  ], "lodMed", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kMedIndex'  ] )
        [self.loIndex,  self.lodLoUpper,  self.lodLoLower]  = self.lodRow( "loIndex", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kIndexToTheLowResArchive'  ], "lodLo", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kLoIndex'  ] )
        self.proxyIndex                                     = self.lodRow( "proxyIndex", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kIndexToTheProxyArchive'  ],"", maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kProxyIndex'  ] )
        

    def setMethod(self,method):
        PrimitiveTabUI.setMethod(self,method)
        if method == 0:
            self.lengthExpr.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kLengthAnn'  ])
            self.widthExpr.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kWidthAnn'  ])
            self.depthExpr.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kDepthAnn'  ])
            self.offUExpr.setVisible(True)
            self.offVExpr.setVisible(True)
        else:
            self.lengthExpr.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kLengthExprAnn'  ])
            self.widthExpr.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kWidthExprAnn'  ])
            self.depthExpr.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kDepthExprAnn'  ])
            self.offUExpr.setVisible(False)
            self.offVExpr.setVisible(False)

    def expressionsUI(self):
        self.expressionsGroup = ExpandUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kArchiveExpressions'  ])
        ...
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kName'  ])
        label.setFixedWidth(DpiScale(50))
        label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
        label.setIndent(DpiScale(10))
        label.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kNameAnn'  ])
        self.cattrName = QLineEdit()
        self.cattrName.setFixedWidth(DpiScale(150))
        self.cattrName.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kNameAnn2'  ])
        rx = QRegExp(r"[A-Za-z]+[A-Za-z0-9_]*(\[[0-9]+\])?")
        ...
        self.cattrAddButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kAddCustomAnn'  ])
        ...
        self.cattrRemButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kRemoveCustomAnn'  ])
    ...
    def refreshCustomParams(self):
        ...
        for param in params:
            if not param.startswith( "archive__aColor[" ): # Skip aColor
                item = ExpressionUI(param,maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kCustomAttribute'  ] % param,
...
class SavePilFileUI(QDialog):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kXgenSavePilFile'  ])
        self.setSizeGripEnabled(True)
        self.setMinimumWidth(DpiScale(50))
        layout = QVBoxLayout()
        self.fileName = BrowseUI("Pil File",
                                maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kPilFileAnn'  ],"",
                                "*.pil","out",maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kPilFile'  ])
        ...
        self.saveButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kSaveFile'  ])
        self.saveButton.setFixedWidth(DpiScale(100))
        self.saveButton.setAutoRepeat(False)
        self.saveButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kSaveFileAnn'  ])
        self.connect(self.saveButton, QtCore.SIGNAL("clicked()"),
                    self.accept)
        hbox.addWidget(self.saveButton)
        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kCancel'  ])
        self.cancelButton.setFixedWidth(DpiScale(100))
        self.cancelButton.setAutoRepeat(False)
        self.cancelButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgArchivePrimitiveTab.kCancelSaveAnn'  ])
