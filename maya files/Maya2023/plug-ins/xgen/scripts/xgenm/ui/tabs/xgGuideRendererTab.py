...
class GuideRendererTabUI(RendererTabUI):
    def __init__(self):
        ...
        # Widgets
        self.baseTopUI()
        self.replaceBox = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgGuideRendererTab.kReplace'  ],"replace",
             "","GuideRenderer")
        self.layout().addWidget(self.replaceBox)
        self.applyFXBox = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgGuideRendererTab.kApplyFx'  ],"applyFX",
             maya.stringTable[ 'y_xgenm_ui_tabs_xgGuideRendererTab.kApplyFxAnn'  ],"GuideRenderer")
        ...
        if ( xgg.Maya ):
            ...
            self.goButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_tabs_xgGuideRendererTab.kCreateGuides'  ])
            self.goButton.setFixedWidth(DpiScale(140))
            self.goButton.setAutoRepeat(False)
            self.goButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_tabs_xgGuideRendererTab.kCreateGuidesAnn'  ])
    ...
    def renderGuides(self):
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_tabs_xgGuideRendererTab.kRenderingPrimitivesProgressInfo'  ])
