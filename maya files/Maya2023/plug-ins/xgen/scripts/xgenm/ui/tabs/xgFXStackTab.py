...
class FXStackTabUI( QWidget ):
    ...
    def __init__( self ):
        ...
        expandUI = ExpandUI(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kModifiers'  ],True)
    ...
    def createModuleWidget(self, module):
        ...
        try:
            ...
            print(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kErrorRefreshingUiFor'  ] % module)
            traceback.print_exc()
            widget = EmptyFXModuleTabUI( "<None>" )
...
class FXModuleLayerUI(QWidget):
    ...
    def __init__(self):
        ...
        tooltips = [ maya.stringTable['y_xgenm_ui_tabs_xgFXStackTab.kMoveUpAnn' ],maya.stringTable['y_xgenm_ui_tabs_xgFXStackTab.kMoveDownAnn' ],maya.stringTable['y_xgenm_ui_tabs_xgFXStackTab.kAddFxAnn' ],maya.stringTable['y_xgenm_ui_tabs_xgFXStackTab.kModFxAnn' ]]
        self.buttonList = []
        self.iconList = []
        for i in range(4):
    ...
    def buildOptionMenu( self, button ):
        ...
        self.menu = QMenu()
        action = self.menu.addAction(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kSaveModifier'  ], lambda: self.repoMan("save"))
        self.buildMenus()
        self.menu.addMenu(_globalFXMenu)
        self.menu.addMenu(_localFXMenu)
        self.menu.addMenu(_userFXMenu)
        self.menu.addAction(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kDuplicate'  ], lambda: self.duplicateModule())
        self.menu.addSeparator()
        self.menu.addAction(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kDelete'  ], lambda: self.deleteModule())
    ...
    def buildMenus(self):   
        ...
        if not _globalFXMenu:
            _globalFXMenu = QMenu(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kLoadGlobal'  ])
            _localFXMenu = QMenu(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kLoadLocal'  ])
            _userFXMenu = QMenu(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kLoadUser'  ])
    ...
    def buildMenu(self,topmenu,startDir):
        ...
        try:
            ...
            action = topmenu.addAction(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kNone'  ])
        ...
        while subdirlist:
            ...
            try:
                ...
                pass
        if topmenu.isEmpty():
            action = topmenu.addAction(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kNone2'  ])
            action.setDisabled(True)
    ...
    def repoMan(self,value):
        ...
        if str(value)=="save":
            ...
            try:
                ...
                xglog.XGError(maya.stringTable[ 'y_xgenm_ui_tabs_xgFXStackTab.kTheGivenmodifierDoesntExist'  ] % filename)
                self.buildMenus()
                return
