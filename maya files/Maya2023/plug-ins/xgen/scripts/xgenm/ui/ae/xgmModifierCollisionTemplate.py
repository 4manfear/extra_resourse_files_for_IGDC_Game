...
def AExgmModifierCollisionTemplate(nodeName):
    ...
    cmds.editorTemplate(
        beginLayout=maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kCollisionModifier' ],
        collapse=False
    )
    mel.eval(r'xgmCreateAEUiForFloatAttr "mask" "%s" "xgmModifierCollision"' %
             maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kMask' ])
    cmds.editorTemplate(addSeparator=True)

    cmds.editorTemplate(
        r'collisionDistance',
        label=maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kCollisionDistance' ],
        addControl=True
    )

    cmds.editorTemplate(r'resolveType', callCustom=[AExgmModifierCollisionResolveTypeNew,AExgmModifierCollisionResolveTypeReplace])

    cmds.editorTemplate(
        r'deformationPreserved',
        label=maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kPreserveDeformation' ],
        addControl=True
    )
    ...
    cmds.editorTemplate(
        beginLayout=maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kCollisionObjects' ],
        collapse=False
    )

    cmds.editorTemplate(r'collider', callCustom=[AExgmModifierCollisionCollidersNew, AExgmModifierCollisionCollidersReplace])
...
def __createCollidersControl():
    ...
    headerItem.setText(TREE_COLUMN_ENABLE, maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kColliderEnable' ])
    headerItem.setTextAlignment(TREE_COLUMN_ENABLE, QtCore.Qt.AlignCenter)
    headerItem.setText(TREE_COLUMN_OBJECT_NAME, maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kColliderObjectName' ])
    headerItem.setTextAlignment(TREE_COLUMN_OBJECT_NAME, QtCore.Qt.AlignCenter)
    headerItem.setText(TREE_COLUMN_FLIP_NORMAL, maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kColliderFlipNormal' ])
...
def AExgmModifierCollisionCollidersNew(nodeAttr):
    ...
    cmds.button(
        ...
        label=maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kButtonAddColliders' ],
        width=buttonWidth,
        height=buttonHeight,
    ...
    cmds.button(
        ...
        label=maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kButtonRemoveColliders' ],
        width=buttonWidth,
        height=buttonHeight,
...
def AExgmModifierCollisionResolveTypeNew(nodeAttr):
    ...
    cmds.intSliderGrp(
        r'sigma',
        label = maya.stringTable['y_xgenm_ui_ae_xgmModifierCollisionTemplate.kSmoothFactor' ],
        field = True,
        minValue = 0,
        maxValue = 3,
        value = 1,
