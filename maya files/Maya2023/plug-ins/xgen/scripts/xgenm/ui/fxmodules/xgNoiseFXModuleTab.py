...
class NoiseFXModuleTabUI(FXModuleTabUI):
    def __init__(self,name):
        FXModuleTabUI.__init__(self,name,maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kNoiseModifier'  ])
        # Widgets
        self.baseTopUI()

        self.frequency = ExpressionUI("frequency",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kFrequencyAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kFrequency'  ])
        self.layout().addWidget(self.frequency)
        
        self.magnitude = ExpressionUI("magnitude",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kMagnitudeAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kMagnitude'  ])
        self.layout().addWidget(self.magnitude)

        self.magScale = RampUI("magnitudeScale",
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kMagnitudeScaleAnn'  ],
                           self.name,
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kMagnitudeScale'  ])
        self.layout().addWidget(self.magScale)
        
        self.correlation = ExpressionUI("correlation",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kCorrelationAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kCorrelation'  ])
        self.layout().addWidget(self.correlation)
        
        self.plength = ExpressionUI("preserveLength",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kPreserveLengthAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kPreserveLength'  ])
        self.layout().addWidget(self.plength)

        self.modeExpand = ExpandUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kBakeOptions'  ], False)
        self.layout().addWidget(self.modeExpand)

        self.mode = RadioUI("mode",
             [maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kLive'  ], 
              maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kBaked'  ]],
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kModeAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kMode'  ])
        self.modeExpand.addWidget(self.mode)

        self.bakeDir = BrowseUI("bakeDir",
                                maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kBakeDirAnn'  ],
                                self.name,"","in",
                                maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kBakeDir'  ])
        ...
        if ( xgg.Maya ):
            ...
            bakeButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kBakeNoiseData'  ])
    ...
    def bakeSlot(self):
        ...
        # bake the noise
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgNoiseFXModuleTab.kBakingProgress'  ])
