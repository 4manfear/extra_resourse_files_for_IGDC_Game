...
class ClumpingFXModuleTabUI(FXModuleTabUI):
    def __init__(self,name):
        FXModuleTabUI.__init__(self,name,maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpingModifier'  ])
        # Widgets
        self.baseTopUI()
        
        # Clump Effect
        self.clumpEffect = ExpandUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpEffect'  ])
        self.layout().addWidget(self.clumpEffect)

        self.clump = ExpressionUI("clump",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClump'  ])
        self.clumpEffect.addWidget(self.clump)

        self.clumpScale = RampUI("clumpScale",
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpScaleAnn'  ],
                           self.name,
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpScale'  ])
        self.clumpEffect.addWidget(self.clumpScale)
        
        self.clumpVolumize = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpVolumize'  ], "clumpVolumize",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpVolumizeAnn'  ],
             self.name)
        self.clumpEffect.addWidget(self.clumpVolumize)

        self.clumpVariance = ExpressionUI("clumpVariance",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpVarianceAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpVariance'  ])
        self.clumpEffect.addWidget(self.clumpVariance)

        # Copy Effect
        self.copyEffect = ExpandUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCopyEffect'  ], False)
        self.layout().addWidget(self.copyEffect)

        self.copy = ExpressionUI("copy",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCopyAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCopy'  ])
        self.copyEffect.addWidget(self.copy)

        self.copyScale = RampUI("copyScale",
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCopyScaleAnn'  ],
                           self.name,
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCopyScale'  ])
        self.copyEffect.addWidget(self.copyScale)
        
        self.copyVariance = ExpressionUI("copyVariance",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCopyVarianceAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCopyVariance'  ])
        self.copyEffect.addWidget(self.copyVariance)

        # Cut Effect
        self.cutEffect = ExpandUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCutEffect'  ], False)
        self.layout().addWidget(self.cutEffect)

        self.cut = ExpressionUI("cut",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCutAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCut'  ])
        self.cutEffect.addWidget(self.cut)

        # Noise Effect
        self.noiseEffect = ExpandUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoiseEffect'  ], False)
        self.layout().addWidget(self.noiseEffect)

        self.noise = ExpressionUI("noise",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoiseAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoise'  ])
        self.noiseEffect.addWidget(self.noise)

        self.noiseScale = RampUI("noiseScale",
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoiseScaleAnn'  ],
                           self.name,
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoiseScale'  ])
        self.noiseEffect.addWidget(self.noiseScale)
        
        self.noiseFrequency = ExpressionUI("noiseFrequency",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoiseFrequencyAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoiseFrequency'  ])
        self.noiseEffect.addWidget(self.noiseFrequency)

        self.noiseCorrelation = ExpressionUI("noiseCorrelation",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoiseCorrelationAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoiseCorrelation'  ])
        self.noiseEffect.addWidget(self.noiseCorrelation)

        # Frame Offset
        self.frameOffset = ExpandUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kFrameOffset'  ], False)
        self.layout().addWidget(self.frameOffset)

        self.frame = ExpressionUI("frame",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kFrameAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kFrame'  ])
        self.frameOffset.addWidget(self.frame)

        # Flatness Effect
        self.flatnessEffect = ExpandUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kFlatnessEffect'  ], False)
        self.layout().addWidget(self.flatnessEffect)

        self.flatness = ExpressionUI("flatness",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kFlatnessAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kFlatness'  ])
        self.flatnessEffect.addWidget(self.flatness)

        self.flatnessScale = RampUI("flatnessScale",
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kFlatnessScaleAnn'  ],
                           self.name,
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kFlatnessScale'  ])
        self.flatnessEffect.addWidget(self.flatnessScale)
        
        # Offset Effect
        self.offsetEffect = ExpandUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kOffsetEffect'  ], False)
        self.layout().addWidget(self.offsetEffect)

        self.offset = ExpressionUI("offset",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kOffsetAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kOffset'  ])
        self.offsetEffect.addWidget(self.offset)

        self.offsetScale = RampUI("offsetScale",
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kOffsetScaleAnn'  ],
                           self.name,
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kOffsetScale'  ])
        self.offsetEffect.addWidget(self.offsetScale)
        
        # Curl Effect
        self.curlEffect = ExpandUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCurlEffect'  ], False)
        self.layout().addWidget(self.curlEffect)

        self.curl = ExpressionUI("curl",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCurlAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCurl'  ])
        self.curlEffect.addWidget(self.curl)

        self.curlScale = RampUI("curlScale",
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCurlScaleAnn'  ],
                           self.name,
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCurlScale'  ])
        self.curlEffect.addWidget(self.curlScale)
        
        self.options = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kOptions'  ], ["colorPreview","cvAttr"],
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kOptionsAnn'  ],
             self.name,0,0,
             [maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kColorPreview'  ],
              maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCvAttr'  ]])
        ...
        if ( xgg.Maya ):
            ...
            setupMapButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kSetupMaps'  ])
            ...
            buttonLayout.setContentsMargins(DpiScale(1),DpiScale(1),DpiScale(1),DpiScale(1))
            buttonBox.setLayout(buttonLayout)
            previewGuidesButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kPreviewGuides'  ])
            buttonLayout.addWidget(previewGuidesButton)
            exportGuidesButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kExportGuides'  ])
    ...
    def previewGuidesSlot(self):
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kPreviewingProgress' ] % self.name)
    ...
    def exportGuidesSlot(self):
        ...
        (res,ok) = QInputDialog.getText(self,maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kExportClumpGuides'  ],
                    maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kExportClumpGuidesAnn'  ],
        ...
        if ok:
            ...
            setProgressInfo(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kExportingClumpingGuidesProgress'  ])
...
class GenerateClumpingMapsUI(PointsBaseUI):
    ...
    """
    def __init__(self,name):
        PointsBaseUI.__init__(self,maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kGenerateClumpingMaps'  ])
        self.name = name
        ...
        group = QGroupBox(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kPoints'  ])
        ...
        self.pointDirUI(layout,
                        "pointDir",
                        maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kPointDirAnn'  ],
                        self.name,
                        maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kPointDir'  ])

        self.ptDensity = FloatUI("Density",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kDensityAnn'  ],
             "",0.0,10000.0,0.01,100.0,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kDensity'  ])
        ...
        self.ptMask = ExpressionUI("Mask",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kMaskAnn'  ],
             "",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kMask'  ])
        ...
        ptLoadButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kLoad'  ])
        ptLoadButton.setAutoDefault(False)
        ptLoadButton.setDefault(False)
        ptButtonLayout.addWidget(ptLoadButton)
        ptGenButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kGenerate'  ])
        ptGenButton.setAutoDefault(False)
        ptGenButton.setDefault(False)
        ptButtonLayout.addWidget(ptGenButton)
        ptGuideButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kGuide'  ])
        ptGuideButton.setAutoDefault(False)
        ptGuideButton.setDefault(False)
        ptButtonLayout.addWidget(ptGuideButton)
        ptClrButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClear'  ])
        ...
        group = QGroupBox(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kMaps'  ])
        group.setAlignment(QtCore.Qt.AlignLeft)
        groupFont = group.font()
        groupFont.setBold(True)
        group.setFont(groupFont)
        ...
        self.mapDir = BrowseUI("mapDir",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kMapDirAnn'  ],
             self.name,"","in",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kMapDir'  ])
        self.mapDir.refresh()
        layout.addWidget(self.mapDir)
        
        self.radius = ExpressionUI("radiusVariance",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kRadiusVarianceAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kRadiusVariance'  ])
        self.radius.setMinimumWidth(DpiScale(50))
        self.radius.refresh()
        layout.addWidget(self.radius)

        self.useCM = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kUseControlMaps'  ],"useControlMaps",
                                maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kUseControlMapsAnn'  ], self.name)
        ...
        self.controlMask = ExpressionUI("controlMask", 
                   maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kControlMaskAnn'  ],
                   self.name, 
                   maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kControlMask'  ])
        self.controlMask.setValue(controlMask)
        layout.addWidget(self.controlMask)
        self.controlMap = BrowseUI("controlMapDir",
                   maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kControlMapAnn'  ],
                   self.name,"","in",
                   maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kControlMap'  ])
        self.controlMap.setValue(controlMap)
        layout.addWidget(self.controlMap)

        self.tpu = FloatUI("texelsPerUnit",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kTexelsPerUnitAnn'  ],
             self.name,0.0,10000,1.0,50.0,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kTexelsPerUnit'  ])
        self.connect(self.tpu.floatValue,QtCore.SIGNAL("editingFinished()"),
                     self.tpuUpdate)
        self.tpu.refresh()
        layout.addWidget(self.tpu)
        self.mem = QLabel(" 0 MB")
        self.mem.setToolTip(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kMemorySizeInMb'  ])
        ...
        mapSaveButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kSave'  ])
        mapSaveButton.setAutoDefault(False)
        mapSaveButton.setDefault(False)
        mapButtonLayout.addWidget(mapSaveButton)
        mapCancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kCancel'  ])
    ...
    def generateMaps(self):
        ...
        if not os.path.exists(dirPath):
            xglog.XGWarning(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kNoPointFileFound'  ] % dirPath )
            return
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kClumpingProgress'  ])
        cmd = 'xgmClumpMap -pb'
        ...
        cmd += ' -d "' + de.currentDescription() + '"'
        maps = mel.eval(cmd)
        print(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgClumpingFXModuleTab.kBakeInfo'  ] % maps)
        self.close()
