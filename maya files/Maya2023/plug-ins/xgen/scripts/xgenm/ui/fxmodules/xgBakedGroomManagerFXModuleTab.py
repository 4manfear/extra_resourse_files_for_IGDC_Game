...
class BakedGroomManagerFXModuleTabUI(FXModuleTabUI):
    def __init__(self,name):
        FXModuleTabUI.__init__(self,name,maya.stringTable[ 'y_xgenm_ui_fxmodules_xgBakedGroomManagerFXModuleTab.kGroomBakeModifier'  ])
        # Widgets
        self.baseTopUI()
        self.maskExpr.hide()

        self.bakeDir = BrowseUI("bakeDir",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgBakedGroomManagerFXModuleTab.kBakeDirAnn'  ],
             self.name,"","in",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgBakedGroomManagerFXModuleTab.kBakeDir'  ])
        ...
        if ( xgg.Maya ):
            ...
            self.bakeButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgBakedGroomManagerFXModuleTab.kBakeXpdGroom'  ])
    ...
    def bakeSlot(self):
        de = xgg.DescriptionEditor
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgBakedGroomManagerFXModuleTab.kBakingPrimitivesIntoXpdFilesProgress'  ])
