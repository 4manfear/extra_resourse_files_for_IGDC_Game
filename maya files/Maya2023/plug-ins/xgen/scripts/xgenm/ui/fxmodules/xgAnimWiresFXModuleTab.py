...
class AnimWiresFXModuleTabUI(FXModuleTabUI):
    def __init__(self,name):
        FXModuleTabUI.__init__(self,name,maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kAnimWireModifier'  ])
        # Widgets
        self.baseTopUI()

        self.magnitude = ExpressionUI("magnitude",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kMagnitudeAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kMagnitude'  ])
        self.layout().addWidget(self.magnitude)

        self.magScale = RampUI("magnitudeScale",
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kMagnitudeScaleAnn'  ],
                           self.name,
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kMagnitudeScale'  ])
        self.layout().addWidget(self.magScale)        
        
        self.interpolation = ExpressionUI("interpolation",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kInterpolationAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kInterpolation'  ])
        self.layout().addWidget(self.interpolation)
        

        #***********************************#
        group = QGroupBox(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kMode'  ])
        ...
        self.liveMode = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kLiveMode'  ], "liveMode",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kLiveModeAnn'  ], 
             self.name)
        ...
        self.wiresFile = BrowseUI("wiresFile",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kWiresFileAnn'  ],
             self.name,"*.caf *.abc","in",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kWiresFile'  ])
        layout.addWidget(self.wiresFile)

        self.refWiresFrame = IntegerUI("refWiresFrame",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kRefWiresFrameAnn'  ],
             self.name,-1e7,1e7,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kRefWiresFrame'  ])
        ...
        group = QGroupBox(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kAnimWiresTabControlMap'  ])
        group.setAlignment(QtCore.Qt.AlignLeft)
        groupFont = group.font()
        groupFont.setBold(True)
        group.setFont(groupFont)        
        ...
        self.useDir = RadioUI("useDir",
             [maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kRegion'  ],
              maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kClumping'  ],
              maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kDefault'  ]],
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kUseDirAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kUseDir'  ])
        ...
        self.setupMapButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kCreateMaps'  ])
        self.setupMapButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kCreateMapsAnn'  ])
        buttonLayout.addWidget(self.setupMapButton)
        self.previewGuidesButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPreviewWires'  ])
        self.previewGuidesButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPreviewWiresAnn'  ])
        buttonLayout.addWidget(self.previewGuidesButton)            
        self.exportGuidesButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kCreateHairSystem'  ])
        self.exportGuidesButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kCreateHairSystemAnn'  ])
        ...
        group = QGroupBox(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kOptions'  ])
        group.setAlignment(QtCore.Qt.AlignLeft)
        groupFont = group.font()
        groupFont.setBold(True)
        group.setFont(groupFont)        
        ...
        self.options = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kOptions2'  ],
                                  ["affectCollision","animationOnly","colorPreview"],
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kOptionsAnn'  ],
             self.name,0,0,
             [maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kAffectCollision'  ],
              maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kAnimationOnly'  ],
              maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kColorPreview'  ]])
        ...
        attachButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kAttachHairSystem'  ])
        attachButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kAttachHairSystemAnn'  ])        
        ...
        buttonLayout.setContentsMargins(DpiScale(1),DpiScale(1),DpiScale(1),DpiScale(1))
        buttonBox.setLayout(buttonLayout)
        regionsButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPreviewRegions'  ])
        regionsButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPreviewRegionsAnn'  ])        
    ...
    def defaultUpdate(self):
        ...
        print(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kControlSetTo'  ] + "${DESC}/${FXMODULE}/Control/") 
        print(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPointSetTo'  ] + "${DESC}/${FXMODULE}/Points/")
    ...
    def controlmapUpdate(self):
        ...
        if clumpMod != "":
            ...
            print(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kControlSetTo2'  ] + str(controlMap)) 
            print(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPointSetTo2'  ] + str(pointDir))
        else:
            xglog.XGWarning(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kNoClumpingModuleFoundWarning'  ])
    ...
    def regionmapUpdate(self):
        ...
        de.setAttr(self.name, "controlMapDir", str(controlMap))
        print(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kControlSetTo3'  ] + str(controlMap))
        self.setupMapButton.setEnabled(False)
    ...
    def previewGuidesSlot(self):
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPreviewingAllProgress'  ]+self.name+".")
    ...
    def createHairSystem(self):
        ...
        if active == "true":
            ...
            setProgressInfo(maya.stringTable['y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kAnimWireExportClumpingGuidesProgress' ])
            ...
            xglog.XGWarning(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kTheModuleHasToBeActiveWarning'  ])
    ...
    def attachSlot(self):
        ...
        if de.getAttr(self.name,"liveMode") == "false":  
            ...
            if sel:                        
                ...
                cmd += ' -module "'+self.name+'"'
                mel.eval(cmd)
                print(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kTheFollowingCurvesWereAttached'  ], sel)            
            else:
                warn = QMessageBox()
                warn.setText(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kNoCurvesSelected'  ])
                warn.exec_()            
    ...
    def regionsSlot(self):
        ...
        if sel:
            ...
            warn = QMessageBox()
            warn.setText(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kNoWireSelected'  ])
            warn.exec_()
...
class GenerateMapsUI(PointsBaseUI):
    ...
    """
    def __init__(self,name):
        PointsBaseUI.__init__(self,maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kGenerateMaps'  ])
        self.name = name
        ...
        group = QGroupBox(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPoints'  ])
        group.setAlignment(QtCore.Qt.AlignLeft)
        groupFont = group.font()
        groupFont.setBold(True)
        group.setFont(groupFont)
        ...
        self.pointDirUI(layout,
                        "pointDir",
                        maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPointDirAnn'  ],
                        self.name,
                        maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kPointDir'  ])

        self.ptDensity = FloatUI("Density",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kDensityAnn'  ],
             "",0.0,10000.0,0.01,100.0,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kDesnity'  ])
        ...
        self.ptMask = ExpressionUI("Mask",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kMaskAnn'  ],
             "", maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kMask'  ])
        ...
        ptLoadButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kLoad'  ])
        ptLoadButton.setAutoDefault(False)
        ptLoadButton.setDefault(False)
        ptButtonLayout.addWidget(ptLoadButton)
        ptGenButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kGenerate'  ])
        ptGenButton.setAutoDefault(False)
        ptGenButton.setDefault(False)
        ptButtonLayout.addWidget(ptGenButton)
        ptGuideButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kGuide'  ])
        ptGuideButton.setAutoDefault(False)
        ptGuideButton.setDefault(False)
        ptButtonLayout.addWidget(ptGuideButton)
        ptClrButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kClear'  ])
        ptClrButton.setAutoDefault(False)
        ptClrButton.setDefault(False)
        ptButtonLayout.addWidget(ptClrButton)
        ptSaveButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kSave'  ])
        ...
        group = QGroupBox(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kMaps'  ])
        group.setAlignment(QtCore.Qt.AlignLeft)
        groupFont = group.font()
        groupFont.setBold(True)
        group.setFont(groupFont)
        ...
        self.controlMapDir = BrowseUI("controlMapDir",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kControlMapDirAnn'  ],
             self.name,"","in",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kControlMapDir'  ])
        self.controlMapDir.refresh()
        layout.addWidget(self.controlMapDir)
        
        self.radius = ExpressionUI("radiusVariance",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kRadiusVarianceAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kRadiusVariance'  ])
        self.radius.refresh()
        layout.addWidget(self.radius)

        self.useCM = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kUseControlMaps'  ],"useControlMaps",
                                maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kUseControlMapsAnn'  ], self.name)
        ...
        self.controlMask = ExpressionUI("controlMask",
                   maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kControlMaskAnn'  ],
                   self.name, 
                   maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kControlMask'  ])
        self.controlMask.setValue(controlMask)
        layout.addWidget(self.controlMask)
        self.controlMap = BrowseUI("controlMap",
                   maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kControlMapAnn'  ],
                   self.name,"","in",
                   maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kControlMap'  ])
        self.controlMap.setValue(controlMap)
        layout.addWidget(self.controlMap)
        
        self.tpu = FloatUI("texelsPerUnit",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kTexelsPerUnitAnn'  ],
             self.name,0.0,10000,1.0,50.0,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kTexelsPerUnit'  ])
        self.connect(self.tpu.floatValue,QtCore.SIGNAL("editingFinished()"),
                     self.tpuUpdate)
        self.tpu.refresh()
        layout.addWidget(self.tpu)
        self.mem = QLabel(" 0 MB")
        self.mem.setToolTip(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kMemorySizeInMb'  ])
        ...
        mapSaveButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kCreate'  ])
        ...
        mapCancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kCancel'  ])
    ...
    def generateMaps(self):
        ...
        setProgressInfo(maya.stringTable['y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kAnimWiresSavePointsProgress' ])
        cmd = 'xgmClumpMap -pb'
        ...
        cmd += ' -d "' + de.currentDescription() + '"'
        maps = mel.eval(cmd)
        print(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgAnimWiresFXModuleTab.kTheFollowingMapsWereGenerated'  ], maps)
        self.close()
