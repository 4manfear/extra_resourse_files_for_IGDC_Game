...
class PlaneAnimFXModuleTabUI(FXModuleTabUI):
    def __init__(self,name):
        FXModuleTabUI.__init__(self,name,maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kPlaneAnimModifier'  ])
        # Widgets
        self.baseTopUI()
        
        self.magnitude = ExpressionUI("magnitude",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kMagnitudeAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kMagnitude'  ])
        self.layout().addWidget(self.magnitude)

        self.planeNames = BrowseUI("planeNames",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kPlaneNamesAnn'  ],
             self.name,"*.caf *.abc","in",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kPlaneNames'  ])
        self.layout().addWidget(self.planeNames)
        
        self.planeSubdivsU = IntegerUI("planeSubdivsU",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kPlaneSubdivUAnn'  ],
             self.name,-1e7,1e7,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kPlaneSubdivsU'  ])
        self.layout().addWidget(self.planeSubdivsU)

        self.planeSubdivsV = IntegerUI("planeSubdivsV",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kPlaneSubdivsV'  ],
             self.name,-1e7,1e7,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kPlaneSabduvsV'  ])
        ...
        if ( xgg.Maya ):
            ...
            freezeButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kFreezePlane'  ])
    ...
    def freezeSlot(self):
        print(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgPlaneAnimFXModuleTab.kFreezePlaneButtonPressed'  ])
