...
class ControlWiresFXModuleTabUI(FXModuleTabUI):
    def __init__(self,name):
        FXModuleTabUI.__init__(self,name,maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kControlWiresModifier'  ])
        # Widgets
        self.baseTopUI()
        
        self.magnitude = ExpressionUI("magnitude",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kMagnitudeAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kMagnitude'  ])
        self.layout().addWidget(self.magnitude)

        self.magScale = RampUI("magnitudeScale",
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kMagnitudeScaleAnn'  ],
                           self.name,
                           maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kMagnitudeScale'  ])
        self.layout().addWidget(self.magScale)                
        
        self.smoothness = ExpressionUI("smoothness",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kSmoothnessAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kSmoothness'  ])
        self.layout().addWidget(self.smoothness)
        
        self.breakage = ExpressionUI("breakage",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kBreakageAnn'  ],
             self.name,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kBreakage'  ])
        self.layout().addWidget(self.breakage)

        #***********************************#
        group = QGroupBox(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kMode'  ])
        ...
        self.liveMode = CheckBoxUI(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kLiveMode'  ], "liveMode",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kLiveModeAnn'  ], 
             self.name)
        ...
        self.wiresFile = BrowseUI("wiresFile",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kWiresFileAnn'  ],
             self.name,"*.caf *.abc","in",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kWiresFile'  ])
        layout.addWidget(self.wiresFile)

        self.refWiresFrame = IntegerUI("refWiresFrame",
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kRefWiresFrameAnn'  ],
             self.name,-1e7,1e7,
             maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kRefWiresFrame'  ])
        ...
        if ( xgg.Maya ):
            ...
            attachButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kAttachHairSystem'  ])
            attachButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kHairSystemAnn'  ])        
    ...
    def attachSlot(self):
        ...
        if de.getAttr(self.name,"liveMode") == "false":  
            ...
            if sel:                        
                ...
                cmd += ' -module "'+self.name+'"'
                mel.eval(cmd)
                print(maya.stringTable['y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kControlWiresCurvesAttached' ], sel)            
            else:
                warn = QMessageBox()
                warn.setText(maya.stringTable[ 'y_xgenm_ui_fxmodules_xgControlWiresFXModuleTab.kNoCurvesSelectedNothingToAttach'  ])
                warn.exec_()            
