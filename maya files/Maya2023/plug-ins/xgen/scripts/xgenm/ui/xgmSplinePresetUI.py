...
importPresetDialogTitle = maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kImportDialogTitle' ]
exportPresetDialogTitle = maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kExportDialogTitle' ]
...
class xgmSplinePresetImportDialog(xgmSplinePresetDialog):
    ...
    def __setupDescriptionUI(self, layout):
        self.presetFile = FileBrowserUI(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kFileNameForPresetImport' ], r"", r"*.%s" % presetExtension, r"in")
        ...
        tranferLabel = QLabel(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kTransferMethod' ])
        ...
        self.posBasedTransfer = QRadioButton(maya.stringTable[ 'y_xgenm_ui_xgmSplinePresetUI.kPosBasedTransfer' ])
        self.transferRadioButtonGroup.addWidget(self.posBasedTransfer)
        self.uvBasedTransfer = QRadioButton(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kUVBasedTransfer' ])
        self.transferRadioButtonGroup.addWidget(self.uvBasedTransfer)

        # Orientation
        orientationLayout = self._createRowLayout(layout)
        orientationLabel = QLabel(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kOrientation'  ])
        ...
        self.rotateOrientationToNewNormal = QRadioButton(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kRotateOrientationToNewNormal' ])
        self.orientationRadioButtonGroup.addWidget(self.rotateOrientationToNewNormal)
        self.keepOrientation = QRadioButton(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kKeepOrientation' ])
    ...
    def __setupButtons(self, layout):
        ...
        self.importButton = QPushButton(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kImportPreset' ])
        ...
        self.cancelButton = QPushButton(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kCancelImportPreset' ])
    ...
    def __importPresetCallback(self):
        ...
        if not os.path.exists(presetFilePath):
            text = maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kNotAValidPathImport' ]
        ...
        if not selectedShapes or len(selectedShapes) != 1:
            text = maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kPleaseSelectOneMesh' ]
            QMessageBox.warning(self, importPresetDialogTitle, text)
            return
...
class xgmSplinePresetExportDialog(xgmSplinePresetDialog):
    ...
    def __setupDescriptionUI(self, layout):
        self.presetFile = FileBrowserUI(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kFileNameForPresetExport' ], r"", r"*.%s" % presetExtension, r"out")
        self.connect(self.presetFile.textValue, QtCore.SIGNAL(r"editingFinished()"), self.__onFileSelectedCallback)
    ...
    def __setupThumbnailUI(self, layout):
        ...
        label = QLabel(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kXGenPresetThumbnail' ])
        ...
        snapshotButton = QPushButton(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kSnapshotButtonForPresetThumbnail' ])
        ...
        browseButton = QPushButton(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kBrowseButtonForPresetThumbnail' ])
    ...
    def __setupButtons(self, layout):
        ...
        hbox.setSpacing(DpiScale(15))
        hbox.setContentsMargins(DpiScale(1), DpiScale(1), DpiScale(1), DpiScale(1))
        self.exportButton = QPushButton(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kExportPreset' ])
        ...
        self.cancelButton = QPushButton(maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kCancelExportPreset' ])
        self.cancelButton.setFixedWidth(DpiScale(100))
        self.cancelButton.setAutoRepeat(False)
        self.connect(self.cancelButton, QtCore.SIGNAL(r"clicked()"), self.close)
        hbox.addWidget(self.cancelButton)
    ...
    def __exportPresetCallback(self):
        ...
        if not os.path.exists(os.path.dirname(presetFilePath)):
            text = maya.stringTable[ 'y_xgenm_ui_xgmSplinePresetUI.kNotAValidPathExport'  ]
        ...
        if not selectedDescs or len(selectedDescs) != 1:
            text = maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kPleaseSelectOneDescription' ]
            QMessageBox.warning(self, exportPresetDialogTitle, text)
            return

        if os.path.isfile(presetFilePath):
            text = """'%s' %s""" % (presetFilePath, maya.stringTable['y_xgenm_ui_xgmSplinePresetUI.kReplaceFile' ])
