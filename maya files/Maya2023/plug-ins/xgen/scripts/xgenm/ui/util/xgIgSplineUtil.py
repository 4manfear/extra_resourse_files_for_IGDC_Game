...
gSplineNodeNiceNameTable = {
    r'xgmModifierCut'           : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierCut'],
    r'xgmModifierCollision'     : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierCollision'],
    r'xgmModifierSculpt'        : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierSculpt'],
    r'xgmModifierNoise'         : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierNoise'],
    r'xgmModifierGuide'         : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierGuide'],
    r'xgmModifierLinearWire'    : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierLinearWire'],
    r'xgmModifierScale'         : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierScale'],
    r'xgmModifierDisplacement'  : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierDisplacement' ],
    r'xgmSplineCache'           : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierSplineCache'],
    r'xgmCurveToSpline'         : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kCurveToSpline' ],
    r'xgmModifierClump'         : maya.stringTable['y_xgenm_ui_util_xgIgSplineUtil.kModifierClump']
    }
