...
class ArchiveFilesUI(QWidget):
    ...
    def __init__(self,attr,help="",object="",width=0):
        ...
        self.slider.setToolTip(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kThumbnailSizeAnn'  ])
        self.connect(self.slider, QtCore.SIGNAL("valueChanged(int)"), self.sliderChanged )
        sliderLayout.addWidget( self.slider )

        # Show Thumbnails checkbox
        self.pbMode = QCheckBox(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kList'  ])
        self.pbMode.setToolTip(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kListAnn'  ])
        ...
        self.pbCreate = QPushButton(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kCreate'  ])
        self.pbCreate.setToolTip(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kCreateAnn'  ])
        ...
        self.pbAdd = QPushButton(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kAdd'  ])
        self.pbAdd.setToolTip(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kAddAnn'  ])
        archiveButLayout.addWidget(self.pbAdd)
        self.connect(self.pbAdd, QtCore.SIGNAL("clicked()"), self.addArchiveDialog)
        
        self.pbEdit = QPushButton(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kEdit'  ])
        self.pbEdit.setToolTip(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kEditAnn'  ])
        archiveButLayout.addWidget(self.pbEdit)
        self.connect(self.pbEdit, QtCore.SIGNAL("clicked()"), self.editArchiveDialog)
        
        self.pbRemove = QPushButton(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kRemove'  ])
        self.pbRemove.setToolTip(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kRemoveAnn'  ])
    ...
    def handleMenu( self, pos):
        menu = QMenu()
        menu.addAction(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kEditRightClick'  ],self.emitEditMenu)
        menu.addAction(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kRemoveRightClick'  ],self.emitRemoveMenu)
        ...
        for i in range( model.rowCount() ):
            ...
            if len(resolvedThumbnail) and pixmap.load( resolvedThumbnail ):
                ...
                try:
                    ...
                    print(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kCouldntCreateEmptyPixmap'  ])
    ...
    def addArchiveDialog(self):
        ...
        dialog.setWindowTitle( maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kXgenAddArchives'  ] )
    ...
    def addArchives( self, files ):
        ...
        if xgg.Maya:
            ...
            if len(materialFiles):
                ...
                msgbox.setWindowTitle( maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kXgenImportMaterials'  ] )

                strFiles = ""
                for m in materialFiles:
                    strFiles += m + "\n"

                msgbox.setText(maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kAddedXarcArchives'  ] % strFiles)
                ...
                if msgbox.exec_() == QMessageBox.Yes:
                    for f in materialFiles:
                        ...
                        try:
                            ...
                            print(maya.stringTable['y_xgenm_ui_widgets_xgArchiveFilesUI.kErrorWhileReadFile' ])
                            print(str(e))
    ...
    def removeArchiveDialog(self):
        ...
        if len(groups):
            ...
            if self.mode:
                ...
                sel, ok = QInputDialog.getItem(self, maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kXgenRemoveArchive'  ], maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kArchive'  ], items, current=0, editable=False  )
                if ok:
    ...
    def editArchiveDialog( self ):
        ...
        if len(groups):
            ...
            if self.mode:
                ...
                sel, ok = QInputDialog.getItem(self, maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kXgenEditArchive2'  ], maya.stringTable[ 'y_xgenm_ui_widgets_xgArchiveFilesUI.kArchive2'  ], items, current=0, editable=False  )
                if ok:
