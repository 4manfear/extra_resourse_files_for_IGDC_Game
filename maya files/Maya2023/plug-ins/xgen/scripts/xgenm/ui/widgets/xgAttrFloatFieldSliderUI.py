    ...
    def __onFieldContextMenu(self, pos):
        ...
        if not self.watcher.isPlugLocked():
            ...
            if self.watcher.isPlugHasExpression():
                ...
                ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kEditExpression'], self.watcher.plugSetExpression)
                ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kDeleteExpression'], self.watcher.plugDeleteExpression)
            else:
                ...
                if not plugIsDest:
                    ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kCreateNewExpression'], self.watcher.plugSetExpression)
                    
                # Set Key when there is no key or already keyed
                if not plugIsDest or self.watcher.isPlugKeyed():
                    ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kSetKey'], self.watcher.plugSetKey)
                ...
                if not plugIsDest:
                    ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kCreateNewTexture'], self.watcher.plugCreateTexture)
                    
                # Break Connection when there is a connection
                if plugIsDest:
                    ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kBreakConnection'], self.watcher.breakPlugConnection)
                    
            ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kLockAttribute'], self.watcher.lockPlug)
            ...
            if plugIsDest and not self.watcher.isPlugHasExpression():
                if self.watcher.isPlugIgnoreWhenRendering():
                    ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kDontIgnoreWhenRendering'], self.watcher.plugToggleIgnoreWhenRendering)
                else:
                    ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kIgnoreWhenRendering'], self.watcher.plugToggleIgnoreWhenRendering)
        else:
            # Locked Attribute
            ctxMenu.addAction(maya.stringTable['y_xgenm_ui_widgets_xgAttrFloatFieldSliderUI.kUnlockAttribute'], self.watcher.unlockPlug)
