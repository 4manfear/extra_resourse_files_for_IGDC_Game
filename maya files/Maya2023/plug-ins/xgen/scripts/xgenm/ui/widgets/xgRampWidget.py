...
class xgRampWidget(QWidget):
    ...
    def __init__(self,pLabel=None,vLabel=None,iLabel=None, RampCurve = None,parent=None, FixEditSize = 320):
        ...
        if pLabel != None:
            ...
            selPosLayout.addWidget(QLabel(maya.stringTable[ 'y_xgenm_ui_widgets_xgRampWidget.kSelectedPosition'  ]))
        ...
        if vLabel != None:
            ...
            selValLayout.addWidget(QLabel(maya.stringTable[ 'y_xgenm_ui_widgets_xgRampWidget.kSelectedValue'  ]))
        ...
        self.interpComboBox.addItem(maya.stringTable[ 'y_xgenm_ui_widgets_xgRampWidget.kFlat'  ])
        self.interpComboBox.addItem(maya.stringTable[ 'y_xgenm_ui_widgets_xgRampWidget.kLinear'  ])
        self.interpComboBox.addItem(maya.stringTable[ 'y_xgenm_ui_widgets_xgRampWidget.kSmooth'  ])
        self.interpComboBox.addItem(maya.stringTable[ 'y_xgenm_ui_widgets_xgRampWidget.kSpline'  ])
        self.interpComboBox.setCurrentIndex(1)
        if vLabel != None:
            interpLayout.addWidget(QLabel(iLabel))
        else:
            interpLayout.addWidget(QLabel(maya.stringTable[ 'y_xgenm_ui_widgets_xgRampWidget.kInterpolation'  ]))
