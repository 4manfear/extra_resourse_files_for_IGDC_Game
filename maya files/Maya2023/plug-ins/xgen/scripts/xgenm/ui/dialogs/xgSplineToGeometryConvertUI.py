...
class ConvertPrimitiveToPolygonWindow(QMainWindow):
    ...
    def __init__(self, parent):
        ...
        # Window title
        self.setWindowTitle( maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kConvertPrimToPolyWinTitle' ])
        ...
        self.convertSelectedChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kConvertSelected' ])
        ...
        self.combineMeshChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kCombineMesh' ])
        ...
        self.useWidthRampChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kUseWidthRamp' ])
        gridLayout.addWidget(self.useWidthRampChkBoxUI, gridLine, 1, 1, 2)
        gridLine += 1

        # 'Insert Spans Along Width' check box
        self.insertSpansChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kInsertSpans' ])
        ...
        self.spanNumIntUI = IgIntSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kSpanNum' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kkSpanNumAnno' ],
                True,
                0, 100, 0, 10,
                gridLayout, gridLine,
        ...
        self.curvatureFloatUI = IgFloatSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kCurvature' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kCurvatureAnno' ],
                True,
                -1.0, 1.0, -1.0, 1.0,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.placeUVChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kPlaceUV' ])
        ...
        # UV Layout Type
        self.uvLayoutTypeLabelUI = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kUVLayoutType'  ])
        ...
        self.tileSeparationFloatUI = IgFloatSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kTileSeparation' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kTileSeparationAnno' ],
                True,
                0.0, 1.0, 0.0, 1.0,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.createStripJointsChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kCreateStripJoints' ])
        ...
        jointPlacementStr = maya.stringTable[ 'y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kJointPlacement'  ]
        jointPerSpanStr = maya.stringTable[ 'y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kJointPerSpan'  ]
        jointPerCVStr = maya.stringTable[ 'y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kJointPerCV'  ]
        specifyJointNumStr = maya.stringTable[ 'y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kSpecifyJointNum'  ]
        ...
        self.stripJointNumIntUI = IgIntSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kStripJointNum' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kStripJointNumAnno' ],
                True,
                3, 100, 3, 10,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        # Auto Bind Skin
        self.autoBindSkinChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kAutoBindSkin' ])
        ...
        self.maxInfluencesIntUI = IgIntSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kMaxInfluences' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kMaxInfluencesAnno' ],
                True,
                3, 100, 3, 10,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.convertButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kConvert'  ])
        ...
        self.applyButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kApply'  ])
        ...
        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kCancel'  ])
    ...
    def __createMenus(self):
        ...
        # Edit menu
        editMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kEdit' ])
        editMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kResetSettings' ], self.__onMenuResetSettings)
        editMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kSaveSettings' ], self.__onMenuSaveSettings)

        # Help menu
        helpMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kHelp' ])
        helpMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgSplineToGeometryConvertUI.kHelpMenu' ], self.__onMenuHelp)
