...
importPresetDialogTitle = maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kImportPresetToSelectedGeometry'  ]
...
class ImportPresetUI(QWidget):
    ...
    def descriptionUI(self,layout):
        ...
        self.xgpFile = BrowseUI(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kFileNameOfPreset'  ], "", "", "*.xgp", "in")
        ...
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kNewDescriptionNameForPreset'  ])
        ...
        self.addDescriptionToRadio = QRadioButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kAddPresetToExistingCollection'  ])
        ...
        self.createNewPaletteRadio = QRadioButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kCreateNewCollectionForPreset'  ])
        ...
        # guides options
        guideOptionLabel = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kGuideOptionForPreset'  ])
        vbox.addWidget(guideOptionLabel)
        rowLayout1 = self._createRowLayout(vbox)
        generateGuideLabel = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kGenerateGuides'  ])
        ...
        self.transferGuide = QRadioButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kTransferGuide'  ])
        self.transferGuide.clicked.connect(self.onClickTransferGuide)
        self.guideOptionGroup.addWidget(self.transferGuide)
        self.noGuide = QRadioButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kNoGuide'  ])
        ...
        guideTranferLabel = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kGuideTranferForPreset'  ])
        ...
        self.posBasedGuideTransfer = QRadioButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kPosBasedGuideTransfer'  ])
        ...
        self.uvBasedGuideTransfer = QRadioButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kUVBasedGuideTransfer'  ])
        ...
        guideOrientionTransfer = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kGuideOrientionTransfer'  ])
        ...
        self.rotateGuideOrientationToNewNormal = QRadioButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kRotateGuideOrientationToNewNormal'  ])
        self.guideOrientationTransferRadioButtonGroup.addWidget(self.rotateGuideOrientationToNewNormal)
        self.keepGuideOrientation = QRadioButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kKeepGuideOrientation'  ])
    ...
    def buttons(self,layout):
        ...
        self.importButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kImport'  ])
        ...
        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kCancelImport'  ])
    ...
    def importGroomableSplines(self, descName, palName, xgpFilePath):
        ...
        if not os.path.isfile(filename):
            ...
            cmds.warning(maya.stringTable['y_xgenm_ui_dialogs_xgImportPreset.kMissGroom' ] % (baseName, dirName))
            return
    ...
    def importCB(self):
        ...
        if not ImportPresetUI.fileExists(xgpFileName,maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kPresetFileDoesNotExist'  ]):
            return
        ...
        if len(pal) and xgg.Maya:
            ...
            if not (len(geometries) or faces is not None):
                text = maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kPleaseSelectAPolygonSurfaceForPresetTip'  ]
        ...
        if not len(newDesc):
            text = maya.stringTable[ 'y_xgenm_ui_dialogs_xgImportPreset.kImportPresetFail'  ]
            QMessageBox.warning(self, importPresetDialogTitle, text)
            self.close()
            return
        ...
        if (xgg.DescriptionEditor != 0 ):
            ...
            if xg.igDescription(newDesc) and xgg.Maya:
                ...
                xgg.DescriptionEditor.activateTab( maya.stringTable['y_xgenm_ui_dialogs_xgImportPreset.kGrooming' ] )
