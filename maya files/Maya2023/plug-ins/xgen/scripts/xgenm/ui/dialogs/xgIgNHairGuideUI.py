...
class NHairGuideWindow(QMainWindow):
    ...
    def __init__(self, parent, guideModifierNode):
        ...
        # Window title
        self.setWindowTitle(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kNHairGuideWindowTitle' ])
        ...
        self.ui_nhair_attachCurve = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kNHairAttachCurve' ])
        self.ui_nhair_snapCurve   = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kNHairSnapCurve' ])
        self.ui_nhair_collide     = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kNHairCollide' ])
        self.ui_nhair_exact       = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kNHairExact' ])
        self.ui_delete_origin     = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kDeleteOriginGuide' ])
        ...
        # "Apply" button
        self.ui_applyButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgNHairGuideUI.kApplyAndClose'  ])
        ...
        # "Cancel" button
        self.ui_cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgNHairGuideUI.kCancel'  ])
    ...
    def __createMenus(self):
        # Edit menu
        editMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kEdit' ])
        editMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kResetSettings' ], self.__onMenuResetSettings)

        # Help menu
        helpMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kHelp' ])
        helpMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kHelpMenu' ], self.__onMenuHelp)
    ...
    def __onClickApplyButton(self):
        ...
        try:
            ...
            print(stackTrace)
            cmds.inViewMessage(msg=maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kMakeGuideDynamicFailed' ], pos="botCenter", fade=True)
        else:
            cmds.inViewMessage(msg=maya.stringTable['y_xgenm_ui_dialogs_xgIgNHairGuideUI.kMakeGuideDynamicSucceeded' ], pos="botCenter", fade=True)
