...
class TubeGroomUI(QDialog):
    ...
    def __init__(self,object):
        ...
        self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kTubeBasedGrooming'  ])
        self.setSizeGripEnabled(True)
        self.setMinimumWidth(DpiScale(600))
        layout = QVBoxLayout()
        de = xgg.DescriptionEditor
        self.tubes = TextUI("tubes",maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kTubesAnn'  ],
                            object,0)
        self.tubes.label.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kTubes'  ])
        ...
        self.spacing = FloatUI("guideSpacing",
                               maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kSpacingAnnxs'  ],
                               object,0.0,1000000,0.01,2.0)
        self.spacing.label.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kGuideSpacing'  ])
        self.spacing.refresh()
        self.count = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kUnkownGuides'  ])
        self.count.setFixedWidth(DpiScale(85))
        self.count.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kGuideNumberAnn'  ])
        self.spacing.layout().addWidget(self.count)
        self.test1Button = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kTest1'  ])
        self.test1Button.setFixedWidth(DpiScale(70))
        self.test1Button.setAutoRepeat(False)
        self.test1Button.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kSpacingAnn2'  ])
        ...
        self.guideMask = ExpressionUI("guideMask",
               maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kGuideMaskAnn'  ],
               object)
        self.guideMask.label.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kGuideMask'  ])
        self.guideMask.refresh()
        layout.addWidget(self.guideMask)
        self.cutParam = ExpressionUI("cutParam",
               maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kCutParamAnn' ],
               object)
        self.cutParam.label.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kCutParam'  ])
        self.cutParam.refresh()
        layout.addWidget(self.cutParam)        
        self.freq = FloatUI("CVFrequency",
                            maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kFloatUIAnn' ],
                               object,0.0001,100.0)
        self.freq.label.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kCvFrequency'  ])
        self.freq.refresh()
        layout.addWidget(self.freq)        

        self.tpu = FloatUI("texelsPerUnit",
             maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kTexelsPerUnitAnn'  ],
             object,0.0,10000,1.0,50.0)
        self.tpu.label.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kTexelsPerUnit'  ])
        self.connect(self.tpu.floatValue,QtCore.SIGNAL("editingFinished()"),
                     self.tpuUpdate)
        self.tpu.refresh()
        self.mem = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kMb'  ])
        self.mem.setFixedWidth(DpiScale(85))
        self.mem.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kMemorySizeInMb'  ])
        self.tpu.layout().addWidget(self.mem)
        self.test2Button = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kTest2'  ])
        self.test2Button.setFixedWidth(DpiScale(70))
        self.test2Button.setAutoRepeat(False)
        self.test2Button.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kTestAnn'  ])
        ...
        self.generateButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kGenerate'  ])
        self.generateButton.setFixedWidth(DpiScale(100))
        self.generateButton.setAutoRepeat(False)
        self.generateButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kGenerateAnn'  ])
        self.connect(self.generateButton, QtCore.SIGNAL("clicked()"),
                     self.generate)
        hbox.addWidget(self.generateButton)
        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kCancel'  ])
        self.cancelButton.setFixedWidth(DpiScale(100))
        self.cancelButton.setAutoRepeat(False)
        self.cancelButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kCancelAnn'  ])
    ...
    def testGuides(self):
        ...
        num = mel.eval(cmd)
        if num:
            self.count.setText(maya.stringTable['y_xgenm_ui_dialogs_xgTubeGroom.kTubeGroomTestGuides' ].format(num))
    ...
    def generate(self):
        ...
        setProgressInfo(maya.stringTable[ 'y_xgenm_ui_dialogs_xgTubeGroom.kTubeGroomProgressGeneratingRegionMaps'  ])
        print(mel.eval(cmd))
        self.close()
