...
class IgSplineAddModifierUI(QDialog):
    ...
    def __init__(self, x, y):
        ...
        self.setWindowTitle(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineAddModifier.kAddModifierWindow'])
    ...
    def __createButtonsUI(self):
        ...
        # OK Button
        okButton = QPushButton(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineAddModifier.kOK'])
        okButton.setFixedWidth(DpiScale(90))
        okButton.setAutoRepeat(False)
        okButton.setToolTip(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineAddModifier.kOKButtonAnnot' ])
        okButton.setDefault(True)
        
        # Cancel Button
        cancelButton = QPushButton(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineAddModifier.kCancel'])
        cancelButton.setFixedWidth(DpiScale(90))
        cancelButton.setToolTip(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineAddModifier.kCancelButtonAnnot' ])
