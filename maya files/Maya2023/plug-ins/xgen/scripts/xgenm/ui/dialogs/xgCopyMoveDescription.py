...
class CopyMoveDescriptionUI(QDialog):
    ...
    def __init__(self,type,isMove):
        ...
        self.type = type
        if(isMove):
            self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kMoveDescription'  ])
        else:
            self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kDuplicateDescription'  ])
        ...
        # row for labels
        if(isMove):
            label = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kMoveFrom'  ])
        else:
            label = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kFrom'  ])
        label.setAlignment(QtCore.Qt.AlignLeft)
        gridLayout.addWidget(label,0,0)
        gridLayout.setColumnMinimumWidth(0,DpiScale(220))
        gridLayout.setColumnStretch(0,50)
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kTo'  ])
        label.setAlignment(QtCore.Qt.AlignLeft)
        ...
        self.toPalette.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kNewCollectionAnn'  ])
        ...
        if(isMove):
            self.toDescr.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kNewNameMoveAnn'  ])
        else:
            self.toDescr.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kNewNameAnn'  ])
        ...
        self.descrOnly = QCheckBox(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kDescriptionOnly'  ])
        self.descrOnly.setChecked(True)
        self.descrOnly.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kIncludePatchBindingsAnn'  ])
        ...
        self.applyButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kApplyAnn'  ] % type)
        self.connect(self.applyButton, QtCore.SIGNAL("clicked()"),self.applyCB)
        hbox.addWidget(self.applyButton)
        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kCancel'  ])
        self.cancelButton.setAutoRepeat(False)
        if(isMove):
            self.cancelButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kCancelAnn'  ])
        else:
            self.cancelButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kCancelDuplicationAnn'  ])
    ...
    def checkValid(self):
        if self.getToDescription() == "":
            tellem = QMessageBox()
            tellem.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kYouMustSpecifyADestinationDescriptionName'  ])
            tellem.exec_()
            return False
        if ( self.type == "Copy" and
            ...
            tellem = QMessageBox()
            tellem.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kYouMustSpecifyADifferentName'  ])
            tellem.exec_()
            return False
        if ( cmds.objExists( self.getToDescription() ) and
            ...
            tellem = QMessageBox()
            tellem.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kNameGivenForDescriptionAlreadyExitsInTheScene'  ])
            tellem.exec_()
            return False
        return True
...
def copyDescription():
    ...
    if len(xg.descriptions()) == 0:
        tellem = QMessageBox()
        tellem.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kThereAreNoDescriptionsToCopy'  ])
        tellem.exec_()
        return
    ...
    dialog = CopyMoveDescriptionUI(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kDuplicate'  ],False)
    result = dialog.exec_()
    if result == QDialog.Accepted:
        ...
        if xgg.Maya:
            ...
            goPort = QMessageBox()
            goPort.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kCopyDescriptionOnlyAvailableInMaya'  ])
            goPort.exec_()
...
def moveDescription():
    ...
    if len(xg.descriptions()) == 0 or len(xg.palettes()) < 2:
        tellem = QMessageBox()
        tellem.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kThereAreNoDescriptionsThatCanBeMoved'  ])
        tellem.exec_()
        return
    ...
    dialog = CopyMoveDescriptionUI(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kMove'  ],True)
    result = dialog.exec_()
    ...
    if result == QDialog.Accepted:
        ...
        if xgg.Maya:
            ...
            goPort = QMessageBox()
            goPort.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCopyMoveDescription.kMoveDescriptionOnlyAvailableInMaya'  ])
            goPort.exec_()
