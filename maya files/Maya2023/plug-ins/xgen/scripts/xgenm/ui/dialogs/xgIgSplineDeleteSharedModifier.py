...
class IgSplineDeleteSharedModifierUI(QDialog):
    ...
    def __init__(self, modifier, x, y):
        ...
        self.setWindowTitle(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineDeleteSharedModifier.kDeleteModifier'] % modifier)
        
        # Warning label
        msgLabelUI = QLabel(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineDeleteSharedModifier.kWarnSharedModifier'] % modifier)
        
        # Disconnect button
        disconnectButton = QPushButton(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineDeleteSharedModifier.kDeleteInCurrent'])
        disconnectButton.setAutoRepeat(False)
        disconnectButton.setDefault(True)
        
        # Delete button
        deleteButton = QPushButton(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineDeleteSharedModifier.kDeleteInAll'])
        
        # Cancel button
        cancelButton = QPushButton(maya.stringTable['y_xgenm_ui_dialogs_xgIgSplineDeleteSharedModifier.kCancel'])
