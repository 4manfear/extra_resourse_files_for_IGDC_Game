...
class EditArchiveGroupUI(QDialog):
    ...
    def __init__(self, n, t, c, d, f):
        ...
        self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kEditArchiveGroup'  ])
        ...
        self.aName = TextUI(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kNameLayout'  ], maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kNameLayoutTip'  ], "" )
        self.aName.setValue( n )
        layout.addWidget(self.aName)
        
        self.aThumb = BrowseUI(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kThumbnailName'  ], maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kThumbnailAnn'  ], "","*.png *.jpg *.tif","in")
        self.aThumb.setValue( t )
        layout.addWidget(self.aThumb)
        
        self.aColor = ColorExpressionUI( parent=None, object="", attr="aColor", strLabel="Color", mode="", r=c[0], g=c[1], b=c[2], pos=0, printableName=maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kColor'  ])
        layout.addWidget(self.aColor)
        
        self.aDescription = TextUI(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kDescriptionName'  ], maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kDescriptionAnn'  ], "")
        self.aDescription.setValue( d )
        layout.addWidget(self.aDescription)
        
        
        self.aFiles = TextEditUI( maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kFilesName'  ], maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kFilesAnn'  ], "" )
        ...
        self.okButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kOk'  ])
        ...
        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditArchiveGroup.kCancel'  ])
