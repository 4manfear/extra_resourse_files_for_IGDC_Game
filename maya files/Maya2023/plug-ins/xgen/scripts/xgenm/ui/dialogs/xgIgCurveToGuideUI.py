...
class CurveToGuideWindow(QMainWindow):
    ...
    def __init__(self, parent, modifierNode, isGuide):
        ...
        # Window title
        if self.isGuide:
            self.setWindowTitle(maya.stringTable['y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kCurveAsGuideWindowTitle' ])
        else:
            self.setWindowTitle(maya.stringTable['y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kCurveAsWireWindowTitle' ])
        ...
        #----------------------------------------
        # UIs for Options
        self.ui_delete_curves = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kDeleteCurves' ])
        self.ui_preserve_dynamic_link  = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kPreserveDynamicLink' ])
        ...
        # "Apply" button
        self.ui_applyButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kApplyAndClose'  ])
        ...
        # "Cancel" button
        self.ui_cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kCancel'  ])
    ...
    def __createMenus(self):
        # Edit menu
        editMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kEdit' ])
        editMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kResetSettings' ], self.__onMenuResetSettings)

        # Help menu
        helpMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kHelp' ])
        if self.isGuide:
            helpMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kCurveAsGuideWindowHelp' ], self.__onMenuHelp)
        else:
            helpMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgIgCurveToGuideUI.kCurveAsWireWindowHelp' ], self.__onMenuHelp)
