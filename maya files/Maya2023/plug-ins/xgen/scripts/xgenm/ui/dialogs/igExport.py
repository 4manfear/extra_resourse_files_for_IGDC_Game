...
class igExportUI(QDialog):
    class PtexUI(QWidget):
        def __init__(self,path,tpu):
            ...
            self.path = FileBrowserUI(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kFolderPathPtexExport'  ],
                                 maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kFullPathAnn'  ],"","out")
            self.path.optionButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kBrowseForAFolder'  ])
            self.path.setValue( path )
            vbox.addWidget(self.path)
        
            help =maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kTexelsPerUnitAnn'  ]
            self.tpu = FloatUI( maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kTexelsPerUnit'  ], help, '', 0.001, 10000.0, 0.001, 100.0)
    ...
    class MapExporter(QWidget):
        def __init__(self, tabs):
            ...
            help=(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kMethodTypeAnn'  ])
            self.instMeth = RadioUI( maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kInstanceMethod'  ],
                                     [maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kCopyNearest'  ],
                                      maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kInterpolate'  ]], help )
            ...
            tabs.addTab(scrollArea,maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kAttributeMaps'  ]) 
        ...
        def doIt(self):
            ...
            xglog.XGWarning(maya.stringTable['y_xgenm_ui_dialogs_igExport.kIgExportUIAttrMapsFrom' ] % (desc,expandedPath) )
            return True
    ...
    class MaskExporter(QWidget):
        def __init__( self, tabs ):
            ...
            scrollArea.setWidget(self)
            scrollArea.setWidgetResizable(True)
            tabs.addTab(scrollArea,maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kMask'  ])
        ...
        def doIt(self):
            ...
            xglog.XGWarning(maya.stringTable['y_xgenm_ui_dialogs_igExport.kIgExportUIMaskMapsFrom' ] % (desc,expandedPath) )
            return True
    ...
    class RegionExporter(QWidget):
        def __init__( self, tabs ):
            ...
            scrollArea.setWidget(self)
            scrollArea.setWidgetResizable(True)
            tabs.addTab(scrollArea,maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kRegionMap'  ])
        ...
        def doIt(self):
            ...
            xglog.XGWarning(maya.stringTable['y_xgenm_ui_dialogs_igExport.kIgExportUIRegionMapsFrom' ] % (desc,expandedPath) )        
            return True
    ...
    class ColorSetExporter(QWidget):
        def __init__( self, tabs ):
            ...
            self.path = BrowseUI(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kFolderPathColorExport'  ],
                                 maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kFilePathColorExportAnn'  ],
                                 "","","out")
            self.path.optionButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kBrowseForAFolder2'  ])
            self.path.setValue( values['colorPath'] )
            vbox.addWidget(self.path)

            self.colorSet = TextUI( maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kColorset'  ], 
                                    maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kColorSetAnn'  ] )
            ...
            scrollArea.setWidget(self)
            scrollArea.setWidgetResizable(True)
            tabs.addTab(scrollArea,maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kColors'  ])
    ...
    class UVSetExporter(QWidget):
        def __init__( self, tabs ):
            ...
            self.path = BrowseUI(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kFolderPathUVExport'  ],
                                 maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kFullPathUVExportAnn'  ],
                                 "","","out")
            self.path.optionButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kBrowseForAFolder3'  ])
            self.path.setValue( values['uvPath'] )
            vbox.addWidget(self.path)

            self.uvSet = TextUI( maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kUvset'  ],
                                 maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kUvSetAnn'  ] )
            ...
            scrollArea.setWidget(self)
            scrollArea.setWidgetResizable(True)
            tabs.addTab(scrollArea,maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kUvs'  ])
    ...
    class Texture2DExporter(QWidget):
        def __init__( self, tabs ):
            ...
            self.texture = TextUI( maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kTextureNode'  ],
                                   maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kTextureNodeAnn'  ] )
            ...
            scrollArea.setWidget(self)
            scrollArea.setWidgetResizable(True)
            tabs.addTab(scrollArea,maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.k2dTexture'  ])
    ...
    def __init__(self):
        ...
        self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kIgroomExport'  ])
    ...
    def buttons(self,layout):
        ...
        self.exportButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kExport'  ])
        ...
        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kCancel'  ])
        self.cancelButton.setFixedWidth(DpiScale(100))
        self.cancelButton.setAutoRepeat(False)
        self.cancelButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kCancelAnn'  ])
...
def igExportFile():
    if len(xg.palettes()) == 0:
        tellem = QMessageBox()
        tellem.setText(maya.stringTable[ 'y_xgenm_ui_dialogs_igExport.kThereIsNothingToExport'  ])
        tellem.exec_()
        return
