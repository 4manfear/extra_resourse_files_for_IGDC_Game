...
class InteractiveSplineWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Window title
        self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kCreateInteractiveDescriptionTitle'  ])
        ...
        self.newDescriptionNameLabelUI = QLabel(maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kNewDescriptionName' ])
        ...
        self.genSeedIntUI = IgIntSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kGeneratorSeed' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kGeneratorSeedAnno' ],
                False,
                0, 100000, 0, 10000,
                gridLayout, 1,
        ...
        self.densityFloatUI = IgFloatSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kDensity' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kDensityAnno' ],
                True,
        ...
        # Spline count Label
        self.splineCountLabelUI = QLabel(maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kApprSplinesCount' ])
        splineCountLabelAnno = maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kSplinesCountAnno' ]
        ...
        self.lengthFloatUI = IgFloatSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kLength' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kLengthAnno' ],
                True,
        ...
        self.widthFloatUI = IgFloatSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kWidth' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kWidthAnno' ],
                True,
                0.0, 1000.0, 0.0, 1.0,
                gridLayout, 5,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.cvCountIntUI = IgIntSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kCVCount' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kCVCountAnno' ],
                False,
                0, maxCVCount, 0, 1000,
                gridLayout, 7,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.createButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kCreate'  ])
        ...
        self.applyButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kApply'  ])
        ...
        self.closeButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kClose'  ])
    ...
    def __createMenus(self):
        ...
        # Edit menu
        editMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kEdit' ])
        editMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kResetSettings' ], self.__onMenuResetSettings)

        # Help menu
        helpMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kHelp' ])
        helpMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kHelpMenu' ], self.__onMenuHelp)
    ...
    def __onClickApplyButton(self):
        ...
        try:
            ...
            print(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgCreateInteractiveDescription.kNoBoundMesh'  ])
            pass
