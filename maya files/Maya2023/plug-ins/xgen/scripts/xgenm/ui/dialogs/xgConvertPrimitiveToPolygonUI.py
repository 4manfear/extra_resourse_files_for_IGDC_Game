...
def composeConvertCmd(setting):
    ...
    if len(descriptions) == 0:
        xglog.XGWarning(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kNoDesc' ] )
        return ""
...
class ConvertPrimitiveToPolygonWindow(QMainWindow):
    ...
    def __init__(self, parent):
        ...
        # Window title
        self.setWindowTitle( maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kConvertPrimToPolyWinTitle' ])
        ...
        self.convertSelectedChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kConvertSelected' ])
        ...
        self.combineMeshChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCombineMesh' ])
        ...
        self.useWidthRampChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kUseWidthRamp' ])
        gridLayout.addWidget(self.useWidthRampChkBoxUI, gridLine, 1, 1, 2)
        gridLine += 1

        # 'Insert Spans Along Width' check box
        self.insertSpansChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kInsertSpans' ])
        ...
        self.spanNumIntUI = IgIntSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kSpanNum' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kkSpanNumAnno' ],
                True,
                0, 100, 0, 10,
                gridLayout, gridLine,
        ...
        self.curvatureFloatUI = IgFloatSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCurvature' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCurvatureAnno' ],
                True,
                -1.0, 1.0, -1.0, 1.0,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.placeUVChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kPlaceUV' ])
        ...
        # UV Layout Type
        self.uvLayoutTypeLabelUI = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kUVLayoutType'  ])
        ...
        self.uvLayoutTypeComboUI.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.k2x2' ])
        self.uvLayoutTypeComboUI.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.k3x3' ])
        self.uvLayoutTypeComboUI.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.k4x4' ])
        ...
        self.tileSeparationFloatUI = IgFloatSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kTileSeparation' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kTileSeparationAnno' ],
                True,
                0.0, 1.0, 0.0, 1.0,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.createStripJointsChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCreateStripJoints' ])
        ...
        jointPlacementStr = maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kJointPlacement'  ]
        jointPerSpanStr = maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kJointPerSpan'  ]
        jointPerCVStr = maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kJointPerCV'  ]
        specifyJointNumStr = maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kSpecifyJointNum'  ]
        ...
        self.stripJointNumIntUI = IgIntSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kStripJointNum' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kStripJointNumAnno' ],
                True,
                3, 100, 3, 10,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        # Auto Bind Skin
        self.autoBindSkinChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kAutoBindSkin' ])
        ...
        self.maxInfluencesIntUI = IgIntSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kMaxInfluences' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kMaxInfluencesAnno' ],
                True,
                3, 100, 3, 10,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.createGuideJointsChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCreateGuideJoint' ])
        ...
        self.guideJointNumIntUI = IgIntSliderUI(
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kGuideJointNum' ],
                maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kGuideJointNumAnno' ],
                True,
                3, 100, 3, 10,
                gridLayout, gridLine,
                textUIWidth, editUIWidth, sliderUIWidth)
        ...
        self.convertButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kConvert'  ])
        ...
        self.applyButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kApply'  ])
        ...
        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kCancel'  ])
    ...
    def __createMenus(self):
        ...
        # Edit menu
        editMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kEdit' ])
        editMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kResetSettings' ], self.__onMenuResetSettings)
        editMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kSaveSettings' ], self.__onMenuSaveSettings)

        # Help menu
        helpMenu = self.menuBar().addMenu(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kHelp' ])
        helpMenu.addAction(maya.stringTable['y_xgenm_ui_dialogs_xgConvertPrimitiveToPolygonUI.kHelpMenu' ], self.__onMenuHelp)
