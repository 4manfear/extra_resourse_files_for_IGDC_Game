...
class ConvertToInteractiveGroomWindow(QMainWindow):
    ...
    def __init__(self, parent):
        ...
        # Window title
        self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgConvertToInteractiveGroomUI.kConvertToInteractiveGroomWindowTitle'  ])
        ...
        self.outPrefixChkBoxUI = QCheckBox(maya.stringTable['y_xgenm_ui_dialogs_xgIgConvertToInteractiveGroomUI.kOutNamePrefixCheckbox' ])
        ...
        # "Convert" button
        self.ui_convertButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgConvertToInteractiveGroomUI.kConvertButton'  ])
        ...
        # "Cancel" button
        self.ui_cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgIgConvertToInteractiveGroomUI.kCancel'  ])
