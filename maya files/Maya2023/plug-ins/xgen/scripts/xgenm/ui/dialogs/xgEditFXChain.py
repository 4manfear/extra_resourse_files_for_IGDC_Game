...
_locNames = {"AnimWires"         :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kAnimWires'  ],
             "ApplyNetForce"     :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kApplyNetForce'  ],
             "BakedGroomManager" :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kGroomBake'  ],
             "BlockAnim"         :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kBlockAnim'  ],
             "Clumping"          :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kClumping'  ],
             "Coil"              :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kCoil'  ],
             "Collision"         :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kCollision'  ],
             "ControlWires"      :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kControlwires'  ],
             "Cut"               :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kCut'  ],
             "Debug"             :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kDebug'  ],
             "DirectionalForce"  :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kDirectionalForce'  ],
             "Force"             :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kForce'  ],
             "MeshCut"           :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kMeshcut'  ],
             "Noise"             :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kNoise'  ],
             "Particle"          :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kParticle'  ],
             "PlaneAnim"         :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kPlaneAnim'  ],
             "PlaneForce"        :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kPlaneForce'  ],
             "PolylineForce"     :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kPolylineForce'  ],
             "PreserveClumps"    :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kPreserveClumps'  ],
             "Snapshot"          :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kSnapshot'  ],
             "SphereForce"       :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kSphereForce'  ],
             "Wind"              :maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kWind'  ]}
...
class EditFXChainUI(QDialog):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kEditModifierStack'  ])
    ...
    def mkAvailable(self):
        ...
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kAvailableModules'  ])
    ...
    def mkChain(self):
        ...
        vbox.setSpacing(DpiScale(3))
        vbox.setContentsMargins(DpiScale(1),DpiScale(1),DpiScale(1),DpiScale(1))
        label = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kCurrentModules'  ])
    ...
    def addButtons(self):
        ...
        self.addButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kAddAnn'  ])
        ...
        self.removeButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kRemoveAnn'  ])
        ...
        self.upButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kUpAnn'  ])
        ...
        self.downButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kDownAnn'  ])
        ...
        self.doneButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kDone'  ])
        self.doneButton.setFixedWidth(DpiScale(90))
        self.doneButton.setAutoRepeat(False)
        self.doneButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kDoneAnn'  ])
...
class FXChainLoaderUI(QDialog):
    ...
    def __init__(self,x,y):
        ...
        self.setSizeGripEnabled(True)
        self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kAddModifierWindow'  ])
    ...
    def addButtons(self):
        ...
        self.okButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kOk'  ])
        self.okButton.setFixedWidth(DpiScale(90))
        self.okButton.setAutoRepeat(False)
        self.okButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kOkAnn'  ])
        self.connect(self.okButton, QtCore.SIGNAL("clicked()"), self.okCB)
        self.okButton.setDefault(True)

        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kCancel'  ])
        self.cancelButton.setFixedWidth(DpiScale(90))
        self.cancelButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kCancelAnn'  ])
...
class FXChainOrderingUI(QDialog):
    ...
    def addButtons(self):
        ...
        self.okButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kOk2'  ])
        self.okButton.setFixedWidth(DpiScale(70))
        self.okButton.setAutoRepeat(False)
        self.okButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kOkAnn2'  ])
        ...
        self.upButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kUpAnn2'  ])
        ...
        self.downButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kDownAnn2'  ])
        ...
        self.removeButton.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kRemoveAnn2'  ])
...
def editFXChain():
    ...
    if not xgg.DescriptionEditor:
        print(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kNoDescriptionEditorOpenSoNoCurrentDescription1'  ])
        return
...
def showFXChainLoaderDialog( x, y ):
    ...
    """
    if not xgg.DescriptionEditor:
        print(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kNoDescriptionEditorOpenSoNoCurrentDescription2'  ])
        return
...
def showFXChainOrderingDialog( x, y ):
    ...
    """
    if not xgg.DescriptionEditor:
        print(maya.stringTable[ 'y_xgenm_ui_dialogs_xgEditFXChain.kNoDescriptionEditorOpenSoNoCurrentDescription3'  ])
        return
