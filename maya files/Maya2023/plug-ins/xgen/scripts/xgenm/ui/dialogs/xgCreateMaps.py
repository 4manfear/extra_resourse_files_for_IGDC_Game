...
class CreateMapsUI(QDialog):
    ...
    def __init__(self,attr,defaultFolder="",useRGB=False):
        ...
        self.setWindowTitle(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kCreateMap'  ])
    ...
    def createUI(self):
        ...
        self.mapLabel = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kMapName'  ])
        ...
        # Map Resolution
        self.resSlider = FloatUI(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kMapResolution'  ],
             maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kMapResolutionAnn'  ],
             "",0,)
        ...
        self.texelHelp = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kTotalResolutionHelp'  ])
        ...
        self.colorLabel = QLabel(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kStartColor'  ])
        self.colorLabel.setToolTip(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kStartColorAnn'  ])
        ...
        if self.isRGB:
            self.startColorCB.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kRed'  ], "red")
            self.startColorCB.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kGreen'  ], "green")
            self.startColorCB.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kBlue'  ], "blue")
        else:
            if not self.isBrowseMode:
                self.startColorCB.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kBasedOnAttribute'  ],"basedOnAttribute")
            self.startColorCB.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kWhite'  ], "white")
            self.startColorCB.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kBlack'  ], "black")
            self.startColorCB.addItem(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kGrey'  ], "grey")
        ...
        self.createButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kCreate'  ])
        self.connect(self.createButton, QtCore.SIGNAL("clicked()"),self.accept)
        buttonLayout.addWidget(self.createButton)
        self.cancelButton = QPushButton(maya.stringTable[ 'y_xgenm_ui_dialogs_xgCreateMaps.kCancel'  ])
